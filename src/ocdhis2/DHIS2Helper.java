		...
		if(type.equalsIgnoreCase("default")){
			...
			try {
				...
				while(iCols.hasNext()){
					...
					results.put(getDataElementName(root.attributeValue("dataSet"), r.attributeValue("dataElement"), language,dataSetLabel)+";"+r.attributeValue("dataElement")+";"+r.attributeValue("categoryOptionCombo"), r.attributeValue("value"));
				}
				...
				while(iCols.hasNext()){
					...
					if(!activeDataElement.equalsIgnoreCase(key.split(";")[1])){
						...
						html.append("<tr><td"+(n==0?" style='max-width:150px;overflow: hidden' ":"")+" class='admin'>"+key.split(";")[0]+"</td>");
						n++;
