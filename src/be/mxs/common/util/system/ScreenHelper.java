...
public static String removeAccents(String sTest){
    ...
    public static String writeDateField(String sName, String sForm, String sValue, boolean allowPastDates, 
        ...
        return "<input type='text' maxlength='10' class='text' id='"+sName+"' name='"+sName+"' value='"+sValue+"' size='12' onblur='if(!checkDate(this)"+sExtraCondition+"){dateError(this);}else{"+sExtraOnBlur+"}'>"+
               "&nbsp;<img height='16px' name='popcal' style='vertical-align:-1px;' onclick='gfPop"+gfPopType+".fPopCalendar(document."+sForm+"."+sName+");return false;' src='"+sCONTEXTDIR+"/_img/icons/icon_agenda.png' alt='"+HTMLEntities.htmlentities(getTran(null,"Web","Select",sWebLanguage))+"'></a>"+
               "&nbsp;<img height='16px' class='link' src='"+sCONTEXTDIR+"/_img/icons/icon_compose.png' alt='"+getTranNoLink("Web","PutToday",sWebLanguage)+"' onclick='getToday(document."+sForm+"."+sName+");'>";
    }
    ...
    public static String writeDateFieldWithDelete(String sName, String sForm, String sValue, boolean allowPastDates, 
        ...
        return "<input type='text' maxlength='10' class='text' id='"+sName+"' name='"+sName+"' value='"+sValue+"' size='12' onblur='if(!checkDate(this)"+sExtraCondition+"){dateError(this);}else{"+sExtraOnBlur+"}'>"
              ...
              +"&nbsp;<img class='link' src='"+sCONTEXTDIR+"/_img/icons/icon_compose.png' alt='"+getTranNoLink("web","PutToday",sWebLanguage)+"' onclick='getToday(document."+sForm+"."+sName+");'>"
              +"&nbsp;<img class='link' src='"+sCONTEXTDIR+"/_img/icons/icon_delete.png' alt='"+getTranNoLink("web","clear",sWebLanguage)+"' onclick=\"document."+sForm+"."+sName+".value='';\">";
    }
    ...
    public static String newWriteDateField(String sName, java.util.Date dValue, String sWebLanguage, String sCONTEXTDIR){
        return "<input id='"+sName+"' type='text' maxlength='10' class='text' name='"+sName+"' value='"+getSQLDate(dValue)+"' size='12' onblur='if(!checkDate(this)){dateError(this);this.value=\"\";}'>"
              ...
              +"&nbsp;<img class='link' src='"+sCONTEXTDIR+"/_img/icons/icon_compose.png' alt='"+HTMLEntities.htmlentities(getTran(null,"Web","putToday",sWebLanguage))+"' onclick=\"getToday($('"+sName+"'));\">";
    }
    ...
    public static String writeServiceButton(String sButtonName, String sVarCode, String sVarText,
        ...
        return  "<img src='"+sCONTEXTDIR+"/_img/icons/icon_search.png' id='"+sButtonName+"' class='link' alt='"+getTranNoLink("Web","select",sWebLanguage)+"'"
              ...
              +"&nbsp;<img src='"+sCONTEXTDIR+"/_img/icons/icon_delete.png' class='link' alt='"+getTranNoLink("Web","clear",sWebLanguage)+"' onclick=\"document.getElementsByName('"+sVarCode+"')[0].value='';document.getElementsByName('"+sVarText+"')[0].value='';\">";
    }
	        ...
	        if(labelTypes!=null){
	            ...
	            if(labelIds!=null){
	                ...
	                while(it.hasNext()){
	                    ...
	                    s.append("<label style='display: inline-block;'><input "+setRightClickMini(request.getSession(), sName)+" "+sEvent+" onclick='document.getElementById(\""+sName+"\").value=\""+sLabelID+";\";' type='radio' name='"+sName+".radio' id='"+sName+"."+sLabelID+"' value='"+sLabelID+"'");
	                    if(arrayContains(sSelected,sLabelID,";")){
	                        s.append(" checked");
	                    }
    ...
    public static String writeDefaultTextArea(HttpSession session, TransactionVO transaction, String sName,int cols, int rows){
    	if(transaction.getItem("be.mxs.common.model.vo.healthrecord.IConstants."+sName)==null){
	    	...
	    	s.append(" class='text' cols='"+cols+"' rows='"+rows+"' name='currentTransactionVO.items.<ItemVO[hashCode="+transaction.getItem("be.mxs.common.model.vo.healthrecord.IConstants."+sName).getItemId()+"]>.value'>");
    ...
    public static String writeDefaultSelect(HttpServletRequest request,TransactionVO transaction, String sName,String type, String language, String sEvent,String sDefault){
    	if(transaction.getItem("be.mxs.common.model.vo.healthrecord.IConstants."+sName)==null){
	        ...
	        if(request!=null && checkString((String)request.getSession().getAttribute("editmode")).equalsIgnoreCase("1")){
		    	...
		    	s.append("<select style='vertical-align: top' "+(request==null?"":setRightClick(request.getSession(),"ITEM_TYPE_CNRKR_SESSIONS")+" ")+sEvent+" class='text' id='"+sName+"' ");
		    	s.append(" name='currentTransactionVO.items.<ItemVO[hashCode="+transaction.getItem("be.mxs.common.model.vo.healthrecord.IConstants."+sName).getItemId()+"]>.value'>");
		    	s.append(" <option/>");
		    	s.append(writeSelect(request,type,itemValue.length()==0 && checkString(sDefault).length()>0?sDefault:itemValue,language));
		    	s.append(" </select>");
