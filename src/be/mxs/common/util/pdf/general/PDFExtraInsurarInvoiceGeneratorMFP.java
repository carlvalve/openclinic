...
public class PDFExtraInsurarInvoiceGeneratorMFP extends PDFInvoiceGenerator {
    ...
    //--- CONSTRUCTOR -----------------------------------------------------------------------------
    public PDFExtraInsurarInvoiceGeneratorMFP(User user, String sProject, String sPrintLanguage, String PrintType){
        this.user = user;
