 ...
 * Date: 21-nov-2006
 */
public class PDFImagingLabelGenerator extends PDFOfficialBasic {
    ...
    //--- CONSTRUCTOR -----------------------------------------------------------------------------
    public PDFImagingLabelGenerator(User user, String sProject){
        this.user = user;
    ...
    public ByteArrayOutputStream generatePDFDocumentBytes(final HttpServletRequest req, String imageid, String trandate,String examination, AdminPerson activepatient) throws Exception {
		...
		try{
            ...
            doc.open();
            printImageLabel(imageid,trandate,examination,activepatient);
		}
		catch(Exception e){
			baosPDF.reset();
			e.printStackTrace();
