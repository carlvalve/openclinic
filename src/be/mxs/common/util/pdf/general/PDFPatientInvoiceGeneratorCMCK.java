    ...
    private void addPatientDataVisit(PatientInvoice invoice,String encounteruid){
        ...
        try{
        	...
        	if(person!=null){
	        	...
	        	table.addCell(cell);
	        	cell=createBoldLabelCell(ScreenHelper.stdDateFormat.format(encounter.getBegin()), 40);
	        	table.addCell(cell);
    ...
    private void addPatientDataAdmission(PatientInvoice invoice, String encounteruid){
        ...
        try{
        	...
        	if(person!=null){
	        	...
	        	table.addCell(cell);
	        	cell=createBoldLabelCell(encounter.getEnd()==null?"":ScreenHelper.stdDateFormat.format(encounter.getEnd()), 40);
	        	table.addCell(cell);
