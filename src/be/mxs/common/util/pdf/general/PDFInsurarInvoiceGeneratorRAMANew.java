...
public class PDFInsurarInvoiceGeneratorRAMANew extends PDFInvoiceGenerator {
    ...
    private void getDebets(InsurarInvoice invoice) throws DocumentException{
        ...
        if(debets.size() > 0){
            ...
            for(int i=0; i<debets.size(); i++){
                ...
                if(i>0 && (displayDate || displayPatientName)){
                	...
                	if(linecounter==36 || (linecounter-36)%40==0){
                        ...
                        cell = createLabelCell(priceFormatInsurar.format(pageTotalAmount100)+" "+MedwanQuery.getInstance().getConfigString("currencyPdf","RWF"),100,7);
                        cell.setHorizontalAlignment(PdfPCell.ALIGN_LEFT);
                        cell.setBorder(PdfPCell.BOX);
                        cell.setPaddingRight(5);
                        table.addCell(cell);
                        cell = createLabelCell(priceFormatInsurar.format(pageTotalAmount85)+" "+MedwanQuery.getInstance().getConfigString("currencyPdf","RWF"),100,7);
                        cell.setHorizontalAlignment(PdfPCell.ALIGN_LEFT);
                        cell.setBorder(PdfPCell.BOX);
                        cell.setPaddingRight(5);
                        table.addCell(cell);
            ...
            table.addCell(cell);
            table.addCell(createEmptyCell(800));
            cell = createLabelCell(priceFormatInsurar.format(generaltotal100pct)+" "+MedwanQuery.getInstance().getConfigString("currencyPdf","RWF"),100,7);
            cell.setHorizontalAlignment(PdfPCell.ALIGN_LEFT);
            cell.setBorder(PdfPCell.BOX);
            cell.setPaddingRight(5);
            table.addCell(cell);
            cell = createLabelCell(priceFormatInsurar.format(generaltotal85pct)+" "+MedwanQuery.getInstance().getConfigString("currencyPdf","RWF"),100,7);
            cell.setHorizontalAlignment(PdfPCell.ALIGN_LEFT);
            cell.setBorder(PdfPCell.BOX);
            cell.setPaddingRight(5);
            table.addCell(cell);
