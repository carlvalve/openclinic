...
public class PDFInsurarInvoiceGeneratorHMK extends PDFInvoiceGenerator {
    ...
    //--- CONSTRUCTOR -----------------------------------------------------------------------------
    public PDFInsurarInvoiceGeneratorHMK(User user, String sProject, String sPrintLanguage, String PrintType){
        this.user = user;
	...
	private void addType1Invoice(InsurarInvoice invoice) throws Exception{
        ...
        while(iServices.hasNext()){
            ...
            cell.setBorder(PdfPCell.BOTTOM);
            table.addCell(cell);
            cell=createHeaderCell(ScreenHelper.getTranNoLink("web.mfp", "amount.insurer", user.person.language), 10);
            cell.setHorizontalAlignment(PdfPCell.ALIGN_RIGHT);
            cell.setBorder(PdfPCell.BOTTOM);
            table.addCell(cell);
