...
public class PDFExtraInsurarInvoiceGeneratorRAMANew extends PDFInvoiceGenerator {
    String PrintType;
    ...
    //--- CONSTRUCTOR -----------------------------------------------------------------------------
    public PDFExtraInsurarInvoiceGeneratorRAMANew(User user, String sProject, String sPrintLanguage, String PrintType){
        this.user = user;
