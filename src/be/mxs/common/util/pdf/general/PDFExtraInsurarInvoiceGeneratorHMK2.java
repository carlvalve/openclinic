...
public class PDFExtraInsurarInvoiceGeneratorHMK2 extends PDFInvoiceGenerator {
    ...
    //--- CONSTRUCTOR -----------------------------------------------------------------------------
    public PDFExtraInsurarInvoiceGeneratorHMK2(User user, String sProject, String sPrintLanguage, String PrintType){
        this.user = user;
	...
	private void addType1Invoice(ExtraInsurarInvoice2 invoice) throws Exception{
        model=" Mod MFP.1";
		...
		for(int n=0;n<debets.size();n++){
        	...
        	if(debet!=null && debet.getDate()!=null && debet.getPrestation()!=null){
            	...
            	if(invoices.get(invoiceUid)!=null){
       			...
       			income.unknown+=debet.getAmount();
	...
	private void addType2Invoice(ExtraInsurarInvoice2 invoice) throws Exception{
        model=" Mod MFP.2.A";
		SortedMap services = new TreeMap();
		SortedMap dates;
	...
	private void addType3Invoice(ExtraInsurarInvoice2 invoice) throws Exception{
        model=" Mod MFP.3.A";
		SortedMap services = new TreeMap();
		...
		for(int n=0;n<debets.size();n++){
        	...
        	if(debet!=null && debet.getDate()!=null && debet.getPrestation()!=null && !"drug".equalsIgnoreCase(ScreenHelper.checkString(debet.getPrestation().getPrestationClass()))){
        		...
        		if(diseaseType.equalsIgnoreCase("a")){
        			income.mn+=debet.getAmount();
        		}
        		else if(diseaseType.equalsIgnoreCase("b")){
        			income.mp+=debet.getAmount();
        		}
        		else if(diseaseType.equalsIgnoreCase("c")){
        			income.at+=debet.getAmount();
        		}
        		else if(diseaseType.equalsIgnoreCase("d")){
        			income.ac+=debet.getAmount();
        		}
        		else if(diseaseType.equalsIgnoreCase("e")){
        			income.aa+=debet.getAmount();
        		}
        		else {
        			income.unknown+=debet.getAmount();
        		}
	...
	private void addType4Invoice(ExtraInsurarInvoice2 invoice) throws Exception{
        model=" Mod MFP.4.A";
