...
public class PDFInsurarInvoiceGeneratorBRARUDI extends PDFInvoiceGenerator {
    ...
    //--- CONSTRUCTOR -----------------------------------------------------------------------------
    public PDFInsurarInvoiceGeneratorBRARUDI(User user, String sProject, String sPrintLanguage, String PrintType){
        this.user = user;
    ...
    //--- ADD INSURAR DATA ------------------------------------------------------------------------
    private void addInsurarData(InsurarInvoice invoice,String personid){
        ...
        try {
            ...
            cell=createLabelCell(getTran("web","NIF"),10);
            table.addCell(cell);
        	...
        	cell=createEmptyCell((30-characters)*3);
        	table.addCell(cell);
            cell=createLabelCell(getTran("web","socialreason"),15);
        	table.addCell(cell);
            cell=createBoldLabelCell(getTran("web","hospitalname"),85);
        	table.addCell(cell);
            cell=createLabelCell(getTran("web","address"),15);
        	table.addCell(cell);
            cell=createBoldLabelCell(getTran("web","hospitaladdress"),85);
        	table.addCell(cell);
        	...
        	table.addCell(cell);
            cell=createBoldLabelCell(person.getFullName(),85);
        	table.addCell(cell);
            cell=createLabelCell(getTran("web","NIF"),10);
        	table.addCell(cell);
            ...
            cell=createBoldLabelCell(" "+insurar.getName(),30);
        	table.addCell(cell);
        	cell=createEmptyCell((20-characters)*3);
        	table.addCell(cell);
        ...
        try {
            ...
            for(int n=0;n<debets.size();n++){
            	...
            	if(debet.getPrestation()==null){
            		...
            		uid=debet.getPrestation().getUid();
            	}
            	if(prestations.get(uid)==null){
            		prestations.put(uid, new PrestationData());
            	}
            ...
            cell=createBoldLabelCell(new SimpleDateFormat("MM/yyyy").format(begin)+(new SimpleDateFormat("MM/yyyy").format(begin).equalsIgnoreCase(new SimpleDateFormat("MM/yyyy").format(end))?"":" - "+new SimpleDateFormat("MM/yyyy").format(end)), 90);
            table.addCell(cell);
			cell=createLabelCell("\n",100);
			table.addCell(cell);
			cell = createBoldLabelCell(getTran("web","ordernumber"), 10);
			cell.setBorder(PdfPCell.BOX);
			table.addCell(cell);
			cell = createBoldLabelCell(getTran("web","prestation"), 45);
			cell.setBorder(PdfPCell.BOX);
			table.addCell(cell);
			cell = createBoldLabelCell(getTran("web","quantity"), 15);
			cell.setBorder(PdfPCell.BOX);
			table.addCell(cell);
			cell = createBoldLabelCell(getTran("web","unitprice"), 15);
			cell.setBorder(PdfPCell.BOX);
			table.addCell(cell);
			cell = createBoldLabelCell(getTran("web","totalexvat"), 15);
			cell.setBorder(PdfPCell.BOX);
			table.addCell(cell);
			Enumeration ePrestations = prestations.keys();
			...
			while(ePrestations.hasMoreElements()){
				...
				if(p!=null){
					...
					cell.setBorder(PdfPCell.BOX);
					table.addCell(cell);
					cell = createBoldLabelCell(p.getDescription(), 45);
					cell.setBorder(PdfPCell.BOX);
					table.addCell(cell);
					...
					table.addCell(cell);
					ordernumber++;
					totalamount+=prestation.amount;
				}
			}
			cell = createBoldLabelCell(getTran("web","generaltotalexVAT"), 85);
			cell.setBorder(PdfPCell.BOX);
			table.addCell(cell);
			cell = createBoldLabelCell(new Double(totalamount).intValue()+"", 15);
			cell.setBorder(PdfPCell.BOX);
			table.addCell(cell);
			cell = createBoldLabelCell(getTran("web","vatamount"), 85);
			cell.setBorder(PdfPCell.BOX);
			table.addCell(cell);
			cell = createBoldLabelCell("0", 15);
			cell.setBorder(PdfPCell.BOX);
			table.addCell(cell);
			cell = createBoldLabelCell(getTran("web","generaltotalincVAT"), 85);
			cell.setBorder(PdfPCell.BOX);
			table.addCell(cell);
			cell = createBoldLabelCell(new Double(totalamount).intValue()+"", 15);
			cell.setBorder(PdfPCell.BOX);
