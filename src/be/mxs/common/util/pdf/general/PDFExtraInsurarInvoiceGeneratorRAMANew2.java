...
public class PDFExtraInsurarInvoiceGeneratorRAMANew2 extends PDFInvoiceGenerator {
    String PrintType;
    ...
    //--- CONSTRUCTOR -----------------------------------------------------------------------------
    public PDFExtraInsurarInvoiceGeneratorRAMANew2(User user, String sProject, String sPrintLanguage, String PrintType){
        this.user = user;
