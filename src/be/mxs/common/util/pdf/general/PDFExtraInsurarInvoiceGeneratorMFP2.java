...
public class PDFExtraInsurarInvoiceGeneratorMFP2 extends PDFInvoiceGenerator {
    ...
    //--- CONSTRUCTOR -----------------------------------------------------------------------------
    public PDFExtraInsurarInvoiceGeneratorMFP2(User user, String sProject, String sPrintLanguage, String PrintType){
        this.user = user;
