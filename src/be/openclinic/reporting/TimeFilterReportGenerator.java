...
public class TimeFilterReportGenerator {
								...
								while(iRows.hasNext()){
									...
									while(selectfields.hasNext()){
										...
										if(value.attributeValue("type").equalsIgnoreCase("variable")){
											...
											v=MedwanQuery.getInstance().getConfigString(value.getText(),ScreenHelper.checkString(value.attributeValue("default")));
										}
										if(selectField.attributeValue("name").equalsIgnoreCase("encountertype")){
	...
	static boolean evaluateString(Element value,String s,SortedMap rows,Object rowid){
		...
		if(value.attributeValue("compare").equalsIgnoreCase("equals")){
			if(value.attributeValue("type").equalsIgnoreCase("constant")){
				...
				return s.equalsIgnoreCase(MedwanQuery.getInstance().getConfigString(value.getText(),ScreenHelper.checkString(value.attributeValue("default"))));
			}
			else{
			...
			if(value.attributeValue("type").equalsIgnoreCase("constant")){
				...
				return s.contains(MedwanQuery.getInstance().getConfigString(value.getText(),ScreenHelper.checkString(value.attributeValue("default"))));
			}
			else{
	...
	static void addParameter(Element value, Vector parameters, Hashtable variables){
		if(value.attributeValue("type").equalsIgnoreCase("constant")){
			...
			parameters.add(MedwanQuery.getInstance().getConfigString(value.getText(),ScreenHelper.checkString(value.attributeValue("default"))));
		}
		else{
	...
	static String setSelectString(Element value,String sSelect,Vector parameters,String fieldname,String fieldvalue){
		if(value.attributeValue("compare").equalsIgnoreCase("equals")){
			sSelect+=" AND "+fieldname+" = ?";
			if(value.attributeValue("type").equalsIgnoreCase("config")){
				parameters.add(MedwanQuery.getInstance().getConfigString(fieldvalue,ScreenHelper.checkString(value.attributeValue("default"))));
			}
			else{
				parameters.add(fieldvalue);
			}
