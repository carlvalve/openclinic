                    ...
                    while(itemIter.hasNext()){
                        ...
                        if(item.getHtmlElement().equals("label")){
                            ...
                            if(item.getDefaultValue().length()==0){
                                sTran = ScreenHelper.getTran(null,"web",item.getItemTypeId(),sWebLanguage);
                            }
                        ...
                        //*** date ***
                            ...
                            sHtml.append("<script>getMyDate('item_"+item.getItemTypeId()+"','"+sCONTEXTPATH+"/_img/icons/icon_agenda.gif','"+ScreenHelper.getTran(null,"web","putToday",sWebLanguage)+"',true,false);</script>");
                        }
                        //*** select ***
                            ...
                            sHtml.append(ScreenHelper.writeSelect(null,"CUSTOMEXAMINATION"+this.getExamId()+"."+item.getItemTypeId(),item.getDefaultValue(),sWebLanguage,false,false));
                        ...
                        //*** radio (yes/no) ***
                            ...
                            sHtml.append("<input type='radio' name='"+item.getItemTypeId()+"' id='radio_"+item.getItemTypeId()+"_yes' style='vertical-align:-2px'")
                                 ...
                                 .append("<label for='radio_"+item.getItemTypeId()+"_yes'>"+ScreenHelper.getTran(null,"web","yes",sWebLanguage)+"</label>");
                            ...
                            sHtml.append("<input type='radio' name='"+item.getItemTypeId()+"' id='radio_"+item.getItemTypeId()+"_no' style='vertical-align:-2px'")
                                 ...
                                 .append("<label for='radio_"+item.getItemTypeId()+"_no'>"+ScreenHelper.getTran(null,"web","no",sWebLanguage)+"</label>");
                        }
                        //*** checkBox ***
                            ...
                            sHtml.append("<input type='checkBox' id='cb_"+item.getItemTypeId()+"' style='vertical-align:-2px'")
                                 ...
                                 .append(ScreenHelper.getTran(null,"CUSTOMEXAMINATION"+this.getExamId(),item.getItemTypeId(),sWebLanguage));
                        }
