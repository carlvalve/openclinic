...
public class DiagnosisStats extends DStats{
    ...
    public DiagnosisStats(String codeType, String code, Date start, Date end,String service,String sortorder,String type) {
        this.codeType = codeType;
        this.code = code;
        this.start = start;
        this.end = end;
        ...
        try {
            ...
            while (rs.next()){
                ...
                if(!activeDiagnosis.equalsIgnoreCase(sCode)){
                    ...
                    diagnosisStats = new DiagnosisStats(codeType,sCode+"%");
