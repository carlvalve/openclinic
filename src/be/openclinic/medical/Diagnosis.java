...
public class Diagnosis extends OC_Object{
        ...
        try{
            if(this.getUid()!=null && this.getUid().length() > 0){
                ...
                ids = new String[]{MedwanQuery.getInstance().getConfigString("serverId"),
                		           MedwanQuery.getInstance().getOpenclinicCounter("OC_DIAGNOSES")+""};
            }
            ...
            if(ids.length==2){
                ...
                ps.setTimestamp(10,ScreenHelper.getSQLTime()); // updatetime : now
    ...
    //--- SELECT DIAGNOSES ------------------------------------------------------------------------
    public static Vector selectDiagnoses(String serverID, String objectID, String encounterUID, String authorUID,
    		                             String fromGravity, String toGravity, String fromCertainty, String toCertainty,
    		                             String code, String fromDate, String toDate, String codeType, String findSortColumn){
        return selectDiagnoses(serverID,objectID,encounterUID,authorUID,fromGravity,toGravity,fromCertainty,toCertainty,
        		               code,fromDate,toDate,codeType,findSortColumn,"","");
    }
    
    public static Vector selectDiagnoses(String serverID, String objectID, String encounterUID, String authorUID,
    		                             String fromGravity,String toGravity, String fromCertainty,String toCertainty,
    		                             String code, String fromDate, String toDate, String codeType, String findSortColumn,
    		                             String findEncounterOutcome, String serviceID){
        return selectDiagnoses(serverID,objectID,encounterUID,authorUID,fromGravity,toGravity,fromCertainty,toCertainty,
        		               code,fromDate,toDate,codeType,findSortColumn,findEncounterOutcome,serviceID,"");
    }
    
    public static Vector selectDiagnoses(String serverID, String objectID, String encounterUID, String authorUID,
    		                             String fromGravity, String toGravity, String fromCertainty, String toCertainty,
    		                             String code, String fromDate, String toDate, String codeType, String findSortColumn,
    		                             String findEncounterOutcome, String serviceID, String contactType){
        PreparedStatement ps;
        ResultSet rs = null;
        ...
        if(code.length() > 0)         sCondition+= " ("+ MedwanQuery.getInstance().getConfigString("lowerCompare").replaceAll("<param>","OC_DIAGNOSIS_CODE")+" LIKE ? OR "+
                                                   " EXISTS ("+
        		                                   "  SELECT * FROM OC_DIAGNOSIS_GROUPS"+
        		                                   "   WHERE OC_DIAGNOSIS_GROUPCODE like ?"+
        		                                   "   AND OC_DIAGNOSIS_CODETYPE=a.OC_DIAGNOSIS_CODETYPE"+
                                                   "   AND OC_DIAGNOSIS_CODE>=OC_DIAGNOSIS_CODESTART"+
        		                                   "   AND OC_DIAGNOSIS_CODE<=OC_DIAGNOSIS_CODEEND))"+
                                                   "   AND";
        ...
        if(findEncounterOutcome!=null && findEncounterOutcome.length()>0){
        	sCondition+= (findEncounterOutcome.equalsIgnoreCase("null")?" (b.OC_ENCOUNTER_OUTCOME IS NULL OR b.OC_ENCOUNTER_OUTCOME='') AND":" b.OC_ENCOUNTER_OUTCOME = ? AND");
        }
        ...
        try{
            ...
            if(code.length()>0){
            	ps.setString(i++,code.toLowerCase()+"%");
                ps.setString(i++,code.toLowerCase()+"%");
            }
            ...
            if(findEncounterOutcome!=null && findEncounterOutcome.length()>0 && !findEncounterOutcome.equalsIgnoreCase("null")){
            	ps.setString(i++,findEncounterOutcome);
            }
            rs = ps.executeQuery();
    ...
    //--- DELETE DIAGNOSES BY REFERENCE UID -------------------------------------------------------
    public static void deleteDiagnosesByReferenceUID(String sReferenceUID, String sType){
        PreparedStatement ps = null;
        Connection oc_conn = MedwanQuery.getInstance().getOpenclinicConnection();
        String sDelete = "DELETE FROM OC_DIAGNOSES"+
                         " WHERE OC_DIAGNOSIS_REFERENCETYPE = ?"+
        		         "  AND OC_DIAGNOSIS_REFERENCEUID = ?";
        try{
            ps = oc_conn.prepareStatement(sDelete);
    ...
    //--- GET DIAGNOSES BY REFERENCE UID ----------------------------------------------------------
    ...
    //--- SAVE TRANSACTION DIAGNOSIS --------------------------------------------------------------
    public static void saveTransactionDiagnosis(String sCode, String sLateralisation, String sGravity,
    		                                    String sCertainty, String sPersonid, String sCodeType,
    		                                    String sType, Timestamp updateTime, String sTransactionUID,
    		                                    int userid, String POA){
        try{
            if(POA==null) POA = "";
    ...
    public static void saveTransactionDiagnosis(String sCode, String sLateralisation, String sGravity, 
    		                                    String sCertainty, String sPersonid, String sCodeType,
    		                                    String sType, Timestamp updateTime, String sTransactionUID,
    		                                    int userid, String POA, String NC){
        try{
            if(POA==null) POA = "";
            if(NC==null) NC = "";
    ...
    public static void saveTransactionDiagnosis(String sCode, String sLateralisation, String sGravity,
    		                                    String sCertainty, String sPersonid, String sCodeType, 
    		                                    String sType, Timestamp updateTime, String sTransactionUID,
    		                                    int userid, Encounter encounter, String POA){
        try{
            if(POA==null) POA = "";
            Diagnosis objDiagnosis = new Diagnosis();
    ...
    public static void saveTransactionDiagnosis(String sCode, String sLateralisation, String sGravity,
    		                                    String sCertainty, String sPersonid, String sCodeType,
    		                                    String sType, Timestamp updateTime, String sTransactionUID,
    		                                    int userid, Encounter encounter, String POA, String NC){
        try{
            if(POA==null) POA = "";
            if(NC==null) NC = "";
    ...
    //--- SAVE TRANSACTION DIAGNOSIS WITH SERVICE -------------------------------------------------
    public static void saveTransactionDiagnosisWithService(String sCode, String sLateralisation, String sGravity,
    		                                               String sCertainty, String sPersonid, String sCodeType, 
    		                                               String sType, Timestamp updateTime, String sTransactionUID,
    		                                               int userid, Encounter encounter, String POA, String NC, String serviceUid){
        try{
            if(POA==null) POA = "";
            if(NC==null) NC = "";
    ...
    public static void saveTransactionDiagnosisWithServiceAndFlags(String sCode, String sLateralisation,
    		                                                       ...
    		                                                       String sTransactionUID, int userid, Encounter encounter,
    ...
    public boolean existsComorbidity(String code,String codetype){
        ...
        String sSelect = "SELECT * FROM OC_DIAGNOSES a"+
                         " WHERE OC_DIAGNOSIS_ENCOUNTERUID = ?"+
        		         "  AND OC_DIAGNOSIS_CODETYPE = ?"+
                         "  AND ("+
        		         "   OC_DIAGNOSIS_CODE like ? OR EXISTS ("+
        		         "    SELECT * FROM OC_DIAGNOSIS_GROUPS"+
                         "     WHERE OC_DIAGNOSIS_GROUPCODE like ?"+
        		         "      AND OC_DIAGNOSIS_CODETYPE = a.OC_DIAGNOSIS_CODETYPE"+
                         "      AND OC_DIAGNOSIS_CODE >= OC_DIAGNOSIS_CODESTART"+
    ...
    static public Vector getPatientKPGSDiagnosesByICPC(String code,String codetype,String patientuid,String language){
        ...
        Connection oc_conn = MedwanQuery.getInstance().getOpenclinicConnection();
    	try{
    		String sQuery = "select a.OC_DIAGNOSIS_CODETYPE, a.OC_DIAGNOSIS_CODE, a.OC_DIAGNOSIS_DATE"+
    	                    " from oc_diagnoses a, oc_diagnosis_groups b, oc_diagnosis_groups c, oc_encounters d"+
    						"  where d.oc_encounter_patientuid = ?"+
    						"   and d.oc_encounter_objectid = replace(a.oc_diagnosis_encounteruid,'"+MedwanQuery.getInstance().getConfigString("serverId")+".','')"+
    						"   and b.oc_diagnosis_codetype = ?"+
    						"   and ? between b.oc_diagnosis_codestart"+
    						"   and b.oc_diagnosis_codeend"+
    						"   and c.oc_diagnosis_codetype = a.oc_diagnosis_codetype"+
    						"   and (a.oc_diagnosis_code between c.oc_diagnosis_codestart and c.oc_diagnosis_codeend)"+
    						"   and b.oc_diagnosis_groupcode = c.oc_diagnosis_groupcode"+
    		...
    		while(rs.next()){
    			String sCode     = rs.getString("OC_DIAGNOSIS_CODE"),
    			       sCodeType = rs.getString("OC_DIAGNOSIS_CODEType");
