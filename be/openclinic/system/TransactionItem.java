...
public class TransactionItem {
    ...
    public String getPrintChapter(){
    	if(getModifier().trim().startsWith(";")){
    		return "";
    	}
    	String s = getModifier().split(";")[0];
    	return s;
    }

    public String getResultLabelType(){
    	String s= "";
    	if(getModifier().split(";").length>1){
    		s = getModifier().split(";")[1];
    	}
    	return s;
    }
