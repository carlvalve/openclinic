			...
			{ 
			    ...
			    if(barcode.length()==11){
			    	...
			    	if(mypage==1){
					    ...
					    System.out.println("Trying blurring...");
					    ...
					    //Try downscaling
					    System.out.println("Trying downscaling...");
					    //Try downscaling
					    ...
					    System.out.println("Trying rotating...");
					    //Try rotating
					    ...
					    System.out.println("Trying downscaling + rotating...");
					    ...
					    System.out.println("Trying downscaling + rotating + blurring...");
					    //Try downscaling + rotating
					    ...
					    System.out.println("Trying downscaling full page...");
					    //Try downscaling
					    ...
					    System.out.println("Trying rotating full page...");
					    //Try rotating
					    ...
					    System.out.println("Trying downscaling + rotating full page...");
					    //Try downscaling + rotating
					    ...
					    System.out.println("Trying downscaling + rotating + blurringfull page...");
					    //Try downscaling + rotating
