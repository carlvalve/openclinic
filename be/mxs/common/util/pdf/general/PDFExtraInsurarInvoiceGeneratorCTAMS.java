...
public class PDFExtraInsurarInvoiceGeneratorCTAMS extends PDFInvoiceGenerator {
    String PrintType;
    ...
    //--- CONSTRUCTOR -----------------------------------------------------------------------------
    public PDFExtraInsurarInvoiceGeneratorCTAMS(User user, String sProject, String sPrintLanguage, String PrintType){
        this.user = user;
    ...
    private void addSummaryData(ExtraInsurarInvoice invoice) throws Exception{
		try{
    ...
    private void getDebets(ExtraInsurarInvoice invoice) throws DocumentException{
        ...
        if(debets.size() > 0){
            ...
            for(int i=0; i<debets.size(); i++){
		    	...
		    	if(debet.getEncounter()!=null){
	                ...
	                pageTotalAmount85+=rExtraInsurarAmount;
	                total100pct+=rTotal;
	                total85pct+=rExtraInsurarAmount;
	                generaltotal100pct+=rTotal;
	                generaltotal85pct+=rExtraInsurarAmount;
	                daytotal100pct+=rTotal;
	                daytotal85pct+=rExtraInsurarAmount;
	                prevdate = date;
