...
public class OC {
   ...
   public Vector<Vector> getListData() {
		System.out.println(new SimpleDateFormat("HH:mm:ss:SSS").format(new java.util.Date())+"C.1");
      Vector<Vector> tVector = new Vector<Vector>();
      Vector<String> rVector;
      try {
         statement = Db.conn.createStatement();
         ResultSet rs = statement.executeQuery(vectorSQL);
  		System.out.println(new SimpleDateFormat("HH:mm:ss:SSS").format(new java.util.Date())+"C.2");
 		System.out.println(vectorSQL);
         ResultSetMetaData meta = rs.getMetaData();
         int colCount = meta.getColumnCount();
         while (rs.next()) {
     		System.out.println(new SimpleDateFormat("HH:mm:ss:SSS").format(new java.util.Date())+"C.3");
 		...
 		System.out.println(new SimpleDateFormat("HH:mm:ss:SSS").format(new java.util.Date())+"C.4");
         rs.close();
         statement.close();
      } catch (Exception e) {
         e.printStackTrace();
   ...
   public static Vector<Vector> getResponse(Vector<String> signs, String language){
		...
		oc.setup();
		System.out.println(new SimpleDateFormat("HH:mm:ss:SSS").format(new java.util.Date())+"C");
		Vector<Vector> result = oc.getListData();
		System.out.println(new SimpleDateFormat("HH:mm:ss:SSS").format(new java.util.Date())+"D");
		try {
