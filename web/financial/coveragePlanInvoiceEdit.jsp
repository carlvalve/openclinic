...
<form name='FindForm' id="FindForm" method='POST'>
    ...
    <table class="menu" width="100%">
        <tr>
            <td width="<%=sTDAdminWidth%>"><%=getTran(request,"web.finance","reimbursement.documentid",sWebLanguage)%></td>
            <td>
                ...
                <img src="<c:url value="/_img/icons/icon_search.png"/>" class="link" alt="<%=getTranNoLink("Web","select",sWebLanguage)%>" onclick="searchCoveragePlanInvoice();">
                <img src="<c:url value="/_img/icons/icon_delete.png"/>" class="link" alt="<%=getTranNoLink("Web","clear",sWebLanguage)%>" onclick="doClearCoveragePlanInvoice()">
    ...
    <tr id="invoicedetails" style="visibility:hidden">
        <td colspan="2">
            <table class='list' width='100%' cellspacing='1' id="invoicedetailstable">
                <%-- DOCUMENT ID --%>
                <tr>
                    <td class="admin"><%=getTran(request,"web.finance","reimbursement.documentid",sWebLanguage)%></td>
                    <td class="admin2">
                ...
                <%-- PRESTATIONS --%>
                <tr>
                    <td class='admin'><%=getTran(request,"web","prestations",sWebLanguage)%></td>
                    <td class='admin2'>
