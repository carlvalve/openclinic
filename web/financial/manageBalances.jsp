...
<table width='100%' cellspacing="0" cellpadding="0" class="list">
    ...
    <%
        ...
        while(iter.hasNext()){
            ...
            sbResults.append("/_img/icons/icon_view.png' alt='view'></td>" + "<td onmouseover=\"this.style.cursor='hand';\" onmouseout=\"this.style.cursor='default';\" onclick=\"doEdit('");
            sbResults.append(sBalanceUID);
            sbResults.append("');\"><img src='");
            sbResults.append(request.getContextPath());
            sbResults.append("/_img/icons/icon_edit.png' alt='edit'></td>" + "<td>");
