    ...
    <table class='list' border='0' width='100%' cellspacing='1'>
        ...
        <tr>
            ...
            <td class='admin2'>
                ...
                <img src="<c:url value="/_img/icons/icon_search.png"/>" class="link" alt="<%=getTranNoLink("Web","select",sWebLanguage)%>" onclick="searchPrestation('EditDebetPrestationUID','EditDebetPrestationName');">
                <img src="<c:url value="/_img/icons/icon_delete.png"/>" class="link" alt="<%=getTranNoLink("Web","clear",sWebLanguage)%>" onclick="EditForm.EditDebetPrestationUID.value='';EditForm.EditDebetPrestationName.value='';">
            </td>
        </tr>
        <%-- description --%>
        <tr>
        ...
        <tr>
            ...
            <td class='admin2'>
                ...
                <img src="<c:url value="/_img/icons/icon_search.png"/>" class="link" alt="<%=getTranNoLink("Web","select",sWebLanguage)%>" onclick="searchEncounter('EditDebetEncounterUID','EditDebetEncounterName');">
                <img src="<c:url value="/_img/icons/icon_delete.png"/>" class="link" alt="<%=getTranNoLink("Web","clear",sWebLanguage)%>" onclick="EditForm.EditDebetEncounterUID.value='';EditForm.EditDebetEncounterName.value='';">
            </td>
        </tr>
        ...
        <tr>
            ...
            <td class='admin2'>
                ...
                <img src="<c:url value="/_img/icons/icon_search.png"/>" class="link" alt="<%=getTranNoLink("Web","select",sWebLanguage)%>" onclick="searchSupplier('EditDebetSupplierUID','EditDebetSupplierName');">
                <img src="<c:url value="/_img/icons/icon_delete.png"/>" class="link" alt="<%=getTranNoLink("Web","clear",sWebLanguage)%>" onclick="EditForm.EditDebetSupplierUID.value='';EditForm.EditDebetSupplierName.value='';">
            </td>
        </tr>
