            ...
            <table class="list" border="0" width="534" cellspacing="1">
                ...
                <tr>
                    ...
                    <td class="admin2">
                        ...
                        <script>document.getElementById("beginDateSelector").innerHTML = getMyDate("Begin","<c:url value='/_img/icons/icon_agenda.png'/>","<%=getTran(null,"web","putToday",sWebLanguage)%>",true,false);</script>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="admin2">
                        ...
                        <%-- date selector (only past) --%>
                        <script>document.getElementById("endDateSelector").innerHTML = getMyDate("End","<c:url value='/_img/icons/icon_agenda.png'/>","<%=getTran(null,"web","putToday",sWebLanguage)%>",true,false);</script>
                    </td>
                </tr>
