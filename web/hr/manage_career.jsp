    ...
    <table class="list" border="0" width="100%" cellspacing="1">
        ...
        <tr>
            ...
            <td class="admin2">
                ...
                <%-- buttons --%>
                <img src="<c:url value="/_img/icons/icon_search.png"/>" class="link" alt="<%=getTranNoLink("web","select",sWebLanguage)%>" onclick="searchService('service','serviceName');">
                <img src="<c:url value="/_img/icons/icon_delete.png"/>" class="link" alt="<%=getTranNoLink("web","clear",sWebLanguage)%>" onclick="document.getElementById('service').value='';document.getElementById('serviceName').value='';">
            </td>
        </tr>
