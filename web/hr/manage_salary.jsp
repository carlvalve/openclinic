    ...
    <table class="list" border="0" width="100%" cellspacing="1">        
        ...
        <tr>
            ...
            <td class="admin2">
                ...
                <%-- buttons --%>
                <img src="<c:url value="/_img/icons/icon_search.png"/>" class="link" alt="<%=getTranNoLink("web","select",sWebLanguage)%>" onclick="searchContract('contract','contractName');">
                <img src="<c:url value="/_img/icons/icon_delete.png"/>" class="link" alt="<%=getTranNoLink("web","clear",sWebLanguage)%>" onclick="document.getElementById('contract').value='';document.getElementById('contractName').value='';">
            </td>
        </tr>
