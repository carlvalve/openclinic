		...
		try{
			...
			if(present.size()>0){
				...
				while(i.hasNext()){
					...
					out.println("<b><img height='14px' src='"+sCONTEXTPATH+"/_img/icons/icon_delete.gif' onclick='deleteSymptom(\""+encounter.getUid()+"\","+sItem.split(";")[1]+");'/>"+sItem.split(";")[0]+"</b>");
				}
				out.println("</td></tr>");
			}
			if(absent.size()>0){
				...
				while(i.hasNext()){
					...
					String sItem=(String)i.next();
					out.println("<font style='text-decoration:line-through'><img height='14px' src='"+sCONTEXTPATH+"/_img/icons/icon_delete.gif' onclick='deleteSymptom(\""+encounter.getUid()+"\","+sItem.split(";")[1]+");'/>"+sItem.split(";")[0]+"</font>");
				}
				out.println("</td></tr>");
			}
		}
