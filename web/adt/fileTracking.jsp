	...
	<table width='100%'>
		...
		<tr>
			...
			<td class='admin2'>
	            ...
	            <img src='_img/icons/icon_search.gif' class='link' alt='<%=getTranNoLink("Web","select",sWebLanguage)%>' onclick='searchService("fileFrom","fileFromName");'>&nbsp;
	            <img src='_img/icons/icon_delete.gif' class='link' alt='<%=getTranNoLink("Web","clear",sWebLanguage)%>' onclick='fileFrom.value="";fileFromName.value="";'>
			</td>
			<td class='admin2'>
	            ...
	            <img src='_img/icons/icon_search.gif' class='link' alt='<%=getTranNoLink("Web","select",sWebLanguage)%>' onclick='searchService("fileTo","fileToName");'>&nbsp;
	            <img src='_img/icons/icon_delete.gif' class='link' alt='<%=getTranNoLink("Web","clear",sWebLanguage)%>' onclick='fileTo.value="";fileToName.value="";'>
			</td>
			<td class='admin2'>
                ...
                <img src="<c:url value="/_img/icons/icon_search.gif"/>" class="link" alt="<%=getTran(request,"web","select",sWebLanguage)%>" onclick="searchManager('fileUser','fileUserName');">
                <img src="<c:url value="/_img/icons/icon_delete.gif"/>" class="link" alt="<%=getTran(request,"web","clear",sWebLanguage)%>" onclick="fileUser.value='';fileUserName.value='';">
		...
		<%
			...
			while(rs.next()){
				...
				if(activeUser.getAccessRight("add.filetracking.delete")){
					delete="<img src='"+sCONTEXTPATH+"/_img/icons/icon_delete.gif' onclick='deleteFileTracking("+rs.getInt("OC_FILETRACKING_ID")+")'/>";
				}
				out.println("<tr>");
