    ...
    while(encIter.hasNext()){
        ...
        sbResults.append("<tr id='"+(bFinished?"finished":"")+"' class='list"+sInactive+sClass+"'")
                 .append("onmouseover=\"this.style.cursor='pointer';\" onmouseout=\"this.style.cursor='default';\">")
                  .append("<td id='"+tmpEnc.getUid()+"' width='20px' onclick=\"deleteEncounter('"+tmpEnc.getUid()+"');\"><img class='hand' src='/openclinic/_img/icons/icon_delete.png' alt='"+getTranNoLink("Web.Occup","medwan.common.delete",sWebLanguage)+"' border='0'></td>")
