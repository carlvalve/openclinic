...
<form name="transactionForm" id="transactionForm" method="POST" action='<c:url value="/healthrecord/updateTransaction.do"/>?ts=<%=getTs()%>'>
    ...
    <table border='0' width='100%' align='center' cellspacing="1" class="list">
        ...
        <tr>
            ...
            <td class="admin2">
                <textarea onKeyup="resizeTextarea(this,10);" class="text" <%=setRightClick(session,"ITEM_TYPE_ABSENT_REASON")%> cols="75" rows="2" id="absent_reason" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_ABSENT_REASON" property="itemId"/>]>.value"><mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_ABSENT_REASON" property="value"/></textarea>
