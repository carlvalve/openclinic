            ...
            <td style="vertical-align:top;padding:0px;" class="admin2">           
			    <table class="list" width="100%" cellspacing="1">			    
				    ...
				    <tr>
				        ...
				        <td class="admin2">
				            <textarea onKeyup="resizeTextarea(this,10);limitChars(this,255);" class="text" <%=setRightClick(session,"ITEM_TYPE_PHYSIO_CONS_DIAG_MEDIC")%> cols="80" rows="2" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_PHYSIO_CONS_DIAG_MEDIC" property="itemId"/>]>.value"><mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_PHYSIO_CONS_DIAG_MEDIC" property="value"/></textarea>
				        </td>
				    </tr>
				    ...
				    <tr>
				        ...
				        <td class="admin2">
				            <textarea onKeyup="resizeTextarea(this,10);limitChars(this,255);" class="text" <%=setRightClick(session,"ITEM_TYPE_PHYSIO_CONS_DIAG_PHYS")%> cols="80" rows="2" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_PHYSIO_CONS_DIAG_PHYS" property="itemId"/>]>.value"><mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_PHYSIO_CONS_DIAG_PHYS" property="value"/></textarea>
				        </td>
				    </tr>
