    ...
    <table class="list" width="100%" cellspacing="1">
        ...
        %>
                <tr class='list<%=sClass%>' >
                    <td>
                        <img src="<c:url value='/_img/icons/icon_edit.png'/>" alt="<%=getTranNoLink("web","edit",sWebLanguage)%>" onclick="doOpen('<%=reference.getUid()+"','"+sPatientID%>')"/>
                    </td>
    ...
    <table class="list" width="100%" cellspacing="1">
        ...
        %>
                <tr class='list<%=sClass%>' >
                     <td>
                        <img src="<c:url value='/_img/icons/icon_edit.png'/>" alt="<%=getTranNoLink("web","edit",sWebLanguage)%>" onclick="doOpen('<%=reference.getUid()+"','"+sPatientID%>')"/>
                        <img src="<c:url value='/_img/icons/icon_agenda.png'/>" alt="<%=getTranNoLink("web","planning",sWebLanguage)%>" onclick="doAgenda('<%=ScreenHelper.getSQLDate(reference.getRequestDate())+"','"+sPatientID%>')"/>
                    </td>
                    <td><%=sPatientName%></td><td><%=ScreenHelper.getSQLDate(reference.getRequestDate())%></td><td><%=sServiceName%></td>
                    <td><%=checkString(reference.getStatus())%></td><td><%=ScreenHelper.getSQLDate(reference.getExecutionDate())%></td><td><%=sCreatedByName%></td>
                </tr>
