...
<table cellspacing="1" cellpadding="0" width="100%" border="0" id="fetalDescription" class="list">
   <tr class="admin">
        <td colspan="4"><%=getTran(request,"openclinic.chuk","obreport.fetal.description",sWebLanguage).toUpperCase()%></td>
   </tr>
   <tr>
        <td class="admin" width="<%=sTDAdminWidth%>"><%=getTran(request,"openclinic.chuk","obreport.fetal.position",sWebLanguage)%></td>
        ...
        <td class="admin" width="<%=sTDAdminWidth%>"><%=getTran(request,"openclinic.chuk","obreport.fetal.head",sWebLanguage)%></td>
        <td class="admin2">
   ...
   <tr>
        <td class="admin" ><%=getTran(request,"openclinic.chuk","obreport.fetal.spine",sWebLanguage)%></td>
        <td class="admin2">
        ...
        <td class="admin" ><%=getTran(request,"openclinic.chuk","obreport.placenta.location",sWebLanguage)%></td>
        <td class="admin2">
   ...
   <tr>
        <td class="admin" ><%=getTran(request,"openclinic.chuk","obreport.placenta.grade",sWebLanguage)%></td>
        <td class="admin2">
        ...
        <td class="admin" ><%=getTran(request,"openclinic.chuk","obreport.3v.cord",sWebLanguage)%></td>
        <td class="admin2">
    ...
    <tr>
        <td class="admin" ><%=getTran(request,"openclinic.chuk","obreport.cord.insertion",sWebLanguage)%></td>
        <td class="admin2">
        ...
        <td class="admin" ><%=getTran(request,"openclinic.chuk","obreport.amniotic.fluid",sWebLanguage)%></td>
        <td class="admin2">
    ...
    <tr>
        <td class="admin" ><%=getTran(request,"openclinic.chuk","obreport.face",sWebLanguage)%></td>
        <td class="admin2">
   ...
   <%-- fetal BRAIN ----------------------------------------------------------------------%>
    <tr class="admin">
        <td colspan="4"><%=getTran(request,"openclinic.chuk","obreport.fetal.brain",sWebLanguage).toUpperCase()%></td>
    </tr>
    <tr>
        <td class="admin" ><%=getTran(request,"openclinic.chuk","obreport.lateral.ventricles",sWebLanguage)%></td>
        <td class="admin2">
        ...
        <td class="admin" ><%=getTran(request,"openclinic.chuk","obreport.cerebellum",sWebLanguage)%></td>
        <td class="admin2">
    ...
    <tr>
        <td class="admin" ><%=getTran(request,"openclinic.chuk","obreport.cist.magna",sWebLanguage)%></td>
        <td class="admin2">
    ...
    <%-- fetal ABDOMEN ----------------------------------------------------------------------%>
    <tr class="admin">
        <td colspan="4"><%=getTran(request,"openclinic.chuk","obreport.fetal.abdomen",sWebLanguage).toUpperCase()%></td>
    </tr>
    <tr>
        <td class="admin" ><%=getTran(request,"openclinic.chuk","obreport.abdominal.wall",sWebLanguage)%></td>
        <td class="admin2">
        ...
        <td class="admin" ><%=getTran(request,"openclinic.chuk","obreport.stomach",sWebLanguage)%></td>
        <td class="admin2">
    ...
    <tr>
        <td class="admin" ><%=getTran(request,"openclinic.chuk","obreport.right.kidney",sWebLanguage)%></td>
        <td class="admin2">
        ...
        <td class="admin" ><%=getTran(request,"openclinic.chuk","obreport.upper.extremities",sWebLanguage)%></td>
        <td class="admin2">
    ...
    <tr>
        <td class="admin" ><%=getTran(request,"openclinic.chuk","obreport.commentair",sWebLanguage)%></td>
        <td class="admin2">
    ...
    <%-- BIOPHYSICAL PROFILE ----------------------------------------------------------------------%>
   <tr class="admin">
       <td colspan="4"><%=getTran(request,"openclinic.chuk","obreport.biophysical.profile",sWebLanguage).toUpperCase()%></td>
   </tr>
   <tr>
       <td class="admin" ><%=getTran(request,"openclinic.chuk","obreport.nonstress.test",sWebLanguage)%></td>
       <td class="admin2">
       ...
       <td class="admin" ><%=getTran(request,"openclinic.chuk","obreport.fetal.moves",sWebLanguage)%></td>
       <td class="admin2">
       ...
       <tr>
       <td class="admin" ><%=getTran(request,"openclinic.chuk","obreport.fetal.breath.moves",sWebLanguage)%></td>
       <td class="admin2">
       ...
       <td class="admin" ><%=getTran(request,"openclinic.chuk","obreport.fetal.tone",sWebLanguage)%></td>
       <td class="admin2">
    ...
    <tr>
       ...
       <td class="admin" ><%=getTran(request,"openclinic.chuk","obreport.total",sWebLanguage)%></td>
       <td class="admin2">
    ...
    <%-- MATERNAL SURVEY ----------------------------------------------------------------------%>
    <tr class="admin">
       <td colspan="4"><%=getTran(request,"openclinic.chuk","obreport.maternal.survey",sWebLanguage).toUpperCase()%></td>
    </tr>
    <tr>
        <td class="admin" ><%=getTran(request,"openclinic.chuk","obreport.uterus",sWebLanguage)%></td>
        <td class="admin2">
        ...
        <td class="admin" ><%=getTran(request,"openclinic.chuk","obreport.left.ovary",sWebLanguage)%></td>
        <td class="admin2">
    ...
    <tr>
        <td class="admin" ><%=getTran(request,"openclinic.chuk","obreport.kidneys",sWebLanguage)%></td>
        <td class="admin2">
        ...
        <td class="admin" ><%=getTran(request,"openclinic.chuk","obreport.right.ovary",sWebLanguage)%></td>
        <td class="admin2">
    ...
    <tr>
        <td class="admin" ><%=getTran(request,"openclinic.chuk","obreport.adnexa",sWebLanguage)%></td>
        <td class="admin2">
