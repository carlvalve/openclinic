...
<table width="100%" class="list" cellspacing="0">
    <tr class="admin">
        <td><%=getTran(request,"Web.Occup","medwan.healthrecord.anamnese.vasculaire",sWebLanguage)%></td>
        <td align="right" width="20%">
            <%=getLabel(request,"Web.Occup","medwan.common.nothing-to-mention",sWebLanguage,"vasc-c1")%>&nbsp;<input name="vascular-ras" type="checkbox" id="vasc-c1" value="medwan.common.true" onclick="if (this.checked == true) {hide('VASCULAR-details');setTrue('<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_VASCULAR_RAS" property="itemId"/>'); } else {show('VASCULAR-details');setFalse('<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_VASCULAR_RAS" property="itemId"/>'); }">
        </td>
