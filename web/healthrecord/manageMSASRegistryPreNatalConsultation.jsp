...
<%=checkPermission("msas.registry.prenatal","select",activeUser)%>
	        	...
	        	<table width='100%'>
			        ...
			        <tr>
			            ...
			            <td class='admin2' colspan="3">
	                        ...
	                        <script>writeMyDate("vatdate", "<c:url value="/_img/icons/icon_agenda.gif"/>", "<%=getTran(null,"Web","PutToday",sWebLanguage)%>");</script>
			            </td>
			        </tr>
			        <tr>
