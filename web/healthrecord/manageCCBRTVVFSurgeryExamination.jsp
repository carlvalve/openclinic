...
<%=checkPermission("occup.ccbrt.vvfsurgery","select",activeUser)%>
...
<form name="transactionForm" id="transactionForm" method="POST" action='<c:url value="/healthrecord/updateTransaction.do"/>?ts=<%=getTs()%>'>
    ...
    <table class="list" width="100%" cellspacing="1">
		...
		<tr>
            ...
            <td class='admin2'>
                <textarea onKeyup="resizeTextarea(this,10);limitChars(this,512);" <%=setRightClick("ITEM_TYPE_VVF_SURGERY_COMMENT")%> class="text" cols='80' rows='2' name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_VVF_SURGERY_COMMENT" property="itemId"/>]>.value"><mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_VVF_SURGERY_COMMENT" property="value"/></textarea>
            </td>
		</tr>
		<tr>
