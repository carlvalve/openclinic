		...
		<tr>
			<td style="vertical-align:top;padding:0;" class="admin2">
			    <table class="list" width="100%" cellspacing="1">
			        ...
			        <tr>
			            <td class="admin" colspan="2"><%=getTran("Web","surgical.examination",sWebLanguage)%></td>
			            <td class="admin2">
			        ...
			        <%-- pression-arterielle --%>
			        <tr>
			            <td class="admin" rowspan="2" width="100"><%=getTran("Web.Occup","medwan.healthrecord.cardial.pression-arterielle",sWebLanguage)%></td>
			        ...
			        <tr>
			            <%-- left --%>
			            <td class="admin" width="80"><%=getTran("Web.Occup","medwan.healthrecord.cardial.bras-gauche",sWebLanguage)%></td>
			            <td class="admin2">
