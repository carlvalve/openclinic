...
<script>
  ...
  function calculateBMI(){
		...
		<tr>
			<td style="vertical-align:top;padding:0;" class="admin2">
			    <table class="list" width="100%" cellspacing="1">
			        ...
			        <tr>
			            <td class="admin" colspan="2"><%=getTran(request,"Web","surgical.examination",sWebLanguage)%></td>
			            <td class="admin2">
			                <textarea onKeyup="resizeTextarea(this,10);limitChars(this,255);" <%=setRightClick(session,"ITEM_TYPE_NURSE_COMPLAINTS")%> class="text" cols="80" rows="2" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_NURSE_COMPLAINTS" property="itemId"/>]>.value"><mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_NURSE_COMPLAINTS" property="value"/></textarea>
			            </td>
			        </tr>
			
			        <%-- URINE ---------------------------------------------------------------------------------------------------%>
			        <tr class="admin">
			            <td colspan="3"><%=getTran(request,"Web.Occup","be.mxs.common.model.vo.healthrecord.IConstants.TRANSACTION_TYPE_URINE_EXAMINATION",sWebLanguage)%></td>
			        </tr>
			        ...
			        <%-- BIOMETRY -------------------------------------------------------------------------------------------------%>
			        <tr class="admin">
			            <td colspan="3"><%=getTran(request,"Web.Occup","be.mxs.common.model.vo.healthrecord.IConstants.TRANSACTION_TYPE_BIOMETRY",sWebLanguage)%></td>
			        </tr>
			        <tr>
			            <td class='admin' colspan="2"><%=getTran(request,"openclinic.chuk","temperature",sWebLanguage)%>&nbsp;(°C)</td>
			        ...
			        <tr>
			            <td class='admin' colspan="2"><%=getTran(request,"Web.Occup","medwan.healthrecord.biometry.length",sWebLanguage)%>&nbsp;</td>
			        ...
			        <tr>
			            <td class='admin' colspan="2"><%=getTran(request,"Web.Occup","medwan.healthrecord.biometry.bmi",sWebLanguage)%>&nbsp;</td>
			            <td class='admin2'><input tabindex="-1" class="text" type="text" size="10" readonly name="BMI"></td>
			        </tr>
			
			        <%-- CARDIAL -------------------------------------------------------------------------------------------------%>
			        <tr class="admin">
			            <td colspan="3"><%=getTran(request,"Web.Occup","medwan.healthrecord.anamnese.cardial",sWebLanguage)%></td>
			        </tr>
			        
			        <%-- frequence-cardiaque --%>
			        <tr>
			            <td class='admin' colspan="2"><%=getTran(request,"Web.Occup","medwan.healthrecord.cardial.frequence-cardiaque",sWebLanguage)%></td>
			            <td class='admin2'>
			        ...
			        <%-- pression-arterielle --%>
			        <tr>
			            <td class="admin" rowspan="2" width="100"><%=getTran(request,"Web.Occup","medwan.healthrecord.cardial.pression-arterielle",sWebLanguage)%></td>
			            
			            <%-- right --%>
			            <td class="admin"><%=getTran(request,"Web.Occup","medwan.healthrecord.cardial.bras-droit",sWebLanguage)%></td>
			        ...
			        <tr>
			            <%-- left --%>
			            <td class="admin" width="80"><%=getTran(request,"Web.Occup","medwan.healthrecord.cardial.bras-gauche",sWebLanguage)%></td>
			            <td class="admin2">
	...
	<%=ScreenHelper.alignButtonsStart()%>
	    <%=getButtonsHtml(request,activeUser,activePatient,"occup.nurseexamination",sWebLanguage)%>
