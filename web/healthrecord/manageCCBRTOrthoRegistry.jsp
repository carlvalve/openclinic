	        	...
	        	<table width='100%'>
			        ...
			        <tr>
			            ...
			            <td class="admin2" colspan="6">
							...
							<img src='<c:url value="/_img/icons/icon_search.png"/>' class='link' alt='<%=getTranNoLink("Web","select",sWebLanguage)%>' onclick='searchService("unit","unitname");'>				            
							<img src='<c:url value="/_img/icons/icon_delete.png"/>' class='link' alt='<%=getTranNoLink("Web","clear",sWebLanguage)%>' onclick='document.getElementById("unit").value="";document.getElementById("unitname").value="";'>				            
						</td>
			        </tr>
		        	<tr>
