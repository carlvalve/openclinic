    ...
    private StringBuffer addTooth(int iTotal, String sDate, String sToothNr, String sDescription,
        ...
        sTmp.append("<tr id='rowTooth").append(iTotal).append("'>")
             .append("<td class='admin2'>")
              .append("<a href='javascript:deleteTooth(rowTooth").append(iTotal).append(");'><img src='"+sCONTEXTPATH+"/_img/icons/icon_delete.png' alt='"+getTranNoLink("Web.Occup","medwan.common.delete",sWebLanguage)+"' border='0'></a> ")
              .append("<a href='javascript:editTooth(rowTooth").append(iTotal).append(");'><img src='"+sCONTEXTPATH+"/_img/icons/icon_edit.png' alt='"+getTranNoLink("Web.Occup","medwan.common.edit",sWebLanguage)+"' border='0'></a>")
             .append("</td>")
...
%>
    ...
    <table class="list" cellspacing="1" cellpadding="0" width="100%">
        ...
        <tr>
            ...
            <td class="admin2">
                <textarea onKeyup="resizeTextarea(this,10);limitChars(this,255);" <%=setRightClick(session,"ITEM_TYPE_STOMATOLOGY_DENTIST_STATE")%> class="text" cols="100" rows="2" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_STOMATOLOGY_DENTIST_STATE" property="itemId"/>]>.value"><mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_STOMATOLOGY_DENTIST_STATE" property="value"/></textarea>
            </td>
        </tr>
