...
<table class="list" width="100%" cellspacing="1">
    ...
    <%-- category --%>
    <tr>
        <td class="admin"><%=getTran(request,"Web.Occup","medwan.common.driving-license-declaration.candidate-questionnaire.actual-category-or-sub-category",sWebLanguage)%></td>
        <td class="admin2">
    ...
    <%-- delivery place --%>
    <tr>
        <td class="admin"><%=getTran(request,"Web.Occup","medwan.common.driving-license-declaration.candidate-questionnaire.delivery-place",sWebLanguage)%></td>
        <td class="admin2">
    ...
    <%-- expiration date --%>
    <tr>
        <td class="admin"><%=getTran(request,"Web.Occup","medwan.common.driving-license-declaration.candidate-questionnaire.expiration-date",sWebLanguage)%></td>
        <td class="admin2">
            <input type="text" class="text" size="12" maxLength="10" value="<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_DLD_VALIDITY_DATE" property="value" formatType="date"/>" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N  name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_DLD_VALIDITY_DATE" property="itemId"/>]>.value" id="validdate" onBlur="checkDate(this);"> <script>writeMyDate("validdate","<c:url value="/_img/calbtn.gif"/>","<%=getTran(null,"Web","PutToday",sWebLanguage)%>");</script>
        </td>
    </tr>

    <%-- questionnaire valid for category --%>
    <tr>
        <td class="admin"><%=getTran(request,"Web.Occup","medwan.common.driving-license-declaration.candidate-questionnaire.valide-for-category",sWebLanguage)%></td>
        <td class="admin2">
    ...
    <tr>
        <td class="admin">
            <%=getTran(request,"Web.Occup","medwan.common.driving-license-declaration.candidate-questionnaire.if-applicable",sWebLanguage)%>&nbsp;:
            <br>&nbsp;&nbsp;
            <%=getTran(request,"Web.Occup","medwan.common.driving-license-declaration.candidate-questionnaire.previous-examination-date",sWebLanguage)%>
            <br>&nbsp;&nbsp;
            <%=getTran(request,"Web.Occup","medwan.common.driving-license-declaration.candidate-questionnaire.examination-doctor-name",sWebLanguage)%>
        </td>
        <td class="admin2">
            <br>
            <input type="text" class="text" size="12" maxLength="10" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N  name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_DLD_EXAMINATION_DATE" property="itemId"/>]>.value" value="<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_DLD_EXAMINATION_DATE" property="value" formatType="date"/>" id="nextdate" onBlur='if(checkDate(this)){ checkAfter("trandate",this); }'> <script>writeMyDate("nextdate","<c:url value="/_img/calbtn.gif"/>","<%=getTran(null,"Web","PutToday",sWebLanguage)%>");</script>
            <br>
        ...
        <td colspan="2">
            <table border='0' width='100%' class='list' cellspacing="1">
                ...
                <tr>
                    ...
                    <td width="*">
                        <%=getTran(request,"Web.Occup","medwan.common.driving-license-declaration.candidate-questionnaire",sWebLanguage)%>
                    </td>
                    ...
                    <td colspan="3">
                        <table class="list" width="100%" cellspacing="1">
                            <tr>
                                ...
                                <td class="admin2" width="5%"><%=getTran(request,"Web.Occup","medwan.common.yes",sWebLanguage)%></td>
                                <td class="admin2" width="5%"><%=getTran(request,"Web.Occup","medwan.common.no",sWebLanguage)%></td>
                            </tr>
                            <tr>
                                <td class="admin" width="1%">1</td>
                                <td class="admin" width="90%"><%=getTran(request,"Web.Occup","medwan.common.driving-license-declaration.candidate-questionnaire.question-1",sWebLanguage)%></td>
                            ...
                            <tr>
                                ...
                                <td class="admin" width="90%"><%=getTran(request,"Web.Occup","medwan.common.driving-license-declaration.candidate-questionnaire.question-2",sWebLanguage)%></td>
                            ...
                            <tr>
                                ...
                                <td class="admin" width="90%"><%=getTran(request,"Web.Occup","medwan.common.driving-license-declaration.candidate-questionnaire.question-3",sWebLanguage)%></td>
                            ...
                            <tr>
                                ...
                                <td class="admin" width="90%"><%=getTran(request,"Web.Occup","medwan.common.driving-license-declaration.candidate-questionnaire.question-4",sWebLanguage)%></td>
                            ...
                            <tr>
                                ...
                                <td class="admin" width="90%"><%=getTran(request,"Web.Occup","medwan.common.driving-license-declaration.candidate-questionnaire.question-5",sWebLanguage)%></td>
                            ...
                            <tr>
                                ...
                                <td class="admin" width="90%"><%=getTran(request,"Web.Occup","medwan.common.driving-license-declaration.candidate-questionnaire.question-6",sWebLanguage)%></td>
                            ...
                            <tr>
                                ...
                                <td class="admin" width="90%"><%=getTran(request,"Web.Occup","medwan.common.driving-license-declaration.candidate-questionnaire.question-7",sWebLanguage)%></td>
                            ...
                            <tr>
                                ...
                                <td class="admin" width="90%"><%=getTran(request,"Web.Occup","medwan.common.driving-license-declaration.candidate-questionnaire.question-8",sWebLanguage)%></td>
                            ...
                            <tr>
                                ...
                                <td class="admin" width="90%"><%=getTran(request,"Web.Occup","medwan.common.driving-license-declaration.candidate-questionnaire.question-9",sWebLanguage)%></td>
                            ...
                            <tr>
                                ...
                                <td class="admin" width="90%"><%=getTran(request,"Web.Occup","medwan.common.driving-license-declaration.candidate-questionnaire.question-10",sWebLanguage)%></td>
                            ...
                            <tr>
                                ...
                                <td class="admin" width="90%"><%=getTran(request,"Web.Occup","medwan.common.driving-license-declaration.candidate-questionnaire.question-11",sWebLanguage)%></td>
                            ...
                            <tr>
                                ...
                                <td class="admin" width="90%"><%=getTran(request,"Web.Occup","medwan.common.driving-license-declaration.candidate-questionnaire.question-12",sWebLanguage)%></td>
                            ...
                            <tr>
                                ...
                                <td class="admin" width="90%"><%=getTran(request,"Web.Occup","medwan.common.driving-license-declaration.candidate-questionnaire.question-13",sWebLanguage)%></td>
                            ...
                            <tr>
                                ...
                                <td class="admin" width="90%"><%=getTran(request,"Web.Occup","medwan.common.driving-license-declaration.candidate-questionnaire.question-14",sWebLanguage)%></td>
                            ...
                            <tr>
                                ...
                                <td class="admin" width="90%"><%=getTran(request,"Web.Occup","medwan.common.driving-license-declaration.candidate-questionnaire.question-15",sWebLanguage)%></td>
                            ...
                            <tr>
                                ...
                                <td class="admin" width="90%"><%=getTran(request,"Web.Occup","medwan.common.driving-license-declaration.candidate-questionnaire.question-16",sWebLanguage)%></td>
                            ...
                            <tr>
                                ...
                                <td class="admin" width="90%"><%=getTran(request,"Web.Occup","medwan.common.driving-license-declaration.candidate-questionnaire.question-17",sWebLanguage)%></td>
                            ...
                            <tr>
                                ...
                                <td class="admin" width="90%"><%=getTran(request,"Web.Occup","medwan.common.driving-license-declaration.candidate-questionnaire.question-18",sWebLanguage)%></td>
                            ...
                            <tr>
                                ...
                                <td class="admin" width="90%"><%=getTran(request,"Web.Occup","medwan.common.driving-license-declaration.candidate-questionnaire.question-19",sWebLanguage)%></td>
                            ...
                            <tr>
                                ...
                                <td class="admin" width="90%"><%=getTran(request,"Web.Occup","medwan.common.driving-license-declaration.candidate-questionnaire.question-20",sWebLanguage)%></td>
                            ...
                            <tr>
                                <td class="admin" width="1%">&nbsp;</td>
                                <td class="admin" width="100%"><%=getTran(request,"Web.Occup","medwan.common.driving-license-declaration.candidate-questionnaire.commitment",sWebLanguage)+" "+getTran(request,"Web.Occup","medwan.common.driving-license-declaration.candidate-questionnaire.commitment1",sWebLanguage)%></td>
