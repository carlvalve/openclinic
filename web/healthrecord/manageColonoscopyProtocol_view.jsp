...
<%-- BUTTONS --%>
    <%
      if (activeUser.getAccessRight("occup.protocol.colonoscopy.add") || activeUser.getAccessRight("occup.protocol.colonoscopy.edit")){
    %>
