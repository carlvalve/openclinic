...
<form name="transactionForm" id="transactionForm" method="POST" action="<c:url value="/healthrecord/updateTransaction.do"/>?ts=<%=getTs()%>">
    ...
    <table width="100%" cellspacing="1" class="list">
        ...
        <%-- MUSCULAR FORCE ---------------------------------------------------------------------%>
        <tr class="gray">
            <td class="admin" style="vertical-align:top;padding:top:10px;"><%=getTran(request,"leprosy","muscularforce",sWebLanguage)%></td>
            <td>
                <table width="100%" cellspacing="1" class="list">
                    <%-- header --%>
                    <tr>
                    ...
                    <tr>
                        <td class="admin">
                            <%=getTran(request,"leprosy","occlusionocculaire",sWebLanguage)%>
                        </td>
                    ...
                    <tr>
                        <td class="admin">
                            <%=getTran(request,"leprosy","cinquiemedoigt",sWebLanguage)%>
                        </td>
                    ...
                    <tr>
                        <td class="admin">
                            <%=getTran(request,"leprosy","pouceenhaut",sWebLanguage)%>
                        </td>
                    ...
                    <tr>
                        <td class="admin">
                            <%=getTran(request,"leprosy","piedenhaut",sWebLanguage)%>
                        </td>
        ...
        <%-- YEUX -------------------------------------------------------------------------------%>
        <tr class="gray">
            <td class="admin" style="vertical-align:top;padding:top:10px;"><%=getTran(request,"leprosy","yeux",sWebLanguage)%></td>
            <td>
                <table width="100%" cellspacing="1" class="list">
                    <%-- header --%>
                    <tr>
                    ...
                    <tr>
                        <td class="admin">
                            <%=getTran(request,"leprosy","acuitevisuelle",sWebLanguage)%>
                        </td>
        ...
        <tr class="gray" style="vertical-align:top;padding:top:10px;">
            <td class="admin"><%=getTran(request,"leprosy","cotationdesinfirmites",sWebLanguage)%></td>
            <td>
                <table width="100%" cellspacing="1" class="list">
                    <%-- header --%>
                    <tr>
                    ...
                    <tr>
                        <td class="admin">
                            <%=getTran(request,"leprosy","oeil",sWebLanguage)%>
                        </td>
                    ...
                    <tr>
                        <td class="admin">
                            <%=getTran(request,"leprosy","main",sWebLanguage)%>
                        </td>
                    ...
                    <tr>
                        <td class="admin">
                            <%=getTran(request,"leprosy","pied",sWebLanguage)%>
                        </td>
