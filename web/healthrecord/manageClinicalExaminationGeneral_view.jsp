...
<table width="100%" class="list" cellspacing="0">
    <tr class="admin">
        <td><%=getTran(request,"Web.Occup","medwan.common.general",sWebLanguage)%></td>
        <td align="right" width="20%"><%=getLabel(request,"Web.Occup","medwan.common.nothing-to-mention",sWebLanguage,"mcegen-c1")%><input name="general-ras" type="checkbox" id="mcegen-c1" value="medwan.common.true" onclick="if (this.checked == true) {hide('general-details');setTrue('<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_GENERAL_RAS" property="itemId"/>'); } else {show('general-details');setFalse('<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_GENERAL_RAS" property="itemId"/>'); }"></td>
