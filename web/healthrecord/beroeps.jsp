...
<%!
    private String addBeroep(int iTotal, String sTmpBeroepDateBegin, String sTmpBeroepDateEnd, String sTmpBeroepDescr,
        ...
        sOut.append("<tr id='rowBeroeps"+iTotal+"'>")
            .append("<td width='36'>")
             .append("<a href='javascript:deleteBeroep(rowBeroeps"+iTotal+")'><img src='"+sCONTEXTPATH+"/_img/icons/icon_delete.png' alt='"+getTranNoLink("Web.Occup","medwan.common.delete",sWebLanguage)+"' border='0'></a> ")
             .append("<a href='javascript:editBeroep(rowBeroeps"+iTotal+")'><img src='"+sCONTEXTPATH+"/_img/icons/icon_edit.png' alt='"+getTranNoLink("Web.Occup","medwan.common.edit",sWebLanguage)+"' border='0'></a>")
            .append("</td>")
    ...
    private String addAO(int iTotal, String sTmpAODate, String sTmpAODescr, String sTmpAOBI, String sWebLanguage){
        return "<tr id='rowAO"+iTotal+"'>"
               +"<td width='36'>"
                +"<a href='javascript:deleteArbeidsOngeval(rowAO"+iTotal+")'><img src='"+sCONTEXTPATH+"/_img/icons/icon_delete.png' alt='"+getTranNoLink("Web.Occup","medwan.common.delete",sWebLanguage)+"' border='0'></a> "
                +"<a href='javascript:editArbeidsOngeval(rowAO"+iTotal+")'><img src='"+sCONTEXTPATH+"/_img/icons/icon_edit.png' alt='"+getTranNoLink("Web.Occup","medwan.common.edit",sWebLanguage)+"' border='0'></a>"
                +"</td>"
                +"<td>&nbsp;"+sTmpAODate+"</td>"
                +"<td>&nbsp;"+sTmpAODescr+"</td>"
    ...
    private String addBZ(int iTotal, String sTmpBZDate, String sTmpBZDescr, String sTmpBZBI, String sTmpBZErkenning, String sWebLanguage){
        ...
        sOut.append("<tr id='rowBZ"+iTotal+"'>")
            .append("<td width='36'>")
             .append("<a href='javascript:deleteBZ(rowBZ"+iTotal+")'><img src='"+sCONTEXTPATH+"/_img/icons/icon_delete.png' alt='"+getTranNoLink("Web.Occup","medwan.common.delete",sWebLanguage)+"' border='0'></a> ")
             .append("<a href='javascript:editBZ(rowBZ"+iTotal+")'><img src='"+sCONTEXTPATH+"/_img/icons/icon_edit.png' alt='"+getTranNoLink("Web.Occup","medwan.common.edit",sWebLanguage)+"' border='0'></a>")
            .append("</td>")
...
function addBeroep(){
  if(isAtLeastOneBeroepsFieldFilled()){
    ...
    if((beginDate!="" && endDate!="") && !before(beginDate,endDate)){
      ...
      row.cells[0].innerHTML = "<a href='javascript:deleteBeroep(rowBeroeps"+iIndexBeroeps+")'><img src='<%=sCONTEXTPATH%>/_img/icons/icon_delete.png' alt='<%=getTranNoLink("Web.Occup","medwan.common.delete",sWebLanguage)%>' border='0'></a> "
                              +"<a href='javascript:editBeroep(rowBeroeps"+iIndexBeroeps+")'><img src='<%=sCONTEXTPATH%>/_img/icons/icon_edit.png' alt='<%=getTranNoLink("Web.Occup","medwan.common.edit",sWebLanguage)%>' border='0'></a>";
...
function updateBeroep(){
  if(isAtLeastOneBeroepsFieldFilled()){
    ...
    row.cells[0].innerHTML = "<a href='javascript:deleteBeroep("+editBeroepRowid.id+")'><img src='<%=sCONTEXTPATH%>/_img/icons/icon_delete.png' alt='<%=getTranNoLink("Web.Occup","medwan.common.delete",sWebLanguage)%>' border='0'></a> "
	                        +"<a href='javascript:editBeroep("+editBeroepRowid.id+")'><img src='<%=sCONTEXTPATH%>/_img/icons/icon_edit.png' alt='<%=getTranNoLink("Web.Occup","medwan.common.edit",sWebLanguage)%>' border='0'></a>";
    row.cells[1].innerHTML = "&nbsp;"+transactionForm.BeroepsDateBegin.value;
    row.cells[2].innerHTML = "&nbsp;"+transactionForm.BeroepsDateEnd.value;
    row.cells[3].innerHTML = "&nbsp;"+transactionForm.BeroepsDescription.value;
...
function addArbeidsOngeval(){
  if(isAtLeastOneAOFieldFilled()){
	...
	row.cells[0].innerHTML = "<a href='javascript:deleteArbeidsOngeval(rowAO"+iIndexBeroeps+")'><img src='<%=sCONTEXTPATH%>/_img/icons/icon_delete.png' alt='<%=getTranNoLink("Web.Occup","medwan.common.delete",sWebLanguage)%>' border='0'></a> "
                            +"<a href='javascript:editArbeidsOngeval(rowAO"+iIndexBeroeps+")'><img src='<%=sCONTEXTPATH%>/_img/icons/icon_edit.png' alt='<%=getTranNoLink("Web.Occup","medwan.common.edit",sWebLanguage)%>' border='0'></a>";
...
function updateArbeidsOngeval(){
  if(isAtLeastOneAOFieldFilled()){
    ...
    row.cells[0].innerHTML = "<a href='javascript:deleteArbeidsOngeval("+editAORowid.id+")'><img src='<%=sCONTEXTPATH%>/_img/icons/icon_delete.png' alt='<%=getTranNoLink("Web.Occup","medwan.common.delete",sWebLanguage)%>' border='0'></a> "
                            +"<a href='javascript:editArbeidsOngeval("+editAORowid.id+")'><img src='<%=sCONTEXTPATH%>/_img/icons/icon_edit.png' alt='<%=getTranNoLink("Web.Occup","medwan.common.edit",sWebLanguage)%>' border='0'></a>";
    row.cells[1].innerHTML = "&nbsp;"+transactionForm.ArbeidsOngevallenDate.value;
    row.cells[2].innerHTML = "&nbsp;"+transactionForm.ArbeidsOngevallenDescription.value;
    row.cells[3].innerHTML = "&nbsp;"+sBI;
...
function addBZ(){
  if(isAtLeastOneBZFieldFilled()){
    ...
    row.cells[0].innerHTML = "<a href='javascript:deleteBZ(rowBZ"+iIndexBeroeps+")'><img src='<%=sCONTEXTPATH%>/_img/icons/icon_delete.png' alt='<%=getTranNoLink("Web.Occup","medwan.common.delete",sWebLanguage)%>' border='0'></a> "
	                        +"<a href='javascript:editBZ(rowBZ"+iIndexBeroeps+")'><img src='<%=sCONTEXTPATH%>/_img/icons/icon_edit.png' alt='<%=getTranNoLink("Web.Occup","medwan.common.edit",sWebLanguage)%>' border='0'></a>";
...
function updateBZ(){
  if(isAtLeastOneBZFieldFilled()){
    ...
    row.cells[0].innerHTML = "<a href='javascript:deleteBZ("+editBZRowid.id+")'><img src='<%=sCONTEXTPATH%>/_img/icons/icon_delete.png' alt='<%=getTranNoLink("Web.Occup","medwan.common.delete",sWebLanguage)%>' border='0'></a> "
	                        +"<a href='javascript:editBZ("+editBZRowid.id+")'><img src='<%=sCONTEXTPATH%>/_img/icons/icon_edit.png' alt='<%=getTranNoLink("Web.Occup","medwan.common.edit",sWebLanguage)%>' border='0'></a>";
    row.cells[1].innerHTML = "&nbsp;"+transactionForm.BeroepsziektenDate.value;
    row.cells[2].innerHTML = "&nbsp;"+transactionForm.BeroepsziektenDescription.value;
    row.cells[3].innerHTML = "&nbsp;"+sBI;
