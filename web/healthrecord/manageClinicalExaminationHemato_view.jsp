    ...
    <tr id="HEMATO-details" style="display:none" width="100%">
        <td colspan="4" width="100%">
            <table width="100%" cellspacing="1">
                ...
                <tr class="admin">
                    <td colspan="4">&nbsp; - <%=getTran(request,"Web.Occup","medwan.healthrecord.hemato.inspection",sWebLanguage)%></td>
                </tr>
                <tr>
                ...
                <tr class="admin">
                    <td colspan="4">&nbsp; - <%=getTran(request,"Web.Occup","medwan.healthrecord.hemato.palpation",sWebLanguage)%></td>
                </tr>
                <tr>
                ...
                <tr class="admin">
                    <td colspan="4">&nbsp; - <%=getTran(request,"Web.Occup","medwan.common.other",sWebLanguage)%></td>
                </tr>
                <tr>
