...
<table class="list" width="100%" border="0" cellspacing="1" cellpadding="0">
    <tr>
        ...
        <td style="vertical-align:top;" colspan="2" height="100%">
            <table class="list" width="100%" border="0" cellspacing="0" cellpadding="1" height="100%">
                ...
                <tr class="admin">
                    <td colspan="2" align="center" nowrap><%=getTran(request,"Web.Occup","medwan.healthrecord.clinical-examination.systeme-cardiovasculaire.TA",sWebLanguage)%>
                            (<%
        ...
        <td style="vertical-align:top;" colspan="2" height="100%">
            <table class="list" width="100%" border="0" cellspacing="0" cellpadding="0" height="100%">
                <tr class="admin">
                    <td align="center" width="33%"><%=getTran(request,"Web.Occup","medwan.healthrecord.biometry.weight",sWebLanguage)%></td>
                    <td align="center" width="33%"><%=getTran(request,"Web.Occup","medwan.healthrecord.biometry.length",sWebLanguage)%></td>
                    <td align="center" width="33%"><%=getTran(request,"Web.Occup","medwan.healthrecord.biometry.bmi",sWebLanguage)%></td>
                </tr>
                <tr height="100%">
                    <td align="center">
                         <b>
    ...
    <tr class="admin">
        <td align="center" width="50%" colspan="2"><%=getTran(request,"Web.Occup","medwan.healthrecord.general",sWebLanguage)%></td>
        <td align="center" width="50%" colspan="2"><%=getTran(request,"Web.Occup","medwan.healthrecord.specific",sWebLanguage)%></td>
    </tr>
    ...
    <tr>
        <td colspan="2">
            <table class="list" width="100%" height="100%" cellspacing="1">
                ...
                <tr class="admin">
                    <td align="center" colspan="4"><%=getTran(request,"Web.Occup","medwan.healthrecord.medication",sWebLanguage)%></td>
                </tr>
                <tr><td colspan="4">
                <%
        ...
        <td style="vertical-align:top;" colspan="2">
            <table class="list" width="100%" cellspacing="1">
                ...
                <tr>
                    <td class="admin2">
                        <img src='<c:url value="/_img/themes/default/pijl.gif"/>'>
                        <a  href="javascript:document.getElementsByName('sum_r4a')[0].checked=true;document.getElementsByName('sum_r4b')[0].checked=false;subScreen('/main.do?Page=healthrecord/abdominaal.jsp&be.mxs.healthrecord.transaction_id=currentTransaction&ts=<%=getTs()%>');"><%=getTran(request,"Web.Occup","Abdominaal_onderzoek",sWebLanguage)%></a>
                    </td>
                    <td align="right" class="admin2"> <%=getTran(request,"Web.Occup","medwan.healthrecord.anamnese.general.complaints",sWebLanguage)%>
                        <input <%=setRightClick(session,"ITEM_TYPE_ABDOMINAL_COMPLAINTS")%> id='sum_r4a' type="radio" onDblClick="uncheckRadio(this);" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_ABDOMINAL_COMPLAINTS" property="itemId"/>]>.value" <mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_ABDOMINAL_COMPLAINTS;value=medwan.common.true" property="value" outputString="checked"/> value="medwan.common.true"><label for="sum_r4a">+</label>
                        <input <%=setRightClick(session,"ITEM_TYPE_ABDOMINAL_COMPLAINTS")%> id='sum_r4b' type="radio" onDblClick="uncheckRadio(this);" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_ABDOMINAL_COMPLAINTS" property="itemId"/>]>.value" <mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_ABDOMINAL_COMPLAINTS;value=medwan.common.false" property="value" outputString="checked"/> value="medwan.common.false"><label for="sum_r4b">-</label>
                    </td>
                </tr>
                <tr>
                    <td class="admin2">
                        <img src='<c:url value="/_img/themes/default/pijl.gif"/>'>
                        <a  href="javascript:document.getElementsByName('sum_r5a')[0].checked=true;document.getElementsByName('sum_r5b')[0].checked=false;subScreen('/main.do?Page=healthrecord/locomotorisch_stelsel.jsp&be.mxs.healthrecord.transaction_id=currentTransaction&ts=<%=getTs()%>');"><%=getTran(request,"Web.Occup","Locomotorisch_stelsel",sWebLanguage)%></a>
                    </td>
                    <td align="right" class="admin2"> <%=getTran(request,"Web.Occup","medwan.healthrecord.anamnese.general.complaints",sWebLanguage)%>
                        <input <%=setRightClick(session,"ITEM_TYPE_ORTHO_COMPLAINTS")%> id='sum_r5a' type="radio" onDblClick="uncheckRadio(this);" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_ORTHO_COMPLAINTS" property="itemId"/>]>.value" <mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_ORTHO_COMPLAINTS;value=medwan.common.true" property="value" outputString="checked"/> value="medwan.common.true"><label for="sum_r5a">+</label>
                        <input <%=setRightClick(session,"ITEM_TYPE_ORTHO_COMPLAINTS")%> id='sum_r5b' type="radio" onDblClick="uncheckRadio(this);" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_ORTHO_COMPLAINTS" property="itemId"/>]>.value" <mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_ORTHO_COMPLAINTS;value=medwan.common.false" property="value" outputString="checked"/> value="medwan.common.false"><label for="sum_r5b">-</label>
                    </td>
                </tr>
                <tr>
                    <td class="admin2">
                        <img src='<c:url value="/_img/themes/default/pijl.gif"/>'>
                        <a  href="javascript:document.getElementsByName('sum_r6a')[0].checked=true;document.getElementsByName('sum_r6b')[0].checked=false;subScreen('/main.do?Page=healthrecord/neuro.jsp&be.mxs.healthrecord.transaction_id=currentTransaction&ts=<%=getTs()%>');"><%=getTran(request,"Web.Occup","Neuropsychiatrie",sWebLanguage)%></a>
                    </td>
                    <td align="right" class="admin2"> <%=getTran(request,"Web.Occup","medwan.healthrecord.anamnese.general.complaints",sWebLanguage)%>
                        <input <%=setRightClick(session,"ITEM_TYPE_NEURO_COMPLAINTS")%> id='sum_r6a' type="radio" onDblClick="uncheckRadio(this);" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_NEURO_COMPLAINTS" property="itemId"/>]>.value" <mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_NEURO_COMPLAINTS;value=medwan.common.true" property="value" outputString="checked"/> value="medwan.common.true"><label for="sum_r6a">+</label>
                        <input <%=setRightClick(session,"ITEM_TYPE_NEURO_COMPLAINTS")%> id='sum_r6b' type="radio" onDblClick="uncheckRadio(this);" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_NEURO_COMPLAINTS" property="itemId"/>]>.value" <mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_NEURO_COMPLAINTS;value=medwan.common.false" property="value" outputString="checked"/> value="medwan.common.false"><label for="sum_r6b">-</label>
                    </td>
                </tr>
            </table>
            ...
            <table class="list" width="100%" cellspacing="1">
                <tr class="admin">
                    <td align="center" colspan='2'><a href="javascript:openPopup('healthrecord/findICPC.jsp?ts=<%=getTs()%>&patientuid=<%=activePatient.personid %>');void(0);"><%=getTran(request,"Web.Occup","ICPC-2",sWebLanguage)%>/<%=getTran(request,"Web.Occup","ICD-10",sWebLanguage)%></a></td>
                </tr>
                <tr>
                        ...
                        <%
                            ...
                            if(activeProblems.size() > 0){
                                out.print("<table width='100%' cellspacing='0'>"+
                                           "<tr class='admin'>"+
                                            "<td>"+getTran(request,"web.occup","medwan.common.description",sWebLanguage)+"</td>"+
                                		    "<td nowrap>"+getTran(request,"web.occup","medwan.common.datebegin",sWebLanguage)+"</td>"+
                                           "</tr>");
                            }
  ...
  function setBP(oObject,sbp,dbp){
      if (oObject.value.length>0){
        if (!isNumberLimited(oObject,40,300)){
          ...
          window.showModalDialog?window.showModalDialog(popupUrl,'',modalities):alert('<%=getTran(null,"web.occup","out-of-bounds-value",sWebLanguage)%>');
        }
          ...
          if (idbp>isbp){
            ...
            var modalities = "dialogWidth:266px;dialogHeight:163px;center:yes;scrollbars:no;resizable:no;status:no;location:no;";
            window.showModalDialog?window.showModalDialog(popupUrl,'',modalities):alert('<%=getTran(null,"web.occup","error.dbp_greather_than_sbp",sWebLanguage)%>');
          }
        }
      }
  }
