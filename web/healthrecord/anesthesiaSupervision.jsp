    ...
    private StringBuffer addSA(int iTotal, String sHeure, String sSys, String sDias, String sRythme,
        ...
        sTmp.append("<tr id='rowSA"+iTotal+"'>")
             .append("<td class='admin2'>")
              .append("<a href='javascript:deleteSA(rowSA"+iTotal+")'><img src='"+sCONTEXTPATH+"/_img/icons/icon_delete.png' alt='"+getTranNoLink("Web.Occup","medwan.common.delete",sWebLanguage)+"' border='0'></a> ")
              .append("<a href='javascript:editSA(rowSA"+iTotal+")'><img src='"+sCONTEXTPATH+"/_img/icons/icon_edit.png' alt='"+getTranNoLink("Web.Occup","medwan.common.edit",sWebLanguage)+"' border='0'></a>")
             .append("</td>")
