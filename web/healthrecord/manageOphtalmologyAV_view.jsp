...
<table width="100%" class="list" cellspacing="0">
    <tr class="admin">
        <td><%=getTran(request,"web.occup","medwan.healthrecord.ophtalmology.acuite-visuelle",sWebLanguage)%></td>
        <td align="right" width="20%">
            <%=getLabel(request,"web.occup","medwan.common.not-executed",sWebLanguage,"moav_c1")%>&nbsp;<input name="visus-ras" type="checkbox" id="moav_c1" value="medwan.common.true" onclick="if (this.checked == true){hide('visus-details');setTrue('<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_VISUS_AV_RAS" property="itemId"/>'); } else{show('visus-details');setFalse('<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_VISUS_AV_RAS" property="itemId"/>'); }">
        </td>
            ...
            <table width="100%" cellspacing="1">
                <tr>
                    ...
                    <td class="admin2" colspan="2">
                        ...
                        <%=getLabel(request,"web.occup","medwan.healthrecord.ophtalmology.acuite-visuelle.LASIK",sWebLanguage,"moav_c5")%>
                          &nbsp;&nbsp;&nbsp;&nbsp;
                        <input <%=setRightClick(session,"ITEM_TYPE_OPTHALMOLOGY_VISION_KERATOTOMY")%> type="checkbox" id="moav_c6" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_OPTHALMOLOGY_VISION_KERATOTOMY" property="itemId"/>]>.value" <mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_OPTHALMOLOGY_VISION_KERATOTOMY;value=medwan.healthrecord.ophtalmology.acuite-visuelle.keratotomie" property="value" outputString="checked"/> value="medwan.healthrecord.ophtalmology.acuite-visuelle.keratotomie">
                        <%=getLabel(request,"web.occup","medwan.healthrecord.ophtalmology.acuite-visuelle.keratotomie",sWebLanguage,"moav_c6")%>
                    </td>
                </tr>
                ...
                <tr>
                    <td class="admin" rowspan="2">
                        <%=getTran(request,"web.occup","medwan.healthrecord.ophtalmology.Acuite-VL",sWebLanguage)%>
                    </td>
                    <td class="admin" nowrap><%=getTran(request,"web.occup","medwan.healthrecord.ophtalmology.20-OD",sWebLanguage)%></td>
                    <td class="admin2">
                        ...
                        &#47;10
                        <%=getTran(request,"web.occup","medwan.healthrecord.ophtalmology.SANS-verres",sWebLanguage)%>
                    </td>
                    <td class="admin2">
                ...
                <tr>
                    <td class="admin" nowrap><%=getTran(request,"web.occup","medwan.healthrecord.ophtalmology.21-OG",sWebLanguage)%></td>
                    <td class="admin2">
                        ...
                        &#47;10
                        <%=getTran(request,"web.occup","medwan.healthrecord.ophtalmology.AVEC-verres",sWebLanguage)%>
                    </td>
                    <td class="admin2">
                ...
                <tr>
                    <td class="admin" rowspan="2">
                        <%=getTran(request,"web.occup","medwan.healthrecord.ophtalmology.Acuite-binoculaire-VL",sWebLanguage)%>
                    </td>
