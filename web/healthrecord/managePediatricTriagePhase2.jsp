			...
			<td class='admin2' id='infection'>
				<table width='100%'>
					<tr>
						...
						<td width='20%' style='vertical-align: top; background-color: #FF8A8A'>
							<table width='100%'>
								<%
									level=2;
									for(int n=1;n<=1;n++){ 
						...
						<td width='20%' style='vertical-align: top; background-color: #FFB0B0'>
							<table width='100%'>
								<%
									level=3;
									for(int n=1;n<=1;n++){ 
						...
						<td width='20%' style='vertical-align: top; background-color: #FFDFDF'>
							<table width='100%'>
								<%
									level=4;
									for(int n=1;n<=1;n++){ 
