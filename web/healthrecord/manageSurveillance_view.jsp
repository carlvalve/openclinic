    ...
    private StringBuffer addSignesVitaux(int iTotal,String sHeure,String sSys,String sDias,String sRythme,String sTemp,String sFreq,String sSat, String sMode, String sObservation, String sWebLanguage){
        ...
        sTmp.append(
                    "<tr id='rowSignesVitaux"+iTotal+"'>" +
                        "<td class=\"admin2\">" +
                        "   <a href='javascript:deleteSignesVitaux(rowSignesVitaux"+iTotal+")'><img src='" + sCONTEXTPATH + "/_img/icons/icon_delete.png' alt='" + getTran(null,"Web.Occup","medwan.common.delete",sWebLanguage) + "' border='0'></a> "+
                        "   <a href='javascript:editSignesVitaux(rowSignesVitaux"+iTotal+")'><img src='" + sCONTEXTPATH + "/_img/icons/icon_edit.png' alt='" + getTran(null,"Web.Occup","medwan.common.edit",sWebLanguage) + "' border='0'></a>" +
                        "</td>" +
    ...
    private StringBuffer addConscience(int iTotal,String sHeure,String sYeux,String sMotrice,String sVerbale,String sTotal,String sWebLanguage){
        ...
        sTmp.append(
                    "<tr id='rowConscience"+iTotal+"'>" +
                        "<td class=\"admin2\">" +
                        "   <a href='javascript:deleteConscience(rowConscience"+iTotal+")'><img src='" + sCONTEXTPATH + "/_img/icons/icon_delete.png' alt='" + getTran(null,"Web.Occup","medwan.common.delete",sWebLanguage) + "' border='0'></a> "+
                        "   <a href='javascript:editConscience(rowConscience"+iTotal+")'><img src='" + sCONTEXTPATH + "/_img/icons/icon_edit.png' alt='" + getTran(null,"Web.Occup","medwan.common.edit",sWebLanguage) + "' border='0'></a>" +
                        "</td>" +
                        "<td class=\"admin2\">&nbsp;" + sHeure + "</td>" +
    ...
    private StringBuffer addBiometrie(int iTotal,String sHeure,String sPoids,String sTaille,String sBMI,String sWebLanguage){
        ...
        sTmp.append(
                    "<tr id='rowBiometrie"+iTotal+"'>" +
                        "<td class=\"admin2\">" +
                        "   <a href='javascript:deleteBiometrie(rowBiometrie"+iTotal+")'><img src='" + sCONTEXTPATH + "/_img/icons/icon_delete.png' alt='" + getTran(null,"Web.Occup","medwan.common.delete",sWebLanguage) + "' border='0'></a> "+
                        "   <a href='javascript:editBiometrie(rowBiometrie"+iTotal+")'><img src='" + sCONTEXTPATH + "/_img/icons/icon_edit.png' alt='" + getTran(null,"Web.Occup","medwan.common.edit",sWebLanguage) + "' border='0'></a>" +
                        "</td>" +
                        "<td class=\"admin2\">&nbsp;" + sHeure + "</td>" +
    ...
    private StringBuffer addBilanEntree(int iTotal,String sHeure,String sLactate,String sGlucose,String sPhysio,String sHaem,String sTrans, String sSang,String sWebLanguage){
        ...
        sTmp.append(
                    "<tr id='rowBilanEntree"+iTotal+"'>" +
                        "<td class=\"admin2\">" +
                            "<a href='javascript:deleteBilanEntree(rowBilanEntree"+iTotal+")'><img src='" + sCONTEXTPATH + "/_img/icons/icon_delete.png' alt='" + getTran(null,"Web.Occup","medwan.common.delete",sWebLanguage) + "' border='0'></a> "+
                            "<a href='javascript:editBilanEntree(rowBilanEntree"+iTotal+")'><img src='" + sCONTEXTPATH + "/_img/icons/icon_edit.png' alt='" + getTran(null,"Web.Occup","medwan.common.edit",sWebLanguage) + "' border='0'></a>" +
                        "</td>" +
                        "<td class=\"admin2\">&nbsp;" +
                            sHeure +
                        "</td>" +
        ...
        sTmp.append(
                    "<tr id='rowSitNutri"+iTotal+"'>"+
                        "<td class=\"admin2\" width=\"40\">" +
                            "<a href='javascript:deleteSitNutri(rowSitNutri"+iTotal+")'><img src='" + sCONTEXTPATH + "/_img/icons/icon_delete.png' alt='" + getTran(null,"Web.Occup","medwan.common.delete",sWebLanguage) + "' border='0'></a> "+
                            "<a href='javascript:editSitNutri(rowSitNutri"+iTotal+")'><img src='" + sCONTEXTPATH + "/_img/icons/icon_edit.png' alt='" + getTran(null,"Web.Occup","medwan.common.edit",sWebLanguage) + "' border='0'></a>" +
                        "</td>"+
