...
<%!
    private StringBuffer addSuivi(int iTotal,String sMolecule,String sDateBegin,String sDateEnd, String sReason, String sComment, String sWebLanguage){
        ...
        sTmp.append("<tr id='rowSuivi"+iTotal+"'>")
             .append("<td class=\"admin2\">")
              .append("<a href='javascript:deleteSuivi(rowSuivi"+iTotal+")'><img src='" + sCONTEXTPATH + "/_img/icons/icon_delete.png' alt='" + getTran(null,"Web.Occup","medwan.common.delete",sWebLanguage) + "' border='0'></a> ")
              .append("<a href='javascript:editSuivi(rowSuivi"+iTotal+")'><img src='" + sCONTEXTPATH + "/_img/icons/icon_edit.png' alt='" + getTran(null,"Web.Occup","medwan.common.edit",sWebLanguage) + "' border='0'></a>")
             .append("</td>")
    ...
    private StringBuffer addSummary(int iTotal,String sMolecule,String sDateBegin,String sDateEnd, String sReason, String sComment, String sWebLanguage){
        ...
        sTmp.append("<tr id='rowSummary"+iTotal+"'>")
             .append("<td class=\"admin2\">")
              .append("<a href='javascript:deleteSummary(rowSummary"+iTotal+")'><img src='" + sCONTEXTPATH + "/_img/icons/icon_delete.png' alt='" + getTran(null,"Web.Occup","medwan.common.delete",sWebLanguage) + "' border='0'></a> ")
              .append("<a href='javascript:editSummary(rowSummary"+iTotal+")'><img src='" + sCONTEXTPATH + "/_img/icons/icon_edit.png' alt='" + getTran(null,"Web.Occup","medwan.common.edit",sWebLanguage) + "' border='0'></a>")
             .append("</td>")
             .append("<td class='admin2'>&nbsp;" + sTmpMolecule + "</td>")
             .append("<td class='admin2'>&nbsp;" +sDateBegin + "</td>")
             .append("<td class='admin2'>&nbsp;" + sDateEnd + "</td>")
...
<form id="transactionForm" name="transactionForm" method="POST" action='<c:url value="/healthrecord/updateTransaction.do"/>?ts=<%=getTs()%>'>
    ...
    <table class="list" cellspacing="1" cellpadding="0" id="tblSuivi" width="100%">
        ...
        <tr>
            ...
            <td class="admin2">
                <input type="button" class="button" name="ButtonAddSuivi" value="<%=getTranNoLink("Web","add",sWebLanguage)%>" onclick="addSuivi();">
                <input type="button" class="button" name="ButtonUpdateSuivi" value="<%=getTranNoLink("Web","edit",sWebLanguage)%>" onclick="updateSuivi();">
            </td>
        </tr>
        <%
...
%>
    ...
    <table class="list" cellspacing="1" cellpadding="0" id="tblSummary" width="100%">
        ...
        <tr>
            ...
            <td class="admin2">
                <textarea onKeyup="resizeTextarea(this,10);limitChars(this,255);" <%=setRightClick(session,"ITEM_TYPE_TRACNET_SUIVI_ARV_SUMMARY_DAPSONE_COMMENT")%> class="text" cols="50" rows="2" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_TRACNET_SUIVI_ARV_SUMMARY_DAPSONE_COMMENT" property="itemId"/>]>.value"><mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_TRACNET_SUIVI_ARV_SUMMARY_DAPSONE_COMMENT" property="value"/></textarea>
            </td>
            <td class="admin2"/>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="admin2">
                <input type="button" class="button" name="ButtonAddSummary" value="<%=getTranNoLink("Web","add",sWebLanguage)%>" onclick="addSummary();">
                <input type="button" class="button" name="ButtonUpdateSummary" value="<%=getTranNoLink("Web","edit",sWebLanguage)%>" onclick="updateSummary();">
            </td>
        </tr>
        <%
...
<script>
  ...
  function addSuivi(){
    if(isAtLeastOneSuiviFieldFilled()){
      ...
      td.innerHTML = "<a href='javascript:deleteSuivi(rowSuivi"+iSuiviIndex+")'><img src='<%=sCONTEXTPATH%>/_img/icons/icon_delete.png' alt='<%=getTranNoLink("Web.Occup","medwan.common.delete",sWebLanguage)%>' border='0'></a> "
                    +"<a href='javascript:editSuivi(rowSuivi"+iSuiviIndex+")'><img src='<%=sCONTEXTPATH%>/_img/icons/icon_edit.png' alt='<%=getTranNoLink("Web.Occup","medwan.common.edit",sWebLanguage)%>' border='0'></a>";
      tr.appendChild(td);
  ...
  function updateSuivi(){
    if(isAtLeastOneSuiviFieldFilled()){
      ...
      row.cells[0].innerHTML = "<a href='javascript:deleteSuivi("+editSuiviRowid.id+")'><img src='<%=sCONTEXTPATH%>/_img/icons/icon_delete.png' alt='<%=getTranNoLink("Web.Occup","medwan.common.delete",sWebLanguage)%>' border='0'></a> "
                              +"<a href='javascript:editSuivi("+editSuiviRowid.id+")'><img src='<%=sCONTEXTPATH%>/_img/icons/icon_edit.png' alt='<%=getTranNoLink("Web.Occup","medwan.common.edit",sWebLanguage)%>' border='0'></a>";
  ...
  function addSummary(){
    if(isAtLeastOneSummaryFieldFilled()){
      ...
      var td = tr.insertCell(0);
      td.innerHTML = "<a href='javascript:deleteSummary(rowSummary"+iSummaryIndex+")'><img src='<%=sCONTEXTPATH%>/_img/icons/icon_delete.png' alt='<%=getTranNoLink("Web.Occup","medwan.common.delete",sWebLanguage)%>' border='0'></a> "
                    +"<a href='javascript:editSummary(rowSummary"+iSummaryIndex+")'><img src='<%=sCONTEXTPATH%>/_img/icons/icon_edit.png' alt='<%=getTranNoLink("Web.Occup","medwan.common.edit",sWebLanguage)%>' border='0'></a>";
      tr.appendChild(td);
  ...
  function updateSummary(){
    if(isAtLeastOneSummaryFieldFilled()){
      ...
      row.cells[0].innerHTML = "<a href='javascript:deleteSummary("+editSummaryRowid.id+")'><img src='<%=sCONTEXTPATH%>/_img/icons/icon_delete.png' alt='<%=getTranNoLink("Web.Occup","medwan.common.delete",sWebLanguage)%>' border='0'></a> "
                              +"<a href='javascript:editSummary("+editSummaryRowid.id+")'><img src='<%=sCONTEXTPATH%>/_img/icons/icon_edit.png' alt='<%=getTranNoLink("Web.Occup","medwan.common.edit",sWebLanguage)%>' border='0'></a>";
