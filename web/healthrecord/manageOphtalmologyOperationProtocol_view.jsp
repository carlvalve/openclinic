    ...
    <table class="list" cellspacing="1" cellpadding="0" width="100%">
        ...
        <tr>
            ...
            <td class="admin2" colspan="2">
                ...
                <img src="<c:url value="/_img/icons/icon_search.gif"/>" class="link" alt="<%=getTranNoLink("Web","select",sWebLanguage)%>" onclick="searchSurgeon('currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_OPHTALMOLOGY_OPERATION_PROTOCOL_SURGEON" property="itemId"/>]>.value','surgeonName');">
        ...
        <%-- diagnosis --%>
        <tr>
            <td class="admin"><%=getTran(request,"openclinic.chuk","diagnosis",sWebLanguage)%></td>
            <td class="admin2">
