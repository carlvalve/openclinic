...
<%!
    private StringBuffer addSA(int iTotal,String sHeure,String sSys,String sDias,String sRythme,String sStage,String sFreq,String sSat, String sMedication, String sWebLanguage){
        ...
        sTmp.append(
                    "<tr id='rowSA"+iTotal+"'>" +
                        "<td class=\"admin2\">" +
                        "   <a href='javascript:deleteSA(rowSA"+iTotal+")'><img src='" + sCONTEXTPATH + "/_img/icons/icon_delete.png' alt='" + getTran(null,"Web.Occup","medwan.common.delete",sWebLanguage) + "' border='0'></a> "+
                        "   <a href='javascript:editSA(rowSA"+iTotal+")'><img src='" + sCONTEXTPATH + "/_img/icons/icon_edit.png' alt='" + getTran(null,"Web.Occup","medwan.common.edit",sWebLanguage) + "' border='0'></a>" +
                        "</td>" +
            ...
            <td colspan="2">
                <table cellspacing="1" cellpadding="0" width="100%" border="0" id="tblSA" class="list">
                    <tr>
                        ...
                        <td class="admin" width="150" rowspan="2" style="vertical-align:bottom;padding-bottom:4px;"><%=getTran(request,"openclinic.chuk","medication",sWebLanguage)%></td>
                    ...
                    <tr>
                        ...
                        <td class="admin2">
                            <select class="text" name="svstage">
                                <option/>
                                <option value="pre_anesthesie"><%=getTran(request,"anesthesie_stage","pre_anesthesie",sWebLanguage)%></option>
                                <option value="anesthesie"><%=getTran(request,"anesthesie_stage","anesthesie",sWebLanguage)%></option>
                                <option value="post_anesthesie"><%=getTran(request,"anesthesie_stage","post_anesthesie",sWebLanguage)%></option>
                            </select>
                        </td>
                        <td class="admin2">
...
function addSA(){
  if(isAtLeastOneSAFieldFilled()){
      ...
      td.innerHTML = "<a href='javascript:deleteSA(rowSA"+iSAIndex+")'><img src='<%=sCONTEXTPATH%>/_img/icons/icon_delete.png' alt='<%=getTranNoLink("Web.Occup","medwan.common.delete",sWebLanguage)%>' border='0'></a> "
                    +"<a href='javascript:editSA(rowSA"+iSAIndex+")'><img src='<%=sCONTEXTPATH%>/_img/icons/icon_edit.png' alt='<%=getTranNoLink("Web.Occup","medwan.common.edit",sWebLanguage)%>' border='0'></a>";
      tr.appendChild(td);
...
function updateSA(){
  if(isAtLeastOneSAFieldFilled()){
    ...
    row.cells[0].innerHTML = "<a href='javascript:deleteSA("+editSARowid.id+")'><img src='<%=sCONTEXTPATH%>/_img/icons/icon_delete.png' alt='<%=getTranNoLink("Web.Occup","medwan.common.delete",sWebLanguage)%>' border='0'></a> "
                            +"<a href='javascript:editSA("+editSARowid.id+")'><img src='<%=sCONTEXTPATH%>/_img/icons/icon_edit.png' alt='<%=getTranNoLink("Web.Occup","medwan.common.edit",sWebLanguage)%>' border='0'></a>";
