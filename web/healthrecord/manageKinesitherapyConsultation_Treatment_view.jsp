    ...
    private StringBuffer addSeance(int iTotal,String sDate,String sHour,String sWebLanguage){
        ...
        sTmp.append(
                    "<tr id='rowSeance"+iTotal+"'>" +
                        "<td class=\"admin2\">" +
                        "   <a href='javascript:deleteSeance(rowSeance"+iTotal+")'><img src='" + sCONTEXTPATH + "/_img/icons/icon_delete.png' alt='" + getTran(null,"Web.Occup","medwan.common.delete",sWebLanguage) + "' border='0'></a> "+
                        "   <a href='javascript:editSeance(rowSeance"+iTotal+")'><img src='" + sCONTEXTPATH + "/_img/icons/icon_edit.png' alt='" + getTran(null,"Web.Occup","medwan.common.edit",sWebLanguage) + "' border='0'></a>" +
                        "</td>" +
...
<form name="transactionForm" method="POST" action='<c:url value="/healthrecord/updateTransaction.do"/>?ts=<%=getTs()%>'>
    ...
    <table class="list" cellspacing="1" cellpadding="0" width="100%">
        ...
        <tr>
            <td class="admin">
                <%=getTran(request,"openclinic.chuk","context",sWebLanguage)%>
            </td>
            <td class="admin2">
                <input id="rbcontextconsultation" <%=setRightClick(session,"ITEM_TYPE_KINESITHERAPY_CONSULTATION_TREATMENT_CONTEXT")%>  onDblClick="uncheckRadio(this);"type="radio" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_KINESITHERAPY_CONSULTATION_TREATMENT_CONTEXT" property="itemId"/>]>.value" <mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_KINESITHERAPY_CONSULTATION_TREATMENT_CONTEXT;value=kine.treatment.consultation" property="value" outputString="checked"/> value="kine.treatment.consultation"/>
                &nbsp;<%=getLabel(request,"web.occup","kine.treatment.consultation",sWebLanguage,"rbcontextconsultation")%>
                &nbsp;<input id="rbcontexthospitalized" <%=setRightClick(session,"ITEM_TYPE_KINESITHERAPY_CONSULTATION_TREATMENT_CONTEXT")%>  onDblClick="uncheckRadio(this);"type="radio" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_KINESITHERAPY_CONSULTATION_TREATMENT_CONTEXT" property="itemId"/>]>.value" <mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_KINESITHERAPY_CONSULTATION_TREATMENT_CONTEXT;value=kine.treatment.hospitalized" property="value" outputString="checked"/> value="kine.treatment.hospitalized"/>
                &nbsp;<%=getLabel(request,"web.occup","kine.treatment.hospitalized",sWebLanguage,"rbcontexthospitalized")%>
            </td>
        </tr>
        <tr>
            <td class="admin">
                <%=getTran(request,"openclinic.chuk","diagnosis",sWebLanguage)%>
            </td>
            <td class="admin2">
                <textarea onKeyup="resizeTextarea(this,10);limitChars(this,255);" <%=setRightClick(session,"ITEM_TYPE_KINESITHERAPY_CONSULTATION_TREATMENT_DIAGNOSIS")%> class="text" cols="100" rows="2" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_KINESITHERAPY_CONSULTATION_TREATMENT_DIAGNOSIS"property="itemId"/>]>.value"><mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_KINESITHERAPY_CONSULTATION_TREATMENT_DIAGNOSIS" property="value"/></textarea>
                <br/>
                <%=getTran(request,"openclinic.chuk","diagnosis.code",sWebLanguage)%>
                <input class="text" <%=setRightClick(session,"ITEM_TYPE_KINESITHERAPY_CONSULTATION_TREATMENT_DIAGNOSIS_CODE")%> type="text" name="DiagnosisCodeLabel" value="<%=sDiagnosisCode%> <%=sDiagnosisCodeLabel%>" readonly size="100">
                <img src="<c:url value="/_img/icons/icon_search.png"/>" class="link" alt="<%=getTranNoLink("Web","select",sWebLanguage)%>" onclick="searchICPC('transactionForm.DiagnosisCode','transactionForm.DiagnosisCodeLabel','transactionForm.DiagnosisCodeType');">
                <img src="<c:url value="/_img/icons/icon_delete.png"/>" class="link" alt="<%=getTranNoLink("Web","clear",sWebLanguage)%>" onclick="transactionForm.DiagnosisCode.value='';transactionForm.DiagnosisCodeLabel.value='';transactionForm.DiagnosisCodeType.value='';">
        ...
        <tr>
            <td class="admin">
                <%=getTran(request,"openclinic.chuk","nr.of.meetings",sWebLanguage)%>
            </td>
            <td class="admin2">
                <textarea onKeyup="resizeTextarea(this,10);limitChars(this,255);" <%=setRightClick(session,"ITEM_TYPE_KINESITHERAPY_CONSULTATION_TREATMENT_NR_OF_MEETINGS")%> class="text" cols="100" rows="2" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_KINESITHERAPY_CONSULTATION_TREATMENT_NR_OF_MEETINGS" property="itemId"/>]>.value"><mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_KINESITHERAPY_CONSULTATION_TREATMENT_NR_OF_MEETINGS" property="value"/></textarea>
            </td>
        </tr>
        <tr>
            <td class="admin">
                <%=getTran(request,"openclinic.chuk","startdate",sWebLanguage)%>
            </td>
            <td class="admin2">
                <input <%=setRightClick(session,"ITEM_TYPE_KINESITHERAPY_CONSULTATION_TREATMENT_STARTDATE")%> type="text" class="text" size="12" maxLength="10" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_KINESITHERAPY_CONSULTATION_TREATMENT_STARTDATE" property="itemId"/>]>.value" value="<%=sStartDate%>" id="startdate" OnBlur='checkDate(this)'>
                <script>writeMyDate("startdate");</script>
            </td>
        </tr>
        <tr>
            <td class="admin">
                <%=getTran(request,"openclinic.chuk","date.seances",sWebLanguage)%>
            </td>
            <td class="admin2">
        ...
        <tr>
            <td class="admin">
                <%=getTran(request,"openclinic.chuk","enddate",sWebLanguage)%>
            </td>
            <td class="admin2">
                <input <%=setRightClick(session,"ITEM_TYPE_KINESITHERAPY_CONSULTATION_TREATMENT_ENDDATE")%> type="text" class="text" size="12" maxLength="10" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_KINESITHERAPY_CONSULTATION_TREATMENT_ENDDATE" property="itemId"/>]>.value" value="<%=sEndDate%>" id="enddate" OnBlur='checkDate(this)'>
                <script>writeMyDate("enddate");</script>
            </td>
        </tr>
        <tr>
            <td class="admin">
                <%=getTran(request,"openclinic.chuk","conclusion",sWebLanguage)%>
            </td>
            <td class="admin2">
                <textarea onKeyup="resizeTextarea(this,10);limitChars(this,255);" <%=setRightClick(session,"ITEM_TYPE_KINESITHERAPY_CONSULTATION_TREATMENT_CONCLUSION")%> class="text" cols="100" rows="2" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_KINESITHERAPY_CONSULTATION_TREATMENT_CONCLUSION" property="itemId"/>]>.value"><mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_KINESITHERAPY_CONSULTATION_TREATMENT_CONCLUSION" property="value"/></textarea>
            </td>
        </tr>
        <tr>
            <td class="admin">
                <%=getTran(request,"openclinic.chuk","reference",sWebLanguage)%>
            </td>
            <td class="admin2">
                <input id="rbrefyes" <%=setRightClick(session,"ITEM_TYPE_KINESITHERAPY_CONSULTATION_TREATMENT_REFERENCE")%>  onDblClick="uncheckRadio(this);" type="radio" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_KINESITHERAPY_CONSULTATION_TREATMENT_REFERENCE" property="itemId"/>]>.value" <mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_KINESITHERAPY_CONSULTATION_TREATMENT_REFERENCE;value=medwan.common.yes" property="value" outputString="checked"/> value="medwan.common.yes"/>
                &nbsp;<%=getLabel(request,"web.occup","medwan.common.yes",sWebLanguage,"rbrefyes")%>
                ...
                &nbsp;<%=getLabel(request,"web.occup","medwan.common.no",sWebLanguage,"rbrefno")%>
            </td>
        </tr>
        <tr>
            <td class="admin">
...
function addSeance(){
  if(isAtLeastOneSeanceFieldFilled()){
      ...
      td.innerHTML = "<a href='javascript:deleteSeance(rowSeance"+iSeancesIndex+")'><img src='<%=sCONTEXTPATH%>/_img/icons/icon_delete.png' alt='<%=getTranNoLink("Web.Occup","medwan.common.delete",sWebLanguage)%>' border='0'></a> "
                    +"<a href='javascript:editSeance(rowSeance"+iSeancesIndex+")'><img src='<%=sCONTEXTPATH%>/_img/icons/icon_edit.png' alt='<%=getTranNoLink("Web.Occup","medwan.common.edit",sWebLanguage)%>' border='0'></a>";
      tr.appendChild(td);
...
//      sSeances = replaceRowInArrayString(sSeances,newRow,editSeancesRowid.id);
    ...
    row.cells[0].innerHTML = "<a href='javascript:deleteSeance("+editSeancesRowid.id+")'><img src='<%=sCONTEXTPATH%>/_img/icons/icon_delete.png' alt='<%=getTranNoLink("Web.Occup","medwan.common.delete",sWebLanguage)%>' border='0'></a> "
                            +"<a href='javascript:editSeance("+editSeancesRowid.id+")'><img src='<%=sCONTEXTPATH%>/_img/icons/icon_edit.png' alt='<%=getTranNoLink("Web.Occup","medwan.common.edit",sWebLanguage)%>' border='0'></a>";
