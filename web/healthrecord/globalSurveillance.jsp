...
<%!
    private StringBuffer addSignesVitaux(int iTotal,String sHeure,String sSys,String sDias,String sRythme,String sTemp, String sWebLanguage){
        ...
        sTmp.append(
            ...
            "<td>" +
            " <a href='javascript:deleteSignesVitaux(rowSignesVitaux"+iTotal+")'><img src='"+sCONTEXTPATH+"/_img/icons/icon_delete.png' alt='"+getTranNoLink("Web.Occup","medwan.common.delete",sWebLanguage)+"' border='0'></a> "+
            " <a href='javascript:editSignesVitaux(rowSignesVitaux"+iTotal+")'><img src='"+sCONTEXTPATH+"/_img/icons/icon_edit.png' alt='"+getTranNoLink("Web.Occup","medwan.common.edit",sWebLanguage)+"' border='0'></a>" +
            "</td>" +
            "<td>"+sHeure+"</td>" +
            "<td>" +sSys +"</td>" +
            "<td>" +sDias +"</td>" +
    ...
    private StringBuffer addSignesVitauxResp(int iTotal,String sHeure,String sResp,String sAmbient,String sUnder,String sVolume, String sMode, String sObservation,String sWebLanguage){
        StringBuffer sTmp = new StringBuffer();
        if(sMode.length()>0){
            sMode = getTran(null,"surveillane.vital.resp.signs.mode",sMode,sWebLanguage);
        }
        
        sTmp.append(
            "<tr id='rowSignesVitauxResp"+iTotal+"' class='list'>" +
            "<td>" +
            " <a href='javascript:deleteSignesVitauxResp(rowSignesVitauxResp"+iTotal+")'><img src='"+sCONTEXTPATH+"/_img/icons/icon_delete.png' alt='"+getTranNoLink("Web.Occup","medwan.common.delete",sWebLanguage)+"' border='0'></a> "+
            " <a href='javascript:editSignesVitauxResp(rowSignesVitauxResp"+iTotal+")'><img src='"+sCONTEXTPATH+"/_img/icons/icon_edit.png' alt='"+getTranNoLink("Web.Occup","medwan.common.edit",sWebLanguage)+"' border='0'></a>" +
            "</td>" +
            "<td>"+sHeure+"</td>" +
            "<td>" +sResp +"</td>" +
            "<td>" +sAmbient +"</td>" +
    ...
    private StringBuffer addConscience(int iTotal,String sHeure,String sYeux,String sMotrice,String sVerbale,String sTotal, String sPain,String sWebLanguage){
        ...
        sTmp.append(
            ...
            "<td>" +
            " <a href='javascript:deleteConscience(rowConscience"+iTotal+")'><img src='"+sCONTEXTPATH+"/_img/icons/icon_delete.png' alt='"+getTranNoLink("Web.Occup","medwan.common.delete",sWebLanguage)+"' border='0'></a> "+
            " <a href='javascript:editConscience(rowConscience"+iTotal+")'><img src='"+sCONTEXTPATH+"/_img/icons/icon_edit.png' alt='"+getTranNoLink("Web.Occup","medwan.common.edit",sWebLanguage)+"' border='0'></a>" +
            "</td>" +
            "<td>&nbsp;"+sHeure+"</td>" +
            "<td>&nbsp;"+sYeux+"</td>" +
            "<td>&nbsp;"+sMotrice+"</td>" +
    ...
    private StringBuffer addBiometrie(int iTotal,String sHeure,String sPoids,String sTaille,String sBMI,String sWebLanguage){
        ...
        sTmp.append(
            ...
            "<td>" +
            " <a href='javascript:deleteBiometrie(rowBiometrie"+iTotal+")'><img src='"+sCONTEXTPATH+"/_img/icons/icon_delete.png' alt='"+getTranNoLink("Web.Occup","medwan.common.delete",sWebLanguage)+"' border='0'></a> "+
            " <a href='javascript:editBiometrie(rowBiometrie"+iTotal+")'><img src='"+sCONTEXTPATH+"/_img/icons/icon_edit.png' alt='"+getTranNoLink("Web.Occup","medwan.common.edit",sWebLanguage)+"' border='0'></a>" +
            "</td>" +
            "<td>&nbsp;"+sHeure+"</td>" +
            "<td>&nbsp;"+sPoids+"</td>" +
            "<td>&nbsp;"+sTaille+"</td>" +
    ...
    private StringBuffer addBilanEntree(int iTotal,String sHeure,String sLactate,String sGlucose,String sPhysio,String sHaem,String sTrans, String sSang,String sWebLanguage){
        ...
        sTmp.append(
            ...
            "<td>" +
            "<a href='javascript:deleteBilanEntree(rowBilanEntree"+iTotal+")'><img src='"+sCONTEXTPATH+"/_img/icons/icon_delete.png' alt='"+getTranNoLink("Web.Occup","medwan.common.delete",sWebLanguage)+"' border='0'></a> "+
            "<a href='javascript:editBilanEntree(rowBilanEntree"+iTotal+")'><img src='"+sCONTEXTPATH+"/_img/icons/icon_edit.png' alt='"+getTranNoLink("Web.Occup","medwan.common.edit",sWebLanguage)+"' border='0'></a>" +
            "</td>" +
            "<td>&nbsp;" +sHeure +"</td>" +
            "<td>&nbsp;" +sLactate +"</td>" +
            "<td>&nbsp;" +sGlucose +"</td>" +
    ...
    private StringBuffer addSitNutri(int iTotal,String sHeure,String sLait,String sBouillie,String sPotage, String sJuice, String sWater,String sPB,String sPT, String sIMC,String sObservation,String sWebLanguage){
        ...
        sTmp.append(
            ...
            "<td width='40'>" +
            "<a href='javascript:deleteSitNutri(rowSitNutri"+iTotal+");'><img src='"+sCONTEXTPATH+"/_img/icons/icon_delete.png' alt='"+getTranNoLink("Web.Occup","medwan.common.delete",sWebLanguage)+"' border='0'></a> "+
            "<a href='javascript:editSitNutri(rowSitNutri"+iTotal+");'><img src='"+sCONTEXTPATH+"/_img/icons/icon_edit.png' alt='"+getTranNoLink("Web.Occup","medwan.common.edit",sWebLanguage)+"' border='0'></a>" +
            "</td>"+
...
%>
    ...
    <table cellspacing="1" cellpadding="0" width="100%" border="0" id="tblSignesVitaux" class="list">
        ...
        <tr>
            ...
            <td class="admin" rowspan="2" style="width: 50;vertical-align:bottom;padding-bottom:4px;"><%=getTran(request,"Web.occup","medwan.common.hour",sWebLanguage)%></td>
            <td class="admin" colspan="2"><center><%=getTran(request,"openclinic.chuk","ta",sWebLanguage)%></center></td>
        ...
        <tr>
            <td class="admin" width="50"><%=getTran(request,"openclinic.chuk","sys",sWebLanguage)%></td>
            <td class="admin" width="50"><%=getTran(request,"openclinic.chuk","dias",sWebLanguage)%></td>
        </tr>
        <tr>
    ...
    <table cellspacing="1" cellpadding="0" width="100%" border="0" id="tblSignesVitauxResp" class="list">
        <tr class="admin">
            <td colspan="11"><%=getTran(request,"openclinic.chuk","vital.resp.signs",sWebLanguage).toUpperCase()%></td>
        </tr>

        <%-- header --%>
        <tr>
            <td class="admin" width="40"/>
            <td class="admin" width="50"><%=getTran(request,"Web.occup","medwan.common.hour",sWebLanguage)%></td>
            <td class="admin" width="75"><%=getTran(request,"openclinic.chuk","respiration",sWebLanguage)%></td>
            <td class="admin" width="75"><%=getTran(request,"openclinic.chuk","air.ambient",sWebLanguage)%></td>
            <td class="admin" width="100"><%=getTran(request,"openclinic.chuk","under.o2",sWebLanguage)%></td>
            <td class="admin" width="100"><%=getTran(request,"openclinic.chuk","volume.o2",sWebLanguage)%></td>
            <td class="admin" width="150"><%=getTran(request,"openclinic.chuk","mode.o2",sWebLanguage)%></td>
            <td class="admin" width="300"><%=getTran(request,"openclinic.chuk","observation",sWebLanguage)%></td>
            <td class="admin"/>
        </tr>
        <tr>
            <td class="admin2" width="40"/>
            ...
            <td class="admin2" width="150">
                <select class="text" name="svrmode">
                    <option/>
                    <%=ScreenHelper.writeSelect(request,"surveillane.vital.resp.signs.mode","",sWebLanguage)%>
                </select>
            </td>
    ...
    <table cellspacing="1" cellpadding="0" width="100%" border="0" id="tblConscience" class="list">
        <tr class="admin">
            <td colspan="8"><%=getTran(request,"openclinic.chuk","consciousness",sWebLanguage).toUpperCase()%></td>
        </tr>
        ...
        <tr>
            ...
            <td class="admin" width="100"><%=getTran(request,"web.occup","total",sWebLanguage)%>( /15)</td>
            <td class="admin" width="150"><%=getTran(request,"openclinic.chuk","pain.score",sWebLanguage)%></td>
            <td class="admin"/>
        </tr>
        <tr>
            <td class="admin2" width="40"/>
            ...
            <td class="admin2" width="150">
                <select class="text" name="conspain">
                    <option/>
                    <option value="0" style="background-color:forestgreen">0 <%=getTran(request,"openclinic.chuk","0.nopain",sWebLanguage)%></option>
                    ...
                    <option value="10" style="background-color:#CC3300">10 <%=getTran(request,"openclinic.chuk","10.worstpain",sWebLanguage)%></option>
                </select>
            </td>
            <td class="admin2">
    ...
    <table cellspacing="1" cellpadding="0" width="100%" border="0" id="tblBilanEntree" class="list">
        ...
        <tr>
            ...
            <td class="admin" width="75" rowspan="2" style="vertical-align:bottom;padding-bottom:4px;"><%=getTran(request,"openclinic.chuk","type",sWebLanguage)%></td>
            <td class="admin" rowspan="2"/>
        </tr>
        <tr>
    ...
    <table cellspacing="1" cellpadding="0" border="0" width="100%" class="list">
        ...
        <%-- header --%>
        <tr>
            <td class="admin" width="150"><%=getTran(request,"openclinic.chuk","diuresis",sWebLanguage)%></td>
            <td class="admin2" width="100">
                <input id="bilanoutput1" <%=setRightClick(session,"ITEM_TYPE_PROTSURV_BILANSORTIE_DIURESE")%> type="text" class="text" size="4" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_PROTSURV_BILANSORTIE_DIURESE" property="itemId"/>]>.value" value="<%=sBilanSortieDiurese%>" onblur="isNumber(this);addBilanOutput();"> ml
            </td>
            <td class="admin" width="150"><%=getTran(request,"openclinic.chuk","aspiration",sWebLanguage)%></td>
            <td class="admin2" width="100">
                <input id="bilanoutput2" <%=setRightClick(session,"ITEM_TYPE_PROTSURV_BILANSORTIE_ASPIRATION")%> type="text" class="text" size="4" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_PROTSURV_BILANSORTIE_ASPIRATION" property="itemId"/>]>.value" value="<%=sBilanSortieAspiration%>" onblur="isNumber(this);addBilanOutput();"> ml
            </td>
            <td class="admin" width="150"><%=getTran(request,"openclinic.chuk","vomiting",sWebLanguage)%></td>
            <td class="admin2" width="100">
                <input <%=setRightClick(session,"ITEM_TYPE_PROTSURV_BILANSORTIE_VOMISSEMENTS")%> type="text" class="text" size="4" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_PROTSURV_BILANSORTIE_VOMISSEMENTS" property="itemId"/>]>.value" value="<%=sBilanSortieVomissements%>" onblur="isNumber(this);"> /j
            </td>
            <td class="admin" width="150"><%=getTran(request,"openclinic.chuk","selles",sWebLanguage)%></td>
            <td class="admin2">
                <input <%=setRightClick(session,"ITEM_TYPE_PROTSURV_BILANSORTIE_SELLES")%> type="text" class="text" size="4" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_PROTSURV_BILANSORTIE_SELLES" property="itemId"/>]>.value" value="<%=sBilanSortieSelles%>" onblur="isNumber(this);"> /j
            </td>
        </tr>

        <tr>
            <td class="admin"><%=getTran(request,"openclinic.chuk","thoracic.drain",sWebLanguage)%></td>
            <td class="admin2">
                <input id="bilanoutput3" <%=setRightClick(session,"ITEM_TYPE_PROTSURV_BILANSORTIE_DRAIN_THORACIQUE")%> type="text" class="text" size="4" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_PROTSURV_BILANSORTIE_DRAIN_THORACIQUE" property="itemId"/>]>.value" value="<%=sBilanSortieDrainThoracique%>" onblur="isNumber(this);addBilanOutput();"> ml
            </td>
            <td class="admin"><%=getTran(request,"openclinic.chuk","abdominal.drain",sWebLanguage)%></td>
            <td class="admin2">
                <input id="bilanoutput4" <%=setRightClick(session,"ITEM_TYPE_PROTSURV_BILANSORTIE_DRAIN_ABDOMINAL")%> type="text" class="text" size="4" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_PROTSURV_BILANSORTIE_DRAIN_ABDOMINAL" property="itemId"/>]>.value" value="<%=sBilanSortieDrainAbdominal%>" onblur="isNumber(this);addBilanOutput();"> ml
            </td>
            <td class="admin"><%=getTran(request,"openclinic.chuk","other.drain",sWebLanguage)%></td>
            <td class="admin2">
                <input id="bilanoutput5" <%=setRightClick(session,"ITEM_TYPE_PROTSURV_BILANSORTIE_AUTRE_DRAIN")%> type="text" class="text" size="4" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_PROTSURV_BILANSORTIE_AUTRE_DRAIN" property="itemId"/>]>.value" value="<%=sBilanSortieAutreDrain%>" onblur="isNumber(this);addBilanOutput();"> ml
            </td>
            <td class="admin"/>
            <td class="admin2"/>
        </tr>
        ...
        <tr>
            <td class="admin"><%=getTran(request,"openclinic.chuk","nasogastric.probe",sWebLanguage)%></td>
            <td class="admin2">
                <input id="bilanoutput6" <%=setRightClick(session,"ITEM_TYPE_PROTSURV_BILANSORTIE_SONDE_NASOGASTRIQUE")%> type="text" class="text" size="4" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_PROTSURV_BILANSORTIE_SONDE_NASOGASTRIQUE" property="itemId"/>]>.value" value="<%=sBilanSortieSondeNasogastrique%>" onblur="isNumber(this);addBilanOutput();"> ml
            </td>
            <td class="admin"/>
            <td class="admin2"/>
            <td class="admin"><%=getTran(request,"openclinic.chuk","other.exits",sWebLanguage)%></td>
            <td class="admin2">
                <input id="bilanoutput7" <%=setRightClick(session,"ITEM_TYPE_PROTSURV_BILANSORTIE_AUTRES_SORTIES")%> type="text" class="text" size="4" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_PROTSURV_BILANSORTIE_AUTRES_SORTIES" property="itemId"/>]>.value" value="<%=sBilanSortieAutresSorties%>" onblur="isNumber(this);addBilanOutput();"> ml
            </td>
            <td class="admin"/>
            <td class="admin2">
        </tr>
    ...
    <table class="list" width="100%" cellspacing="1" cellpadding="0">
        <tr class="admin">
            <td colspan="2"><%=getTran(request,"openclinic.chuk","bilan.total",sWebLanguage).toUpperCase()%></td>
                <%
        ...
        <%-- BILAN INPUT TOTAL --%>
        <tr>
            <td class="admin" width="150"><%=getTran(request,"openclinic.chuk","bilan.input.total",sWebLanguage)%></td>
            <td class="admin2" width="100">
        ...
        <%-- BILAN OUTPUT TOTAL --%>
        <tr>
            <td class="admin"><%=getTran(request,"openclinic.chuk","bilan.output.total",sWebLanguage)%></td>
            <td class="admin2">
        ...
        <%-- BILAN TOTAL --%>
        <tr>
            <td class="admin"><%=getTran(request,"openclinic.chuk","bilan.total",sWebLanguage)%></td>
            <td class="admin2">
    ...
    <table cellspacing="1" cellpadding="0" border="0" width="100%" class="list">
        ...
        <tr>
            ...
            <td class="admin" width="50"><%=getTran(request,"openclinic.chuk","morning",sWebLanguage)%></td>
            <td class="admin2">
                <textarea onKeyup="resizeTextarea(this,10);limitChars(this,255);" <%=setRightClick(session,"ITEM_TYPE_PROTSURV_SITUATION_NUTRITIONAL_MATIN")%> class="text" cols="100" rows="2" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_PROTSURV_SITUATION_NUTRITIONAL_MATIN" property="itemId"/>]>.value"><mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_PROTSURV_SITUATION_NUTRITIONAL_MATIN" property="value"/></textarea>
            </td>
        </tr>

        <tr>
            <td class="admin"><%=getTran(request,"openclinic.chuk","midday",sWebLanguage)%></td>
            <td class="admin2">
                <textarea onKeyup="resizeTextarea(this,10);limitChars(this,255);" <%=setRightClick(session,"ITEM_TYPE_PROTSURV_SITUATION_NUTRITIONAL_MIDI")%> class="text" cols="100" rows="2" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_PROTSURV_SITUATION_NUTRITIONAL_MIDI" property="itemId"/>]>.value"><mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_PROTSURV_SITUATION_NUTRITIONAL_MIDI" property="value"/></textarea>
            </td>
        </tr>

        <tr>
            <td class="admin"><%=getTran(request,"openclinic.chuk","evening",sWebLanguage)%></td>
            <td class="admin2">
                <textarea onKeyup="resizeTextarea(this,10);limitChars(this,255);" <%=setRightClick(session,"ITEM_TYPE_PROTSURV_SITUATION_NUTRITIONAL_SOIR")%> class="text" cols="100" rows="2" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_PROTSURV_SITUATION_NUTRITIONAL_SOIR" property="itemId"/>]>.value"><mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_PROTSURV_SITUATION_NUTRITIONAL_SOIR" property="value"/></textarea>
            </td>
        </tr>

        <tr>
            <td class="admin" colspan="2"><%=getTran(request,"openclinic.chuk","other_regime",sWebLanguage)%></td>
            <td class="admin2">
                <textarea onKeyup="resizeTextarea(this,10);limitChars(this,255);" <%=setRightClick(session,"ITEM_TYPE_PROTSURV_SITUATION_NUTRITIONAL_OTHER_REGIME")%> class="text" cols="100" rows="2" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_PROTSURV_SITUATION_NUTRITIONAL_OTHER_REGIME" property="itemId"/>]>.value"><mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_PROTSURV_SITUATION_NUTRITIONAL_OTHER_REGIME" property="value"/></textarea>
            </td>
        </tr>
            ...
            <td colspan="3">
                <table cellspacing="1" cellpadding="0" border="0" width="100%" id="tblSitNutri" class="list">
                    ...
                    <tr>
                        ...
                        <td class="admin" width="50" rowspan="2" style="vertical-align:bottom;padding-bottom:4px;"><%=getTran(request,"Web.occup","medwan.common.hour",sWebLanguage)%></td>
                        <td class="admin" width="350" colspan="5"><center><%=getTran(request,"openclinic.chuk","nutritive.liquid",sWebLanguage)%></center></td>
                        <td class="admin" width="210" colspan="3"><center><%=getTran(request,"openclinic.chuk","nutritional.state",sWebLanguage)%></center></td>
                    ...
                    <%-- header --%>
                    <tr>
                        <td class="admin" width="70"><%=getTran(request,"openclinic.chuk","milk",sWebLanguage)%></td>
                        <td class="admin" width="70"><%=getTran(request,"openclinic.chuk","pulp",sWebLanguage)%></td>
                        <td class="admin" width="70"><%=getTran(request,"openclinic.chuk","soup",sWebLanguage)%></td>
                        <td class="admin" width="70"><%=getTran(request,"openclinic.chuk","juice",sWebLanguage)%></td>
                        <td class="admin" width="70"><%=getTran(request,"openclinic.chuk","water",sWebLanguage)%></td>
                        <td class="admin" width="70"><%=getTran(request,"openclinic.chuk","pb",sWebLanguage)%></td>
                        <td class="admin" width="70"><%=getTran(request,"openclinic.chuk","pt",sWebLanguage)%></td>
                        <td class="admin" width="70"><%=getTran(request,"openclinic.chuk","imc",sWebLanguage)%></td>
                    </tr>
...
function addSignesVitaux(){
  if(isAtLeastOneSignesVitauxFieldFilled()){
    ...
    td.innerHTML = "<a href='javascript:deleteSignesVitaux(rowSignesVitaux"+iSignesVitauxIndex+")'><img src='<%=sCONTEXTPATH%>/_img/icons/icon_delete.png' alt='<%=getTranNoLink("Web.Occup","medwan.common.delete",sWebLanguage)%>' border='0'></a> "
                  +"<a href='javascript:editSignesVitaux(rowSignesVitaux"+iSignesVitauxIndex+")'><img src='<%=sCONTEXTPATH%>/_img/icons/icon_edit.png' alt='<%=getTranNoLink("Web.Occup","medwan.common.edit",sWebLanguage)%>' border='0'></a>";
    tr.appendChild(td);
...
function updateSignesVitaux(){
  if(isAtLeastOneSignesVitauxFieldFilled()){
    ...
    row.cells[0].innerHTML = "<a href='javascript:deleteSignesVitaux("+editSignesVitauxRowid.id+")'><img src='<%=sCONTEXTPATH%>/_img/icons/icon_delete.png' alt='<%=getTranNoLink("Web.Occup","medwan.common.delete",sWebLanguage)%>' border='0'></a> "
                            +"<a href='javascript:editSignesVitaux("+editSignesVitauxRowid.id+")'><img src='<%=sCONTEXTPATH%>/_img/icons/icon_edit.png' alt='<%=getTranNoLink("Web.Occup","medwan.common.edit",sWebLanguage)%>' border='0'></a>";
...
function addSignesVitauxResp(){
  if(isAtLeastOneSignesVitauxRespFieldFilled()){
    ...
    var td = tr.insertCell(0);
    td.innerHTML = "<a href='javascript:deleteSignesVitauxResp(rowSignesVitauxResp"+iSignesVitauxRespIndex+")'><img src='<%=sCONTEXTPATH%>/_img/icons/icon_delete.png' alt='<%=getTranNoLink("Web.Occup","medwan.common.delete",sWebLanguage)%>' border='0'></a> "
                  +"<a href='javascript:editSignesVitauxResp(rowSignesVitauxResp"+iSignesVitauxRespIndex+")'><img src='<%=sCONTEXTPATH%>/_img/icons/icon_edit.png' alt='<%=getTranNoLink("Web.Occup","medwan.common.edit",sWebLanguage)%>' border='0'></a>";
    tr.appendChild(td);
...
function updateSignesVitauxResp(){
  if(isAtLeastOneSignesVitauxRespFieldFilled()){
    ...
    row.cells[0].innerHTML = "<a href='javascript:deleteSignesVitauxResp("+editSignesVitauxRespRowid.id+")'><img src='<%=sCONTEXTPATH%>/_img/icons/icon_delete.png' alt='<%=getTranNoLink("Web.Occup","medwan.common.delete",sWebLanguage)%>' border='0'></a> "
                            +"<a href='javascript:editSignesVitauxResp("+editSignesVitauxRespRowid.id+")'><img src='<%=sCONTEXTPATH%>/_img/icons/icon_edit.png' alt='<%=getTranNoLink("Web.Occup","medwan.common.edit",sWebLanguage)%>' border='0'></a>";
...
function addConscience(){
  if(isAtLeastOneConscienceFieldFilled()){
      ...
      var td = tr.insertCell(0);
      td.innerHTML = "<a href='javascript:deleteConscience(rowConscience"+iConscienceIndex+")'><img src='<%=sCONTEXTPATH%>/_img/icons/icon_delete.png' alt='<%=getTranNoLink("Web.Occup","medwan.common.delete",sWebLanguage)%>' border='0'></a> "
                    +"<a href='javascript:editConscience(rowConscience"+iConscienceIndex+")'><img src='<%=sCONTEXTPATH%>/_img/icons/icon_edit.png' alt='<%=getTranNoLink("Web.Occup","medwan.common.edit",sWebLanguage)%>' border='0'></a>";
      tr.appendChild(td);
...
function updateConscience(){
  if(isAtLeastOneConscienceFieldFilled()){
    ...
    row.cells[0].innerHTML = "<a href='javascript:deleteConscience("+editConscienceRowid.id+")'><img src='<%=sCONTEXTPATH%>/_img/icons/icon_delete.png' alt='<%=getTranNoLink("Web.Occup","medwan.common.delete",sWebLanguage)%>' border='0'></a> "
                            +"<a href='javascript:editConscience("+editConscienceRowid.id+")'><img src='<%=sCONTEXTPATH%>/_img/icons/icon_edit.png' alt='<%=getTranNoLink("Web.Occup","medwan.common.edit",sWebLanguage)%>' border='0'></a>";
...
function addBiometrie(){
  if(isAtLeastOneBiometrieFieldFilled()){
      ...
      var td = tr.insertCell(0);
      td.innerHTML = "<a href='javascript:deleteBiometrie(rowBiometrie"+iBiometrieIndex+")'><img src='<%=sCONTEXTPATH%>/_img/icons/icon_delete.png' alt='<%=getTranNoLink("Web.Occup","medwan.common.delete",sWebLanguage)%>' border='0'></a> "
                    +"<a href='javascript:editBiometrie(rowBiometrie"+iBiometrieIndex+")'><img src='<%=sCONTEXTPATH%>/_img/icons/icon_edit.png' alt='<%=getTranNoLink("Web.Occup","medwan.common.edit",sWebLanguage)%>' border='0'></a>";
      tr.appendChild(td);
...
function updateBiometrie(){
  if(isAtLeastOneBiometrieFieldFilled()){
    ...
    row.cells[0].innerHTML = "<a href='javascript:deleteBiometrie("+editBiometrieRowid.id+")'><img src='<%=sCONTEXTPATH%>/_img/icons/icon_delete.png' alt='<%=getTranNoLink("Web.Occup","medwan.common.delete",sWebLanguage)%>' border='0'></a> "
                            +"<a href='javascript:editBiometrie("+editBiometrieRowid.id+")'><img src='<%=sCONTEXTPATH%>/_img/icons/icon_edit.png' alt='<%=getTranNoLink("Web.Occup","medwan.common.edit",sWebLanguage)%>' border='0'></a>";
...
function addBilanEntree(){
  if(isAtLeastOneBilanEntreeFieldFilled()){
      ...
      var td = tr.insertCell(0);
      td.innerHTML = "<a href='javascript:deleteBilanEntree(rowBilanEntree"+iBilanEntreeIndex+")'><img src='<%=sCONTEXTPATH%>/_img/icons/icon_delete.png' alt='<%=getTranNoLink("Web.Occup","medwan.common.delete",sWebLanguage)%>' border='0'></a> "
                    +"<a href='javascript:editBilanEntree(rowBilanEntree"+iBilanEntreeIndex+")'><img src='<%=sCONTEXTPATH%>/_img/icons/icon_edit.png' alt='<%=getTranNoLink("Web.Occup","medwan.common.edit",sWebLanguage)%>' border='0'></a>";
      tr.appendChild(td);
...
function updateBilanEntree(){
  if(isAtLeastOneBilanEntreeFieldFilled()){
    ...
    row.cells[0].innerHTML = "<a href='javascript:deleteBilanEntree("+editBilanEntreeRowid.id+")'><img src='<%=sCONTEXTPATH%>/_img/icons/icon_delete.png' alt='<%=getTranNoLink("Web.Occup","medwan.common.delete",sWebLanguage)%>' border='0'></a> "
                            +"<a href='javascript:editBilanEntree("+editBilanEntreeRowid.id+")'><img src='<%=sCONTEXTPATH%>/_img/icons/icon_edit.png' alt='<%=getTranNoLink("Web.Occup","medwan.common.edit",sWebLanguage)%>' border='0'></a>";
...
function addSitNutri(){
  if(isAtLeastOneSitNutriFieldFilled()){
      ...
      var td = tr.insertCell(0);
      td.innerHTML = "<a href='javascript:deleteSitNutri(rowSitNutri"+iSitNutriIndex+")'><img src='<%=sCONTEXTPATH%>/_img/icons/icon_delete.png' alt='<%=getTranNoLink("Web.Occup","medwan.common.delete",sWebLanguage)%>' border='0'></a> "
                    +"<a href='javascript:editSitNutri(rowSitNutri"+iSitNutriIndex+")'><img src='<%=sCONTEXTPATH%>/_img/icons/icon_edit.png' alt='<%=getTranNoLink("Web.Occup","medwan.common.edit",sWebLanguage)%>' border='0'></a>";
      tr.appendChild(td);
...
function updateSitNutri(){
  if(isAtLeastOneSitNutriFieldFilled()){
    ...
    row.cells[0].innerHTML = "<a href='javascript:deleteSitNutri(rowSitNutri"+iSitNutriIndex+")'><img src='<%=sCONTEXTPATH%>/_img/icons/icon_delete.png' alt='<%=getTranNoLink("Web.Occup","medwan.common.delete",sWebLanguage)%>' border='0'></a> "
                            +"<a href='javascript:editSitNutri(rowSitNutri"+iSitNutriIndex+")'><img src='<%=sCONTEXTPATH%>/_img/icons/icon_edit.png' alt='<%=getTranNoLink("Web.Occup","medwan.common.edit",sWebLanguage)%>' border='0'></a>";
