			    ...
			    <table class="list" cellspacing="1" cellpadding="0" width="100%">
			        ...
			        <tr>
			            <td class='admin' colspan="1">
			                <%=getTran(request,"web","emg.studymodality",sWebLanguage)%>&nbsp;
			            </td>
			            <td class='admin2'>
			                <select <%=setRightClick(session,"ITEM_TYPE_EMG_STUDY_MODALITY")%> class="text" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_EMG_STUDY_MODALITY" property="itemId"/>]>.value" class="text">
			                    <option value="medwan.common.not-executed" <mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_EMG_STUDY_MODALITY;value=medwan.common.not-executed" property="value" outputString="selected"/>><%=getTran(request,"web.occup","medwan.common.not-executed",sWebLanguage)%></option>
			                    <option value="emg" <mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_EMG_STUDY_MODALITY;value=emg" property="value" outputString="selected"/>><%=getTran(request,"web","emg",sWebLanguage)%></option>
			                    <option value="neurophysiology" <mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_EMG_STUDY_MODALITY;value=neurophysiology" property="value" outputString="selected"/>><%=getTran(request,"web","neurophysiology",sWebLanguage)%></option>
			                </select>
			        ...
			        <tr>
			            ...
			            <td class="admin2">
			                <textarea onKeyup="resizeTextarea(this,10);limitChars(this,255);" <%=setRightClick(session,"ITEM_TYPE_EMG_TECHNICAL_REPORT")%> class="text" cols="80" rows="2" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_EMG_TECHNICAL_REPORT" property="itemId"/>]>.value"><mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_EMG_TECHNICAL_REPORT" property="value"/></textarea>
			            </td>
			        </tr>
			        ...
			        <tr>
			            ...
			            <td class="admin2">
			                <textarea onKeyup="resizeTextarea(this,10);limitChars(this,500);" <%=setRightClick(session,"ITEM_TYPE_EMG_CONCLUSION")%> class="text" cols="80" rows="2" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_EMG_CONCLUSION" property="itemId"/>]>.value"><mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_EMG_CONCLUSION" property="value"/></textarea>
			            </td>
			        </tr>
			    </table>
			</td>
