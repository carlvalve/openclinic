...
<%@page errorPage="/includes/error.jsp" %>
    <bean:define id="transaction" name="be.mxs.webapp.wl.session.SessionContainerFactory.WO_SESSION_CONTAINER" property="currentTransactionVO"/>
        ...
        <tr>
            ...
            <td class="admin2">
                <input <%=setRightClick("ITEM_TYPE_DELIVERY_MCBOOKLET")%> type="radio" onDblClick="uncheckRadio(this);" id="mcbooklet_r1" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_DELIVERY_MCBOOKLET" property="itemId"/>]>.value" value="medwan.common.true"
                <mxs:propertyAccessorI18N name="transaction.items" scope="page"
                ...
                <input <%=setRightClick("ITEM_TYPE_DELIVERY_MCBOOKLET")%> type="radio" onDblClick="uncheckRadio(this);" id="mcbooklet_r2" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_DELIVERY_MCBOOKLET" property="itemId"/>]>.value" value="medwan.common.false"
                <mxs:propertyAccessorI18N name="transaction.items" scope="page"
                        	...
                        	<table width="100%">
                        		<tr>
									...
									<td>
			                            ...
			                            <input <%=setRightClick("ITEM_TYPE_DELIVERY_ATTERM")%> type="radio" onDblClick="uncheckRadio(this);" id="attermyes" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_DELIVERY_ATTERM" property="itemId"/>]>.value" value="medwan.common.true"
			                            <mxs:propertyAccessorI18N name="transaction.items" scope="page"
			                            ...
			                            <input <%=setRightClick("ITEM_TYPE_DELIVERY_ATTERM")%> type="radio" onDblClick="uncheckRadio(this);" id="attermno" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_DELIVERY_ATTERM" property="itemId"/>]>.value" value="medwan.common.false"
			                            <mxs:propertyAccessorI18N name="transaction.items" scope="page"
            	...
            	<table width='100%'>
            		...
            		<tr>
            			...
            			<td colspan="2">
                            ...
                            <script>writeMyDate("lastcsdate", "<c:url value="/_img/icons/icon_agenda.gif"/>", "<%=getTran(null,"Web","PutToday",sWebLanguage)%>");</script>
            			</td>
            		</tr>
            		<tr>
            			<td>
            ...
            <td class="admin2" colspan="3">
            	<table width='100%'>
            		<tr>
            			...
            			<td>
            				<%=getTran(request,"web", "other", sWebLanguage)%>:
            				<textarea onKeyup="resizeTextarea(this,10);" <%=setRightClick("ITEM_TYPE_DELIVERY_HISTORY_MEDOTHER")%> class="text" rows="1" cols="20" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_DELIVERY_HISTORY_MEDOTHER" property="itemId"/>]>.value"><mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_DELIVERY_HISTORY_MEDOTHER" property="value"/></textarea>
            			</td>
            		</tr>
            	</table>
            </td>
   			...
   			<td colspan="3" class='admin2'>
            	<table width='100%'>
            		...
            		<tr>
            			...
            			<td colspan="5">
                            <input <%=setRightClick("ITEM_TYPE_DELIVERY_EXAM_TV")%> type="radio" onDblClick="uncheckRadio(this);" id="tv_r1" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_DELIVERY_EXAM_TV" property="itemId"/>]>.value" value="1"
                            <mxs:propertyAccessorI18N name="transaction.items" scope="page"
                            ...
                            <input <%=setRightClick("ITEM_TYPE_DELIVERY_EXAM_TV")%> type="radio" onDblClick="uncheckRadio(this);" id="tv_r2" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_DELIVERY_EXAM_TV" property="itemId"/>]>.value" value="2"
                            <mxs:propertyAccessorI18N name="transaction.items" scope="page"
                            ...
                            <input <%=setRightClick("ITEM_TYPE_DELIVERY_EXAM_TV")%> type="radio" onDblClick="uncheckRadio(this);" id="tv_r3" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_DELIVERY_EXAM_TV" property="itemId"/>]>.value" value="3"
                            <mxs:propertyAccessorI18N name="transaction.items" scope="page"
            		...
            		<tr>
            			...
            			<td colspan="4">
                            ...
                            <input <%=setRightClick("ITEM_TYPE_DELIVERY_EXAM_WATERPOUCH")%> type="radio" onDblClick="uncheckRadio(this);" id="wp_r2" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_DELIVERY_EXAM_WATERPOUCH" property="itemId"/>]>.value" value="2"
                            <mxs:propertyAccessorI18N name="transaction.items" scope="page"
            				...
            				<input <%=setRightClick("ITEM_TYPE_DELIVERY_EXAM_WATERBROKENSINCE")%> type="text" class="text" size="20" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_DELIVERY_EXAM_WATERBROKENSINCE" property="itemId"/>]>.value" value="<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_DELIVERY_EXAM_WATERBROKENSINCE" property="value"/>">
            			</td>
            		</tr>
            		<tr>
            			<td colspan="6">
            				<%=getTran(request,"web", "other", sWebLanguage)%>:
            				<textarea onKeyup="resizeTextarea(this,10);" <%=setRightClick("ITEM_TYPE_DELIVERY_EXAM_OTHER")%> class="text" rows="1" cols="50" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_DELIVERY_EXAM_OTHER" property="itemId"/>]>.value"><mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_DELIVERY_EXAM_OTHER" property="value"/></textarea>
            			</td>
            		</tr>
            	</table>
            </td>
