    ...
    <table class="list" width="100%" border="0" cellspacing="1" cellpadding="0">
        ...
        <tr>
            ...
            <td class="admin2">
                ...
                <img src="<c:url value="/_img/icons/icon_search.png"/>" class="link" alt="<%=getTranNoLink("Web","select",sWebLanguage)%>" onclick="searchUser('EditCreationUserUID','EditCreationUserName');">
                <img src="<c:url value="/_img/icons/icon_delete.png"/>" class="link" alt="<%=getTranNoLink("Web","clear",sWebLanguage)%>" onclick="document.getElementById('EditCreationUserUID').value='';editForm.EditCreationUserName.value='';">
            </td>
        </tr>
        <tr>
            <td class="admin"/>
