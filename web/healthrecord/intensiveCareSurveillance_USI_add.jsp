...
<form name="transactionForm" id="transactionForm" method="POST" action=''>
    ...
    <tr class='admin' height='25'>
        <td><%=ScreenHelper.getTran(request,"Web.Occup", ((TransactionVO)transaction).getTransactionType(), sWebLanguage)%></td>
    </tr>
            ...
            <td style="vertical-align:top;">
                <div style="overflow:auto;min-height:450px;height:550px;border: 1px solid black;">
                    <table class="list" width="100%" cellspacing="1">
                        ...
                        <%-- actual hour --%>
                        <tr>
                            <td class="admin"><%=getTran(request,"web.occup","medwan.common.hour",sWebLanguage)%></td>
                            <td class="admin2">
                        ...
                        <tr>
                            <td class="admin"><%=getTran(request,"openclinic.chuk","lactate",sWebLanguage)%></td>
                            <td class="admin2">
                        ...
                        <tr>
                            <td class="admin"><%=getTran(request,"openclinic.chuk","glucose",sWebLanguage)%></td>
                            <td class="admin2">
                                <input type="text" class="text" name="<%=((TransactionVO)transaction).getItem("be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_GLUCOSE-"+iDataSetNr).getType()%>" value="<%=((TransactionVO)transaction).getItem("be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_GLUCOSE-"+iDataSetNr).getValue()%>" size="5" onchange="isNumber(this);calculateTotalIn();" id="glucose"> ml
                            </td>
                        </tr>
                        <tr>
                            <td class="admin"><%=getTran(request,"openclinic.chuk","physiology",sWebLanguage)%></td>
                            <td class="admin2">
                        ...
                        <tr>
                            <td class="admin"><%=getTran(request,"openclinic.chuk","shaem",sWebLanguage)%></td>
                            <td class="admin2">
                        ...
                        <tr>
                            <td class="admin"><%=getTran(request,"openclinic.chuk","transfusion",sWebLanguage)%></td>
                            <td class="admin2">
                                <input type="text" class="text" name="<%=((TransactionVO)transaction).getItem("be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_TRANSFUSION-"+iDataSetNr).getType()%>" value="<%=((TransactionVO)transaction).getItem("be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_TRANSFUSION-"+iDataSetNr).getValue()%>" size="5" onchange="isNumber(this);calculateTotalIn();" id="transfusion"> ml
                            </td>
                        </tr>
                        <tr>
                            <td class="admin"><%=getTran(request,"openclinic.chuk","blood",sWebLanguage)%></td>
                            <td class="admin2">
                        ...
                        <tr>
                            <td class="admin"><%=getTran(request,"openclinic.chuk","total_in",sWebLanguage)%></td>
                            <td class="admin2">
                        ...
                        <tr>
                            <td class="admin"><%=getTran(request,"openclinic.chuk","pompe_syringe_text1",sWebLanguage)%></td>
                            <td class="admin2">
                        ...
                        <tr>
                            <td class="admin"><%=getTran(request,"openclinic.chuk","pompe_syringe1",sWebLanguage)%></td>
                            <td class="admin2">
                        ...
                        <tr>
                            <td class="admin"><%=getTran(request,"openclinic.chuk","pompe_syringe_text2",sWebLanguage)%></td>
                            <td class="admin2">
                        ...
                        <tr>
                            <td class="admin"><%=getTran(request,"openclinic.chuk","pompe_syringe2",sWebLanguage)%></td>
                            <td class="admin2">
                        ...
                        <tr>
                            <td class="admin"><%=getTran(request,"openclinic.chuk","pompe_syringe_text3",sWebLanguage)%></td>
                            <td class="admin2">
                        ...
                        <tr>
                            <td class="admin"><%=getTran(request,"openclinic.chuk","pompe_syringe3",sWebLanguage)%></td>
                            <td class="admin2">
                        ...
                        <tr>
                            <td class="admin"><%=getTran(request,"openclinic.chuk","remarks1",sWebLanguage)%></td>
                            <td class="admin2">
                        ...
                        <tr>
                            <td class="admin"><%=getTran(request,"openclinic.chuk","gcs_y",sWebLanguage)%></td>
                            <td class="admin2">
                        ...
                        <tr>
                            <td class="admin"><%=getTran(request,"openclinic.chuk","gcs_v",sWebLanguage)%></td>
                            <td class="admin2">
                        ...
                        <tr>
                            <td class="admin"><%=getTran(request,"openclinic.chuk","gcs_m",sWebLanguage)%></td>
                            <td class="admin2">
                        ...
                        <tr>
                            <td class="admin"><%=getTran(request,"openclinic.chuk","rc",sWebLanguage)%></td>
                            <td class="admin2">
                        ...
                        <tr>
                            <td class="admin"><%=getTran(request,"openclinic.chuk","tas",sWebLanguage)%></td>
                            <td class="admin2">
                        ...
                        <tr>
                            <td class="admin"><%=getTran(request,"openclinic.chuk","tad",sWebLanguage)%></td>
                            <td class="admin2">
                        ...
                        <tr>
                            <td class="admin"><%=getTran(request,"openclinic.chuk","tam",sWebLanguage)%></td>
                            <td class="admin2">
                        ...
                        <tr>
                            <td class="admin"><%=getTran(request,"openclinic.chuk","pvc",sWebLanguage)%></td>
                            <td class="admin2">
                        ...
                        <tr>
                            <td class="admin"><%=getTran(request,"openclinic.chuk","rr",sWebLanguage)%></td>
                            <td class="admin2">
                        ...
                        <tr>
                            <td class="admin"><%=getTran(request,"openclinic.chuk","sat",sWebLanguage)%></td>
                            <td class="admin2">
                        ...
                        <tr>
                            <td class="admin"><%=getTran(request,"openclinic.chuk","fio2",sWebLanguage)%></td>
                            <td class="admin2">
                        ...
                        <tr>
                            <td class="admin"><%=getTran(request,"openclinic.chuk","l_min",sWebLanguage)%></td>
                            <td class="admin2">
                        ...
                        <tr>
                            ...
                            <td class="admin2">
                                <input type="radio" onDblClick="uncheckRadio(this);" id="intubation_yes" name="<%=((TransactionVO)transaction).getItem("be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_INTUBATION_USI-"+iDataSetNr).getType()%>" value="medwan.common.yes" <%if(((TransactionVO)transaction).getItem("be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_INTUBATION_USI-"+iDataSetNr).getValue().equals("medwan.common.yes")) out.print("checked");%>><label for="intubation_yes"><%=getTran(request,"web.occup","medwan.common.yes",sWebLanguage)%></label>
                                <input type="radio" onDblClick="uncheckRadio(this);" id="intubation_non" name="<%=((TransactionVO)transaction).getItem("be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_INTUBATION_USI-"+iDataSetNr).getType()%>" value="medwan.common.no" <%if(((TransactionVO)transaction).getItem("be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_INTUBATION_USI-"+iDataSetNr).getValue().equals("medwan.common.no")) out.print("checked");%>><label for="intubation_non"><%=getTran(request,"web.occup","medwan.common.no",sWebLanguage)%></label>
                            </td>
                        </tr>
                        <tr>
                            <td class="admin"><%=getTran(request,"openclinic.chuk","tube",sWebLanguage)%></td>
                            <td class="admin2">
                        ...
                        <tr>
                            <td class="admin"><%=getTran(request,"openclinic.chuk","days_intubation",sWebLanguage)%></td>
                            <td class="admin2">
                        ...
                        <tr>
                            <td class="admin"><%=getTran(request,"openclinic.chuk","tracheostomie",sWebLanguage)%></td>
                            <td class="admin2">
                                <input type="radio" onDblClick="uncheckRadio(this);" id="tracheostomie_yes" name="<%=((TransactionVO)transaction).getItem("be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_TRACHEOSTOMIE-"+iDataSetNr).getType()%>" value="medwan.common.yes" <%if(((TransactionVO)transaction).getItem("be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_TRACHEOSTOMIE-"+iDataSetNr).getValue().equals("medwan.common.yes")) out.print("checked");%>><label for="tracheostomie_yes"><%=getTran(request,"web.occup","medwan.common.yes",sWebLanguage)%></label>
                                <input type="radio" onDblClick="uncheckRadio(this);" id="tracheostomie_non" name="<%=((TransactionVO)transaction).getItem("be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_TRACHEOSTOMIE-"+iDataSetNr).getType()%>" value="medwan.common.no" <%if(((TransactionVO)transaction).getItem("be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_TRACHEOSTOMIE-"+iDataSetNr).getValue().equals("medwan.common.no")) out.print("checked");%>><label for="tracheostomie_non"><%=getTran(request,"web.occup","medwan.common.no",sWebLanguage)%></label>
                            </td>
                        </tr>
                        <tr>
                            <td class="admin"><%=getTran(request,"openclinic.chuk","days_tracheostomie",sWebLanguage)%></td>
                            <td class="admin2">
                        ...
                        <tr>
                            <td class="admin"><%=getTran(request,"openclinic.chuk","aspiration",sWebLanguage)%></td>
                            <td class="admin2">
                        ...
                        <tr>
                            <td class="admin"><%=getTran(request,"openclinic.chuk","vc",sWebLanguage)%></td>
                            <td class="admin2">
                        ...
                        <tr>
                            <td class="admin"><%=getTran(request,"openclinic.chuk","pc",sWebLanguage)%></td>
                            <td class="admin2">
                        ...
                        <tr>
                            <td class="admin"><%=getTran(request,"openclinic.chuk","peep_pression",sWebLanguage)%></td>
                            <td class="admin2">
                        ...
                        <tr>
                            <td class="admin"><%=getTran(request,"openclinic.chuk","days_ventilation",sWebLanguage)%></td>
                            <td class="admin2">
                        ...
                        <tr>
                            <td class="admin"><%=getTran(request,"openclinic.chuk","tidal_vol",sWebLanguage)%></td>
                            <td class="admin2">
                        ...
                        <tr>
                            <td class="admin"><%=getTran(request,"openclinic.chuk","min_volume",sWebLanguage)%></td>
                            <td class="admin2">
                        ...
                        <tr>
                            <td class="admin"><%=getTran(request,"openclinic.chuk","max_pression",sWebLanguage)%></td>
                            <td class="admin2">
                        ...
                        <tr>
                            <td class="admin"><%=getTran(request,"openclinic.chuk","diurese",sWebLanguage)%></td>
                            <td class="admin2">
                        ...
                        <tr>
                            <td class="admin"><%=getTran(request,"openclinic.chuk","drain_text1",sWebLanguage)%></td>
                            <td class="admin2">
                        ...
                        <tr>
                            <td class="admin"><%=getTran(request,"openclinic.chuk","drain1",sWebLanguage)%></td>
                            <td class="admin2">
                        ...
                        <tr>
                            <td class="admin"><%=getTran(request,"openclinic.chuk","drain_text2",sWebLanguage)%></td>
                            <td class="admin2">
                                <textarea class="text" onkeyup="resizeTextarea(this,10);limitChars(this,255);" name="<%=((TransactionVO)transaction).getItem("be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_DRAIN_TEXT2-"+iDataSetNr).getType()%>" cols="50" rows="2"><%=((TransactionVO)transaction).getItem("be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_DRAIN2-"+iDataSetNr).getValue()%></textarea>
                            </td>
                        </tr>
                        <tr>
                            <td class="admin"><%=getTran(request,"openclinic.chuk","drain2",sWebLanguage)%></td>
                            <td class="admin2">
                                <input type="text" class="text" name="<%=((TransactionVO)transaction).getItem("be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_DRAIN2-"+iDataSetNr).getType()%>" value="<%=((TransactionVO)transaction).getItem("be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_DRAIN2-"+iDataSetNr).getValue()%>" size="5" onchange="isNumber(this);calculateTotalOut();" id="drain2"> ml
                            </td>
                        </tr>
                        <tr>
                            <td class="admin"><%=getTran(request,"openclinic.chuk","drain_text3",sWebLanguage)%></td>
                            <td class="admin2">
                        ...
                        <tr>
                            <td class="admin"><%=getTran(request,"openclinic.chuk","drain3",sWebLanguage)%></td>
                            <td class="admin2">
                        ...
                        <tr>
                            <td class="admin"><%=getTran(request,"openclinic.chuk","drain_text4",sWebLanguage)%></td>
                            <td class="admin2">
                        ...
                        <tr>
                            <td class="admin"><%=getTran(request,"openclinic.chuk","drain4",sWebLanguage)%></td>
                            <td class="admin2">
                        ...
                        <tr>
                            <td class="admin"><%=getTran(request,"openclinic.chuk","drain_text5",sWebLanguage)%></td>
                            <td class="admin2">
                        ...
                        <tr>
                            <td class="admin"><%=getTran(request,"openclinic.chuk","drain5",sWebLanguage)%></td>
                            <td class="admin2">
                                <input type="text" class="text" name="<%=((TransactionVO)transaction).getItem("be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_DRAIN5-"+iDataSetNr).getType()%>" value="<%=((TransactionVO)transaction).getItem("be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_DRAIN5-"+iDataSetNr).getValue()%>" size="5" onchange="isNumber(this);calculateTotalOut();" id="drain5"> ml
                            </td>
                        </tr>
                        <tr>
                            <td class="admin"><%=getTran(request,"openclinic.chuk","sng",sWebLanguage)%></td>
                            <td class="admin2">
                        ...
                        <tr>
                            <td class="admin"><%=getTran(request,"openclinic.chuk","total_out",sWebLanguage)%></td>
                            <td class="admin2">
                        ...
                        <tr>
                            <td class="admin"><%=getTran(request,"openclinic.chuk","out",sWebLanguage)%></td>
                            <td class="admin2">
                                <input type="text" class="text" name="<%=((TransactionVO)transaction).getItem("be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_OUT-"+iDataSetNr).getType()%>" value="<%=((TransactionVO)transaction).getItem("be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_OUT-"+iDataSetNr).getValue()%>" size="5" onchange="isNumber(this);"> ml/kg/<%=getTran(request,"web.occup","medwan.common.hour",sWebLanguage)%>
                            </td>
                        </tr>
                        <tr>
                            <td class="admin"/>
                        ...
                        <tr>
                            <td class="admin"><%=getTran(request,"openclinic.chuk","vomissements",sWebLanguage)%></td>
                            <td class="admin2">
                        ...
                        <tr>
                            <td class="admin"><%=getTran(request,"openclinic.chuk","bilan_in_out",sWebLanguage)%></td>
                            <td class="admin2">
                        ...
                        <tr>
                            <td class="admin"><%=getTran(request,"openclinic.chuk","nurse_notes",sWebLanguage)%></td>
                            <td class="admin2">
                        ...
                        <tr>
                            <td class="admin"><%=getTran(request,"openclinic.chuk","remarks3",sWebLanguage)%></td>
                            <td class="admin2">
