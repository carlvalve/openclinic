    ...
    private StringBuffer addOther(int iTotal,String sName,String sValue,String sUnit, String sWebLanguage){
        ...
        sTmp.append("<tr id='rowOther"+iTotal+"'>")
             .append("<td class=\"admin2\">")
              .append("<a href='javascript:deleteOther(rowOther"+iTotal+")'><img src='" + sCONTEXTPATH + "/_img/icons/icon_delete.png' alt='" + getTran(null,"Web.Occup","medwan.common.delete",sWebLanguage) + "' border='0'></a> ")
              .append("<a href='javascript:editOther(rowOther"+iTotal+")'><img src='" + sCONTEXTPATH + "/_img/icons/icon_edit.png' alt='" + getTran(null,"Web.Occup","medwan.common.edit",sWebLanguage) + "' border='0'></a>")
             .append("</td>")
...
<form id="transactionForm" name="transactionForm" method="POST" action='<c:url value="/healthrecord/updateTransaction.do"/>?ts=<%=getTs()%>'>
    ...
    <table class="list" cellspacing="1" cellpadding="0" width="100%">
        ...
        <tr>
            ...
            <td class="admin2">
                <input type="text" class="text" size="5" <%=setRightClick(session,"ITEM_TYPE_TRACNET_INITIAL_BILAN_HTC")%> name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_TRACNET_INITIAL_BILAN_HTC" property="itemId"/>]>.value" value="<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_TRACNET_INITIAL_BILAN_HTC" property="value"/>" onblur="isNumber(this);"/>
                %
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="admin2">
                <input type="text" class="text" size="5" <%=setRightClick(session,"ITEM_TYPE_TRACNET_INITIAL_BILAN_PLAQUETTES")%> name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_TRACNET_INITIAL_BILAN_PLAQUETTES" property="itemId"/>]>.value" value="<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_TRACNET_INITIAL_BILAN_PLAQUETTES" property="value"/>" onblur="isNumber(this);"/>
                10E3/mm3
            </td>
        </tr>
        <tr>
            ...
            <td class="admin2">
                <input type="text" class="text" size="5" <%=setRightClick(session,"ITEM_TYPE_TRACNET_INITIAL_BILAN_ALAT")%> name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_TRACNET_INITIAL_BILAN_ALAT" property="itemId"/>]>.value" value="<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_TRACNET_INITIAL_BILAN_ALAT" property="value"/>" onblur="isNumber(this);"/>
                IU/l
            </td>
        </tr>
        <tr>
...
<script>
  ...
  function addOther(){
    if(isAtLeastOneOtherFieldFilled()){
      ...
      td.innerHTML = "<a href='javascript:deleteOther(rowOther"+iOtherIndex+")'><img src='<%=sCONTEXTPATH%>/_img/icons/icon_delete.png' alt='<%=getTranNoLink("Web.Occup","medwan.common.delete",sWebLanguage)%>' border='0'></a> "
                    +"<a href='javascript:editOther(rowOther"+iOtherIndex+")'><img src='<%=sCONTEXTPATH%>/_img/icons/icon_edit.png' alt='<%=getTranNoLink("Web.Occup","medwan.common.edit",sWebLanguage)%>' border='0'></a>";
      tr.appendChild(td);
  ...
  function updateOther(){
    if(isAtLeastOneOtherFieldFilled()){
      ...
      row.cells[0].innerHTML = "<a href='javascript:deleteOther("+editOtherRowid.id+")'><img src='<%=sCONTEXTPATH%>/_img/icons/icon_delete.png' alt='<%=getTranNoLink("Web.Occup","medwan.common.delete",sWebLanguage)%>' border='0'></a> "
                              +"<a href='javascript:editOther("+editOtherRowid.id+")'><img src='<%=sCONTEXTPATH%>/_img/icons/icon_edit.png' alt='<%=getTranNoLink("Web.Occup","medwan.common.edit",sWebLanguage)%>' border='0'></a>";
