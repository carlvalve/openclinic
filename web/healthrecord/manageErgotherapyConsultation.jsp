...
<%!
	private String addErgotherapy(int iTotal, String sTmpErgotherapyDate, String sTmpErgotherapyObservation, String sTmpErgotherapyConclusion, String sWebLanguage) {
	    return "<tr id='rowErgotherapy" + iTotal + "'>"
	            + "<td width='36'>"
	            + " <a href='javascript:deleteErgotherapy(rowErgotherapy" + iTotal + ")'><img src='" + sCONTEXTPATH + "/_img/icons/icon_delete.png' alt='" + getTran(null,"Web.Occup", "medwan.common.delete", sWebLanguage) + "' border='0'></a> "
	            + " <a href='javascript:editErgotherapy(rowErgotherapy" + iTotal + ")'><img src='" + sCONTEXTPATH + "/_img/icons/icon_edit.png' alt='" + getTran(null,"Web.Occup", "medwan.common.edit", sWebLanguage) + "' border='0'></a>"
	            + "</td>"
...
<form id="transactionForm" name="transactionForm" method="POST" action='<c:url value="/healthrecord/updateTransaction.do"/>?ts=<%=getTs()%>'>
    ...
    <tr>
        ...
        <td class="admin2">
            <textarea onKeyup="resizeTextarea(this,10);limitChars(this,255);" <%=setRightClick(session,"ITEM_TYPE_ERGOTHERAPY_OBJECTIVE")%> class="text" cols="80" rows="2" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_ERGOTHERAPY_OBJECTIVE" property="itemId"/>]>.value"><mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_ERGOTHERAPY_OBJECTIVE" property="value"/></textarea>
        </td>
    </tr>
    <tr class="admin" >
...
<script>
  ...
  function addErgotherapy(){
	  if(isAtLeastOneErgotherapyFieldFilled()){
	      ...
	      td.innerHTML = "<a href='javascript:deleteErgotherapy(rowErgotherapy"+iIndexPersoonlijk+")'><img src='<%=sCONTEXTPATH%>/_img/icons/icon_delete.png' alt='<%=getTranNoLink("Web.Occup","medwan.common.delete",sWebLanguage)%>' border='0'></a> "
	                    +"<a href='javascript:editErgotherapy(rowErgotherapy"+iIndexPersoonlijk+")'><img src='<%=sCONTEXTPATH%>/_img/icons/icon_edit.png' alt='<%=getTranNoLink("Web.Occup","medwan.common.edit",sWebLanguage)%>' border='0'></a>";
	      tr.appendChild(td);
	...
	function updateErgotherapy(){
	  if(isAtLeastOneErgotherapyFieldFilled()){
	    ...
	    row.cells[0].innerHTML = "<a href='javascript:deleteErgotherapy("+editErgotherapyRowid.id+")'><img src='<%=sCONTEXTPATH%>/_img/icons/icon_delete.png' alt='<%=getTranNoLink("Web.Occup","medwan.common.delete",sWebLanguage)%>' border='0'></a> "
	                            +"<a href='javascript:editErgotherapy("+editErgotherapyRowid.id+")'><img src='<%=sCONTEXTPATH%>/_img/icons/icon_edit.png' alt='<%=getTranNoLink("Web.Occup","medwan.common.edit",sWebLanguage)%>' border='0'></a>";
