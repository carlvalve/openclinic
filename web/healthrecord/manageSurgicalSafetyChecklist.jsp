...
<%=checkPermission("occup.surgicalsafetychecklist","select",activeUser)%>
    ...
    <table class="list" width="100%" cellspacing="1">
		...
		<tr>
			<td valign='top'>
				<table width=100%>
					<tr class='admin'>
						<td><%=getTran("web","before.induction.anesthesia",sWebLanguage)%></td>
					</tr>
					<tr>
						<td><%=getTran("web","at.least.nurse.and.anaesthesist",sWebLanguage)%></td>
					</tr>
					<tr>
						<td class='admin'>
							<%=getTran("web","patient.confirmed.identity.and.consent",sWebLanguage)%><br/>
					...
					<tr>
						<td class='admin'>
							<%=getTran("web","site.marked",sWebLanguage)%><br/>
					...
					<tr>
						<td class='admin'>
							<%=getTran("web","pulsoxy.check",sWebLanguage)%><br/>
					...
					<tr>
						<td class='admin'>
							<%=getTran("web","patient.has",sWebLanguage)%><br/>
						</td>
					</tr>
					<tr>
						<td class='admin2'>
							<b><%=getTran("web","know.allergy",sWebLanguage)%></b><br/>
					...
					<tr>
						<td class='admin2'>
							<b><%=getTran("web","difficult.airway",sWebLanguage)%></b><br/>
			...
			<td valign='top'>
				<table width=100%>
					<tr class='admin'>
						<td><%=getTran("web","before.skin.incision",sWebLanguage)%></td>
					</tr>
					<tr>
						<td><%=getTran("web","nurse.and.anaesthesist.and.surgeon",sWebLanguage)%></td>
					</tr>
					<tr>
						<td class='admin'>
							<%=getTran("web","confirm.members.introduction",sWebLanguage)%><br/>
					...
					<tr>
						<td class='admin'>
							<%=getTran("web","confirm.procedure",sWebLanguage)%><br/>
					...
					<tr>
						<td class='admin'>
							<%=getTran("web","antibiotic.given",sWebLanguage)%><br/>
			...
			<td valign='top'>
				<table width=100%>
					<tr class='admin'>
						<td><%=getTran("web","before.patient.leaves.ot",sWebLanguage)%></td>
					</tr>
					<tr>
						<td><%=getTran("web","nurse.and.anaesthesist.and.surgeon",sWebLanguage)%></td>
					</tr>
