                ...
                %>
                    <tr class="label2">
                                ...
                                <%if(activeUser.getAccessRight("diagnoses.createlocal.select")){ %> 
                                	(<a href='javascript:addnewlocalcode("<%=keywords%>")'><%=getTran(request,"web","managelocalcodes",sWebLanguage)%></a>)
                                <%} %>
                                </td>
