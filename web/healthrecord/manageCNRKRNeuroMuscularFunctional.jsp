    ...
    <tr>
       ...
       <tr>
           <td class="admin" rowspan='3'><%=getTran(request,"web","stairs",sWebLanguage)%></td>
        	...
        	<td class="admin2" colspan='4'>
           		<input <%=setRightClick("ITEM_TYPE_CNRKR_STAIRS_NUMBEROFSTEPS")%> type='text' class='text' size='5' name='currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_CNRKR_STAIRS_NUMBEROFSTEPS" property="itemId"/>]>.value' value='<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_CNRKR_STAIRS_NUMBEROFSTEPS" property="value"/>'/>
        	</td>
        </tr>
        <tr>
