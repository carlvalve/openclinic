...
<%!
    ...
    private StringBuffer addBio(int iTotal,String sDate,String sWeight,String sHeight,String sSkull,String sFood,String sWebLanguage){
        ...
        sTmp.append(
            "<tr id='rowBio"+iTotal+"'>"+
                "<td class=\"admin2\">"+
                "   <a href='javascript:deleteBio(rowBio"+iTotal+")'><img src='"+sCONTEXTPATH+"/_img/icons/icon_delete.png' alt='"+getTranNoLink("Web.Occup","medwan.common.delete",sWebLanguage)+"' border='0'></a>"+
                "   <a href='javascript:editBio(rowBio"+iTotal+")'><img src='"+sCONTEXTPATH+"/_img/icons/icon_edit.png' alt='"+getTranNoLink("Web.Occup","medwan.common.edit",sWebLanguage)+"' border='0'></a>"+
                "</td>" +
        ...
        <td colspan="2">
            <table cellspacing="1" cellpadding="0" width="100%" border="0" id="tblBio" class="list">
                <tr>
                    ...
                    <td class='admin' width="120"><%=getTran(request,"Web.Occup","medwan.healthrecord.biometry.weight",sWebLanguage)%></td>
                    <td class='admin' width="120"><%=getTran(request,"Web.Occup","medwan.healthrecord.biometry.length",sWebLanguage)%></td>
                    <td class='admin' width="120"><%=getTran(request,"openclinic.chuk","skull",sWebLanguage)%></td>
                    <td class='admin'><%=getTran(request,"openclinic.chuk","food",sWebLanguage)%></td>
                    <td class='admin'/>
                </tr>
                <tr>
                    <td class="admin2"/>
                    ...
                    <td class="admin2">
                        <select class="text" name="EditFood">
                            <option/>
                            <option value="food_phase1"><%=getTran(request,"biometry_food","food_phase1",sWebLanguage)%></option>
                            <option value="food_phase2"><%=getTran(request,"biometry_food","food_phase2",sWebLanguage)%></option>
                            <option value="food_phase3"><%=getTran(request,"biometry_food","food_phase3",sWebLanguage)%></option>
                            <option value="food_good"><%=getTran(request,"biometry_food","food_good",sWebLanguage)%></option>
                        </select>
                    </td>
                    <td class="admin2">
...
function addBio(){
  if(isAtLeastOneBioFieldFilled()){
      ...
      td.innerHTML = "<a href='javascript:deleteBio(rowBio"+iBioIndex+")'><img src='<%=sCONTEXTPATH%>/_img/icons/icon_delete.png' alt='<%=getTranNoLink("Web.Occup","medwan.common.delete",sWebLanguage)%>' border='0'></a> "
                    +"<a href='javascript:editBio(rowBio"+iBioIndex+")'><img src='<%=sCONTEXTPATH%>/_img/icons/icon_edit.png' alt='<%=getTranNoLink("Web.Occup","medwan.common.edit",sWebLanguage)%>' border='0'></a>";
      tr.appendChild(td);
...
function updateBio(){
  if(isAtLeastOneBioFieldFilled()){
    ...
    row.cells[0].innerHTML = "<a href='javascript:deleteBio("+editBioRowid.id+")'><img src='<%=sCONTEXTPATH%>/_img/icons/icon_delete.png' alt='<%=getTranNoLink("Web.Occup","medwan.common.delete",sWebLanguage)%>' border='0'></a> "
                            +"<a href='javascript:editBio("+editBioRowid.id+")'><img src='<%=sCONTEXTPATH%>/_img/icons/icon_edit.png' alt='<%=getTranNoLink("Web.Occup","medwan.common.edit",sWebLanguage)%>' border='0'></a>";
