...
<%=checkPermission("occup.ccbrt.cataract","select",activeUser)%>
        ...
        <tr>
        	<td colspan="2">
	        	<table width='100%'>
	        		...
	        		<tr class='admin'>
	        			<td colspan="7"><%=getTran(request,"web","postoperative",sWebLanguage)%></td>
	        		</tr>
	        		<tr>
	        			<td class='admin'><%=getTran(request,"web","followupvisits",sWebLanguage)%></td>
	        			<td class='admin'><%=getTran(request,"web","date",sWebLanguage)%></td>
	        			<td class='admin' colspan='2'><%=getTran(request,"web","presentingva",sWebLanguage)%></td>
	        			<td class='admin' colspan='2'><%=getTran(request,"web","bestcorrectedva",sWebLanguage)%></td>
	        			<td class='admin' colspan='2'><%=getTran(request,"web","causeoflowva",sWebLanguage)%></td>
	        		</tr>
		        	<tr>
			            <td class="admin"><%=getTran(request,"ccbrt.cataract","discharge",sWebLanguage)%></td>
			            <td class="admin2" nowrap>
			            ...
			            <td class="admin2" colspan="2">
			                <select class="text" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_CCBRT_CATARACT_DISCHARGE_PRESENTINGVA" property="itemId"/>]>.value">
			                	<option/>
				            	<%=ScreenHelper.writeSelect(request,"ccbrt.cataract.va",((TransactionVO)transaction).getItemValue("be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_CCBRT_CATARACT_DISCHARGE_PRESENTINGVA"),sWebLanguage,false,false) %>
			                </select>
			            </td>
			            <td class="admin2" colspan="2">
			                <select class="text" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_CCBRT_CATARACT_DISCHARGE_BESTCORRECTEDVA" property="itemId"/>]>.value">
			                	<option/>
				            	<%=ScreenHelper.writeSelect(request,"ccbrt.cataract.va",((TransactionVO)transaction).getItemValue("be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_CCBRT_CATARACT_DISCHARGE_BESTCORRECTEDVA"),sWebLanguage,false,false) %>
			                </select>
			            </td>
			            <td class="admin2" colspan="2">
		        	...
		        	<tr>
			            ...
			            <td class="admin2" colspan="2">
			                <select class="text" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_CCBRT_CATARACT_POSTOP1TO3WEEKS_PRESENTINGVA" property="itemId"/>]>.value">
			                	<option/>
				            	<%=ScreenHelper.writeSelect(request,"ccbrt.cataract.va",((TransactionVO)transaction).getItemValue("be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_CCBRT_CATARACT_POSTOP1TO3WEEKS_PRESENTINGVA"),sWebLanguage,false,false) %>
			                </select>
			            </td>
			            <td class="admin2" colspan="2">
			                <select class="text" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_CCBRT_CATARACT_POSTOP1TO3WEEKS_BESTCORRECTEDVA" property="itemId"/>]>.value">
			                	<option/>
				            	<%=ScreenHelper.writeSelect(request,"ccbrt.cataract.va",((TransactionVO)transaction).getItemValue("be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_CCBRT_CATARACT_POSTOP1TO3WEEKS_BESTCORRECTEDVA"),sWebLanguage,false,false) %>
			                </select>
			            </td>
			            <td class="admin2" colspan="2">
		        	...
		        	<tr>
			            <td class="admin"><%=getTran(request,"ccbrt.cataract","postop4to11weeks",sWebLanguage)%></td>
			            <td class="admin2" nowrap>
			            	<input type="hidden" id="postop4to11datefield" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_CCBRT_CATARACT_POSTOP4TO11WEEKSDATE" property="itemId"/>]>.value"/>
							<%=ScreenHelper.writeDateField("postop4to11date", "transactionForm", ((TransactionVO)transaction).getItemValue("be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_CCBRT_CATARACT_POSTOP4TO11WEEKSDATE"), true, false, sWebLanguage, sCONTEXTPATH)%>
			            </td>
			            <td class="admin2" colspan="2">
			                <select class="text" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_CCBRT_CATARACT_POSTOP4TO11WEEKSDATE_PRESENTINGVA" property="itemId"/>]>.value">
			                	<option/>
				            	<%=ScreenHelper.writeSelect(request,"ccbrt.cataract.va",((TransactionVO)transaction).getItemValue("be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_CCBRT_CATARACT_POSTOP4TO11WEEKSDATE_PRESENTINGVA"),sWebLanguage,false,false) %>
			                </select>
			            </td>
			            <td class="admin2" colspan="2">
			                <select class="text" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_CCBRT_CATARACT_POSTOP4TO11WEEKSDATE_BESTCORRECTEDVA" property="itemId"/>]>.value">
			                	<option/>
				            	<%=ScreenHelper.writeSelect(request,"ccbrt.cataract.va",((TransactionVO)transaction).getItemValue("be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_CCBRT_CATARACT_POSTOP4TO11WEEKSDATE_BESTCORRECTEDVA"),sWebLanguage,false,false) %>
			                </select>
			            </td>
			            <td class="admin2" colspan="2">
			                <select class="text" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_CCBRT_CATARACT_POSTOP4TO11WEEKSDATE_LOWVAREASON" property="itemId"/>]>.value">
			                	<option/>
				            	<%=ScreenHelper.writeSelect(request,"ccbrt.cataract.lowvareason",((TransactionVO)transaction).getItemValue("be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_CCBRT_CATARACT_POSTOP4TO11WEEKSDATE_LOWVAREASON"),sWebLanguage,false,true) %>
			                </select>
			            </td>
			        </tr>
		        	<tr>
			            <td class="admin"><%=getTran(request,"ccbrt.cataract","postop12plusweeks",sWebLanguage)%></td>
			            <td class="admin2" nowrap>
			            	<input type="hidden" id="postop12plusdatefield" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_CCBRT_CATARACT_POSTOP12PLUSWEEKSDATE" property="itemId"/>]>.value"/>
							<%=ScreenHelper.writeDateField("postop12plusdate", "transactionForm", ((TransactionVO)transaction).getItemValue("be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_CCBRT_CATARACT_POSTOP12PLUSWEEKSDATE"), true, false, sWebLanguage, sCONTEXTPATH)%>
			            </td>
			            <td class="admin2" colspan="2">
			                <select class="text" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_CCBRT_CATARACT_POSTOP12PLUSWEEKSDATE_PRESENTINGVA" property="itemId"/>]>.value">
			                	<option/>
				            	<%=ScreenHelper.writeSelect(request,"ccbrt.cataract.va",((TransactionVO)transaction).getItemValue("be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_CCBRT_CATARACT_POSTOP12PLUSWEEKSDATE_PRESENTINGVA"),sWebLanguage,false,false) %>
			                </select>
			            </td>
			            <td class="admin2" colspan="2">
			                <select class="text" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_CCBRT_CATARACT_POSTOP12PLUSWEEKSDATE_BESTCORRECTEDVA" property="itemId"/>]>.value">
			                	<option/>
				            	<%=ScreenHelper.writeSelect(request,"ccbrt.cataract.va",((TransactionVO)transaction).getItemValue("be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_CCBRT_CATARACT_POSTOP12PLUSWEEKSDATE_BESTCORRECTEDVA"),sWebLanguage,false,false) %>
			                </select>
			            </td>
			            <td class="admin2" colspan="2">
			                <select class="text" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_CCBRT_CATARACT_POSTOP12PLUSWEEKSDATE_LOWVAREASON" property="itemId"/>]>.value">
			                	<option/>
				            	<%=ScreenHelper.writeSelect(request,"ccbrt.cataract.lowvareason",((TransactionVO)transaction).getItemValue("be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_CCBRT_CATARACT_POSTOP12PLUSWEEKSDATE_LOWVAREASON"),sWebLanguage,false,true) %>
			                </select>
			            </td>
			        </tr>
		        	<tr>
			            <td class="admin" colspan="7"><%=getTran(request,"ccbrt.cataract","postoprefraction",sWebLanguage)%></td>
			        </tr>
		        	<tr>
			            <td class="admin"><%=getTran(request,"ccbrt.cataract","postop4to11weeks",sWebLanguage)%></td>
			            <td class="admin2" nowrap>
			                <%=getTran(request,"ccbrt.cataract","sph",sWebLanguage)%>:
			                <input onkeyup='calculateDSE();' id='sph4to11' type="text" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_CCBRT_CATARACT_POSTOP4TO11WEEKS_SPH" property="itemId"/>]>.value" value="<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_CCBRT_CATARACT_POSTOP4TO11WEEKS_SPH" property="value"/>" class="text" size="5" >
			            </td>
			            <td class="admin2" nowrap colspan="2">
			                <%=getTran(request,"ccbrt.cataract","cyl",sWebLanguage)%>:
			                <input onkeyup='calculateDSE();' id='cyl4to11' type="text" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_CCBRT_CATARACT_POSTOP4TO11WEEKS_CYL" property="itemId"/>]>.value" value="<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_CCBRT_CATARACT_POSTOP4TO11WEEKS_CYL" property="value"/>" class="text" size="5" >
			            </td>
			            <td class="admin2" nowrap colspan="2">
			                <%=getTran(request,"ccbrt.cataract","axis",sWebLanguage)%>:
			                <input type="text" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_CCBRT_CATARACT_POSTOP4TO11WEEKS_AXIS" property="itemId"/>]>.value" value="<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_CCBRT_CATARACT_POSTOP4TO11WEEKS_AXIS" property="value"/>" class="text" size="5" >
			            </td>
			            <td class="admin2" nowrap colspan="2">
			                <%=getTran(request,"ccbrt.cataract","dse",sWebLanguage)%>:
			                <input onkeyup='calculateDSE();' id='dse4to11' type="text" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_CCBRT_CATARACT_POSTOP4TO11WEEKS_DSE" property="itemId"/>]>.value" value="<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_CCBRT_CATARACT_POSTOP4TO11WEEKS_DSE" property="value"/>" class="text" size="5" >
			            </td>
			        </tr>
		        	<tr>
			            <td class="admin"><%=getTran(request,"ccbrt.cataract","postop12plusweeks",sWebLanguage)%></td>
			            <td class="admin2" nowrap>
			                <%=getTran(request,"ccbrt.cataract","sph",sWebLanguage)%>:
			                <input onkeyup='calculateDSE();' id='sph12plus' type="text" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_CCBRT_CATARACT_POSTOP12PLUSWEEKS_SPH" property="itemId"/>]>.value" value="<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_CCBRT_CATARACT_POSTOP12PLUSWEEKS_SPH" property="value"/>" class="text" size="5" >
			            </td>
			            <td class="admin2" nowrap colspan="2">
			                <%=getTran(request,"ccbrt.cataract","cyl",sWebLanguage)%>:
			                <input onkeyup='calculateDSE();' id='cyl12plus' type="text" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_CCBRT_CATARACT_POSTOP12PLUSWEEKS_CYL" property="itemId"/>]>.value" value="<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_CCBRT_CATARACT_POSTOP12PLUSWEEKS_CYL" property="value"/>" class="text" size="5" >
			            </td>
			            <td class="admin2" nowrap colspan="2">
			                <%=getTran(request,"ccbrt.cataract","axis",sWebLanguage)%>:
			                <input type="text" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_CCBRT_CATARACT_POSTOP12PLUSWEEKS_AXIS" property="itemId"/>]>.value" value="<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_CCBRT_CATARACT_POSTOP12PLUSWEEKS_AXIS" property="value"/>" class="text" size="5" >
			            </td>
			            <td class="admin2" nowrap colspan="2">
			                <%=getTran(request,"ccbrt.cataract","dse",sWebLanguage)%>:
			                <input onkeyup='calculateDSE();' id='dse12plus' type="text" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_CCBRT_CATARACT_POSTOP12PLUSWEEKS_DSE" property="itemId"/>]>.value" value="<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_CCBRT_CATARACT_POSTOP12PLUSWEEKS_DSE" property="value"/>" class="text" size="5" >
			            </td>
			        </tr>
	            </table>
	        </td>
...
function calculateDSE(){
	var target = 0;
	if(document.getElementById('sphtarget').value.length>0){
		target=document.getElementById('sphtarget').value*1;
	}
...
function searchEncounter(){
  ...
  function submitForm(){
    ...
    document.getElementById("dischargedatefield").value=document.getElementById("dischargedate").value;
    document.getElementById("postop1to3datefield").value=document.getElementById("postop1to3date").value;
    document.getElementById("postop4to11datefield").value=document.getElementById("postop4to11date").value;
    document.getElementById("postop12plusdatefield").value=document.getElementById("postop12plusdate").value;
    <%
