...
<table width="100%" class="list" cellspacing="0">
    <tr class="admin">
        <td><%=getTran(request,"Web.Occup","medwan.healthrecord.anamnese.endocrinologie",sWebLanguage)%></td>
        <td align="right" width="20%">
            <%=getLabel(request,"Web.Occup","medwan.common.nothing-to-mention",sWebLanguage,"mcee-c1")%>&nbsp;<input name="endocrino-ras" type="checkbox" id="mcee-c1" value="medwan.common.true" onclick="if (this.checked == true) {hide('ENDOCRINO-details');setTrue('<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_ENDOCRINO_RAS" property="itemId"/>'); } else {show('ENDOCRINO-details');setFalse('<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_ENDOCRINO_RAS" property="itemId"/>'); }">
        </td>
