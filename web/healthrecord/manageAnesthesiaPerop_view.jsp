...
<%=checkPermission("occup.anesthesiaperop","select",activeUser)%>
<form name="transactionForm" method="POST" action='<c:url value="/healthrecord/updateTransaction.do"/>?ts=<%=getTs()%>' onclick="setSaveButton();" onkeyup="setSaveButton();">
    ...
    <table class="list" width="100%" cellspacing="1">
        ...
        <tr>
            ...
            <td class="admin2">
                <textarea onKeyup="resizeTextarea(this,10);limitChars(this,255);" <%=setRightClick(session,"ITEM_TYPE_ANESTHESIA_PEROP_REPORT")%> class="text" cols="100" rows="2" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_ANESTHESIA_PEROP_REPORT" property="itemId"/>]>.value"><mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_ANESTHESIA_PEROP_REPORT" property="value"/></textarea>
            </td>
        </tr>
        <tr>
            <td class="admin"/>
...
<%-- BUTTONS --%>
    <%
      if (activeUser.accessRights.get("occup.anesthesiaperop.add")!=null || activeUser.accessRights.get("occup.anesthesiaperop.edit")!=null){
    %>
