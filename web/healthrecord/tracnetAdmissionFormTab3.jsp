...
<table class="list" cellspacing="1" cellpadding="0" width="100%">
    <tr>
        <td class="admin" width="<%=sTDAdminWidth%>"><%=getTran(request,"openclinic.chuk","weigth",sWebLanguage)%></td>
        <td class="admin2">
    ...
    <tr>
        <td class="admin"><%=getTran(request,"openclinic.chuk","tracnet.admission.form.rr",sWebLanguage)%></td>
        <td class="admin2">
            <input type="text" class="text" size="5" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_ADMISSION_FORM_EXAMINATION_RR" property="itemId"/>]>.value" value="<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_ADMISSION_FORM_EXAMINATION_RR" property="value"/>" onblur="isNumber(this);"/>
        </td>
    </tr>
    <tr>
        <td class="admin"><%=getTran(request,"openclinic.chuk","tracnet.admission.form.temp",sWebLanguage)%></td>
        <td class="admin2">
    ...
    <tr>
        <td class="admin"><%=getTran(request,"openclinic.chuk","tracnet.admission.form.ta",sWebLanguage)%></td>
        <td class="admin2">
    ...
    <tr>
        <td class="admin"><%=getTran(request,"openclinic.chuk","tracnet.admission.form.hr",sWebLanguage)%></td>
        <td class="admin2">
...
<table class="list" cellspacing="1" cellpadding="0" width="100%">
    <tr class="admin">
        <td width="<%=sTDAdminWidth%>"><%=getTran(request,"openclinic.chuk","tracnet.admission.form.system",sWebLanguage)%></td>
        <td><%=getTran(request,"openclinic.chuk","tracnet.admission.form.description",sWebLanguage)%></td>
    </tr>
    <tr>
        <td class="admin"><%=getTran(request,"openclinic.chuk","tracnet.admission.form.orl",sWebLanguage)%></td>
        <td class="admin2">
    ...
    <tr>
        <td class="admin"><%=getTran(request,"openclinic.chuk","tracnet.admission.form.skin",sWebLanguage)%></td>
        <td class="admin2">
    ...
    <tr>
        <td class="admin"><%=getTran(request,"openclinic.chuk","tracnet.admission.form.cardio",sWebLanguage)%></td>
        <td class="admin2">
    ...
    <tr>
        <td class="admin"><%=getTran(request,"openclinic.chuk","tracnet.admission.form.pulmonaire",sWebLanguage)%></td>
        <td class="admin2">
    ...
    <tr>
        <td class="admin"><%=getTran(request,"openclinic.chuk","tracnet.admission.form.abdominal",sWebLanguage)%></td>
        <td class="admin2">
    ...
    <tr>
        <td class="admin"><%=getTran(request,"openclinic.chuk","tracnet.admission.form.neuro",sWebLanguage)%></td>
        <td class="admin2">
    ...
    <tr>
        <td class="admin"><%=getTran(request,"openclinic.chuk","tracnet.admission.form.rhumato",sWebLanguage)%></td>
        <td class="admin2">
    ...
    <tr>
        <td class="admin"><%=getTran(request,"openclinic.chuk","tracnet.admission.form.uro",sWebLanguage)%></td>
        <td class="admin2">
