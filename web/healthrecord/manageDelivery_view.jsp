...
<form name="transactionForm" id="transactionForm" method="POST" action='<c:url value="/healthrecord/updateTransaction.do"/>?ts=<%=getTs()%>'>
    ...
    <table class="list" width="100%" cellspacing="1">
        <tr class="admin">
            <td colspan="4"><%=getTran(request,"gynaeco","work",sWebLanguage)%></td>
        </tr>
        <%-- DATE --%>
        <tr>
        ...
        <tr>
            <td class="admin">
                <%=getTran(request,"gynaeco","start.hour",sWebLanguage)%>
            </td>
            <td class="admin2">
                <input <%=setRightClick(session,"ITEM_TYPE_DELIVERY_STARTHOUR")%> type="text" class="text" size="5" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_DELIVERY_STARTHOUR" property="itemId"/>]>.value" value="<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_DELIVERY_STARTHOUR" property="value"/>" onblur="checkTime(this)">
            </td>
        </tr>
        <tr>
            <td class="admin">
                <%=getTran(request,"gynaeco","age.gestationnel",sWebLanguage)%>
            </td>
            <td class="admin2">
                <table>
                    <tr>
                        <td><%=getTran(request,"gynaeco","age.date.dr",sWebLanguage)%></td>
                        <td><input <%=setRightClick(session,"ITEM_TYPE_DELIVERY_AGE_DATE_DR")%> type="text" class="text" size="5" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_DELIVERY_AGE_DATE_DR" property="itemId"/>]>.value" value="<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_DELIVERY_AGE_DATE_DR" property="value"/>" onblur="isNumber(this)"> <%=getTran(request,"web","weeks",sWebLanguage)%></td>
                    </tr>
                    <tr>
                        <td><%=getTran(request,"gynaeco","age.echography",sWebLanguage)%></td>
                        <td><input <%=setRightClick(session,"ITEM_TYPE_DELIVERY_AGE_ECHOGRAPHY")%> type="text" class="text" size="5" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_DELIVERY_AGE_ECHOGRAPHY" property="itemId"/>]>.value" value="<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_DELIVERY_AGE_ECHOGRAPHY" property="value"/>" onblur="isNumber(this)"> <%=getTran(request,"web","weeks",sWebLanguage)%></td>
                    </tr>
                    <tr>
                        <td><%=getTran(request,"gynaeco","age.trimstre",sWebLanguage)%></td>
                        <td>
        ...
        <%-- Delivrance --%>
        <tr class="admin">
            <td colspan="4"><%=getTran(request,"gynaeco","deliverance",sWebLanguage)%></td>
        </tr>
        <tr>
            <td class="admin">
        ...
        <tr>
            <td class="admin"><%=getTran(request,"gynaeco","height",sWebLanguage)%></td>
            <td class="admin2">
            ...
            <td class="admin"><%=getTran(request,"gynaeco","cranien",sWebLanguage)%></td>
            <td class="admin2">
                    ...
                    <tr id="tralive2">
                        ...
                        <td bgcolor="#EBF3F7">
                            <table bgcolor="white" cellspacing="1">
                                ...
                                <tr>
                                    <td class="admin2"><%=getTran(request,"openclinic.chuk","malformation",sWebLanguage)%></td>
                                    <td class="admin2">
                                ...
                                <tr>
                                    <td class="admin2"><%=getTran(request,"openclinic.chuk","observation",sWebLanguage)%></td>
                                    <td class="admin2">
                                ...
                                <tr>
                                    <td class="admin2"><%=getTran(request,"openclinic.chuk","treatment",sWebLanguage)%></td>
                                    <td class="admin2">
                                ...
                                <tr>
                                    <td class="admin2"><%=getTran(request,"openclinic.chuk","polio.date",sWebLanguage)%></td>
                                    <td class="admin2">
                                ...
                                <tr>
                                    <td class="admin2"><%=getTran(request,"openclinic.chuk","bcg.date",sWebLanguage)%></td>
                                    <td class="admin2">
