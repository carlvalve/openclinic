        ...
        <td style="vertical-align:top" width="50%">                
            <table class="list" cellspacing="1" cellpadding="0" width="100%">
		       ...
		       <tr>
		           ...
		           <td class="admin2" colspan='3'>
		               <textarea onKeyup="resizeTextarea(this,10);limitChars(this,5000);" <%=setRightClick("ITEM_TYPE_CNRKR_KINE_INFLUENCINGFACTORS")%> class="text" cols="60" rows="1" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_CNRKR_KINE_INFLUENCINGFACTORS" property="itemId"/>]>.value"><mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_CNRKR_KINE_INFLUENCINGFACTORS" property="value"/></textarea>
		           </td>
		       </tr>
		       <tr class="admin" style="padding:0px;">
    	...
    	<td style="vertical-align:top" width="50%">                
            <table class="list" cellspacing="1" cellpadding="0" width="100%">
		       ...
		       <tr>
		           ...
		           <td class="admin2" colspan='3'>
		               <textarea onKeyup="resizeTextarea(this,10);limitChars(this,5000);" <%=setRightClick("ITEM_TYPE_CNRKR_KINE_DIAGNOSTICACTS")%> class="text" cols="60" rows="1" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_CNRKR_KINE_DIAGNOSTICACTS" property="itemId"/>]>.value"><mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_CNRKR_KINE_DIAGNOSTICACTS" property="value"/></textarea>
		           </td>
		       </tr>
		       <tr>
		           <td class="admin"><%=getTran(request,"web","diagnostictests",sWebLanguage)%></td>
		           <td class="admin2" colspan='3'>
		               <textarea onKeyup="resizeTextarea(this,10);limitChars(this,5000);" <%=setRightClick("ITEM_TYPE_CNRKR_KINE_DIAGNOSTICTESTS")%> class="text" cols="60" rows="1" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_CNRKR_KINE_DIAGNOSTICTESTS" property="itemId"/>]>.value"><mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_CNRKR_KINE_DIAGNOSTICTESTS" property="value"/></textarea>
		           </td>
		       </tr>
		       <tr>
		           <td class="admin"><%=getTran(request,"web","diagnisticresults",sWebLanguage)%></td>
		           <td class="admin2">
		               <textarea onKeyup="resizeTextarea(this,10);limitChars(this,5000);" <%=setRightClick("ITEM_TYPE_CNRKR_KINE_DIAGNOSTICRESULTS")%> class="text" cols="40" rows="1" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_CNRKR_KINE_DIAGNOSTICRESULTS" property="itemId"/>]>.value"><mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_CNRKR_KINE_DIAGNOSTICRESULTS" property="value"/></textarea>
		           </td>
		           <td class="admin2"><%=getTran(request,"web.occup","severity",sWebLanguage)%></td>
		           <td class='admin2'>
			            <select id="functionalseverity" class="text" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_CNRKR_KINE_DIAGNOSTICSEVERITY" property="itemId"/>]>.value">
			               	<option/>
			            	<%=ScreenHelper.writeSelect(request,"functionalseverity",((TransactionVO)transaction).getItemValue("be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_CNRKR_KINE_DIAGNOSTICSEVERITY"),sWebLanguage,false,true) %>
			            </select>
		           </td>
		       </tr>
		       <tr class="admin" style="padding:0px;">
		       ...
		       <tr>
		           ...
		           <td class="admin2" colspan='3'>
		               <textarea onKeyup="resizeTextarea(this,10);limitChars(this,5000);" <%=setRightClick("ITEM_TYPE_CNRKR_KINE_FUNCTIONALLIMITATIONS")%> class="text" cols="60" rows="1" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_CNRKR_KINE_FUNCTIONALLIMITATIONS" property="itemId"/>]>.value"><mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_CNRKR_KINE_FUNCTIONALLIMITATIONS" property="value"/></textarea>
		           </td>
		       </tr>
		       <tr>
		           <td class="admin"><%=getTran(request,"web","functionaldisorders",sWebLanguage)%></td>
		           <td class="admin2">
		               <textarea onKeyup="resizeTextarea(this,10);limitChars(this,5000);" <%=setRightClick("ITEM_TYPE_CNRKR_KINE_FUNCTIONALDISORDERS")%> class="text" cols="40" rows="1" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_CNRKR_KINE_FUNCTIONALDISORDERS" property="itemId"/>]>.value"><mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_CNRKR_KINE_FUNCTIONALDISORDERS" property="value"/></textarea>
		           </td>
		           <td class="admin2"><%=getTran(request,"web.occup","severity",sWebLanguage)%></td>
		           <td class='admin2'>
			            <select id="functionalseverity" class="text" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_CNRKR_KINE_FUNCTIONALDISORDERSEVERITY" property="itemId"/>]>.value">
			               	<option/>
			            	<%=ScreenHelper.writeSelect(request,"functionalseverity",((TransactionVO)transaction).getItemValue("be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_CNRKR_KINE_FUNCTIONALDISORDERSEVERITY"),sWebLanguage,false,true) %>
			            </select>
		           </td>
		       </tr>
		       <tr>
