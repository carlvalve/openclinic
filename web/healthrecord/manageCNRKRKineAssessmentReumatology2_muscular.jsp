	...
	<tr>
		<td class='admin2' width='100%' style="vertical-align:top;padding:0px;">
			<table width='100%' cellspacing='1' cellpadding='0'>
				<tr class='admin'>
       				<td colspan='2'>
       					<center><%=getTran(request,"cnrkr","amyotrophia",sWebLanguage)%></center>
       				</td>
       			</tr>
				<tr>
       					...
       					<table width='100%' cellspacing='0' cellpadding='0'>
       						<tr>
			       				...
			       				<td class='admin2' width='12.5%'><center>
			  						<%=ScreenHelper.writeDefaultVisualNumericInput(session,(TransactionVO)transaction, "ITEM_TYPE_CNRKR_KINE_ASSESSMENT_REUMATOLOGY2_MUSCAMYOMEAS_"+m+"_R", 3, sWebLanguage, sCONTEXTPATH) %>
			       				</center></td>
			       				<td class='admin2' width='12.5%'><center>
			  						<%=ScreenHelper.writeDefaultVisualNumericInput(session,(TransactionVO)transaction, "ITEM_TYPE_CNRKR_KINE_ASSESSMENT_REUMATOLOGY2_MUSCAMYOMEAS_"+m+"5_L", 3, sWebLanguage, sCONTEXTPATH) %>
			       				</center></td>
			       				<td class='admin2' width='12.5%'><center>
			  						<%=ScreenHelper.writeDefaultVisualNumericInput(session,(TransactionVO)transaction, "ITEM_TYPE_CNRKR_KINE_ASSESSMENT_REUMATOLOGY2_MUSCAMYOMEAS_"+m+"10_R", 3, sWebLanguage, sCONTEXTPATH) %>
			       				</center></td>
			       				<td class='admin2' width='12.5%'><center>
			  						<%=ScreenHelper.writeDefaultVisualNumericInput(session,(TransactionVO)transaction, "ITEM_TYPE_CNRKR_KINE_ASSESSMENT_REUMATOLOGY2_MUSCAMYOMEAS_"+m+"10_L", 3, sWebLanguage, sCONTEXTPATH) %>
			       				</center></td>
			       				<td class='admin2' width='12.5%'><center>
			  						<%=ScreenHelper.writeDefaultVisualNumericInput(session,(TransactionVO)transaction, "ITEM_TYPE_CNRKR_KINE_ASSESSMENT_REUMATOLOGY2_MUSCAMYOMEAS_"+m+"15_R", 3, sWebLanguage, sCONTEXTPATH) %>
			       				</center></td>
			       				<td class='admin2' width='12.5%'><center>
			  						<%=ScreenHelper.writeDefaultVisualNumericInput(session,(TransactionVO)transaction, "ITEM_TYPE_CNRKR_KINE_ASSESSMENT_REUMATOLOGY2_MUSCAMYOMEAS_"+m+"15_L", 3, sWebLanguage, sCONTEXTPATH) %>
			       				</center></td>
			       				<td class='admin2' width='12.5%'><center>
			  						<%=ScreenHelper.writeDefaultVisualNumericInput(session,(TransactionVO)transaction, "ITEM_TYPE_CNRKR_KINE_ASSESSMENT_REUMATOLOGY2_MUSCAMYOMEAS_"+m+"20_R", 3, sWebLanguage, sCONTEXTPATH) %>
			       				</center></td>
			       				<td class='admin2' width='12.5%'><center>
			  						<%=ScreenHelper.writeDefaultVisualNumericInput(session,(TransactionVO)transaction, "ITEM_TYPE_CNRKR_KINE_ASSESSMENT_REUMATOLOGY2_MUSCAMYOMEAS_"+m+"20_L", 3, sWebLanguage, sCONTEXTPATH) %>
			       				</center></td>
			       			</tr>
				   		</table>
				   	</td>
				...
				<tr>
       				...
       				<td class='admin2' style="padding:0px;">
       					<table width='100%' cellspacing='0' cellpadding='0'>
       						<tr>
			       				<td class='admin2' width='12.5%'><center>
			  						<%=ScreenHelper.writeDefaultVisualNumericInput(session,(TransactionVO)transaction, "ITEM_TYPE_CNRKR_KINE_ASSESSMENT_REUMATOLOGY2_MUSCAMYOMEAS_PERIHAND_R", 3, sWebLanguage, sCONTEXTPATH) %>
			       				</center></td>
			       				<td class='admin2' width='12.5%'><center>
			  						<%=ScreenHelper.writeDefaultVisualNumericInput(session,(TransactionVO)transaction, "ITEM_TYPE_CNRKR_KINE_ASSESSMENT_REUMATOLOGY2_MUSCAMYOMEAS_PERIHAND_L", 3, sWebLanguage, sCONTEXTPATH) %>
			       				</center></td>
				...
				<tr>
       				...
       				<td class='admin2' style="padding:0px;">
       					<table width='100%' cellspacing='0' cellpadding='0'>
       						<tr>
			       				<td class='admin2' width='12.5%'><center>
			  						<%=ScreenHelper.writeDefaultVisualNumericInput(session,(TransactionVO)transaction, "ITEM_TYPE_CNRKR_KINE_ASSESSMENT_REUMATOLOGY2_MUSCAMYOMEAS_PERIMALLEOLUM_R", 3, sWebLanguage, sCONTEXTPATH) %>
			       				</center></td>
			       				<td class='admin2' width='12.5%'><center>
			  						<%=ScreenHelper.writeDefaultVisualNumericInput(session,(TransactionVO)transaction, "ITEM_TYPE_CNRKR_KINE_ASSESSMENT_REUMATOLOGY2_MUSCAMYOMEAS_PERIMALLEOLUM_L", 3, sWebLanguage, sCONTEXTPATH) %>
			       				</center></td>
			       				<td class='admin2' width='*'/>
			       			</tr>
				   		</table>
				...
				<tr>
       				...
       				<td class='admin2' style="padding:0px;">
       					<table width='100%' cellspacing='0' cellpadding='0'>
       						<tr>
			       				<td class='admin2'>
				   					<%=ScreenHelper.writeDefaultTextArea(session,(TransactionVO)transaction, "ITEM_TYPE_CNRKR_KINE_ASSESSMENT_REUMATOLOGY2_MUSCAMYOMEAS_COMMENT", 60, 1) %>
								</td>
			       			</tr>
				   		</table>
				   	</td>
