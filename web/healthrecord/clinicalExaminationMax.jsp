...
<form name="transactionForm" id="transactionForm" method="POST" action='<c:url value="/healthrecord/updateTransaction.do"/>?ts=<%=getTs()%>'>
    ...
    <table border='0' width='100%' height='100%' cellspacing="1" cellpadding="0" class="list">
        ...
        <tr class="admin">
            <td colspan="2"><%=getTran(request,"Web.Occup","medwan.common.general",sWebLanguage)%></td>
        </tr>
        <tr>
            <td class="admin"><%=getTran(request,"Web.Occup","medwan.healthrecord.anamnese.general.style-de-vie",sWebLanguage)%></td>
        ...
        <tr>
            <td class="admin"><%=getTran(request,"Web.Occup","medwan.healthrecord.anamnese.general.medicaments",sWebLanguage)%></td>
            <td class="admin2">
        ...
        <tr>
            <td class="admin"><%=getTran(request,"Web.Occup","medwan.healthrecord.anamnese.general.tobacco-usage",sWebLanguage)%></td>
            <td class="admin2">
        ...
        <tr>
            <td class="admin"><%=getTran(request,"Web.Occup","medwan.healthrecord.anamnese.general.alcohol-usage",sWebLanguage)%></td>
            <td class="admin2">
                <select <%=setRightClick("[GENERAL.ANAMNESE]ITEM_TYPE_ALCOHOL_USAGE")%> id="EditAlcohol" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.[GENERAL.ANAMNESE]ITEM_TYPE_ALCOHOL_USAGE" property="itemId"/>]>.value" class="text">
                    <option/>
                    <option value="1">0 <%=getTran(request,"Web.Occup","ADay",sWebLanguage)%></option>
                    <option value="2">&lt; 1 <%=getTran(request,"Web.Occup","ADay",sWebLanguage)%></option>
                    <option value="3">1 <%=getTran(request,"Web.Occup","ADay",sWebLanguage)%></option>
                    <option value="4">1 - 2 <%=getTran(request,"Web.Occup","ADay",sWebLanguage)%></option>
                    <option value="5">1 - 3 <%=getTran(request,"Web.Occup","ADay",sWebLanguage)%></option>
                    <option value="6">3 - 6 <%=getTran(request,"Web.Occup","ADay",sWebLanguage)%></option>
                    <option value="8">&gt; 1 <%=getTran(request,"Web.Occup","ADay",sWebLanguage)%></option>
                    <option value="7">&gt; 6 <%=getTran(request,"Web.Occup","ADay",sWebLanguage)%></option>
                    <option value="9">&lt; 1 <%=getTran(request,"Web.Occup","AMonth",sWebLanguage)%></option>
                    <option value="10">&lt; 1 <%=getTran(request,"Web.Occup","AWeek",sWebLanguage)%></option>
                    <option value="11">&gt; 1 <%=getTran(request,"Web.Occup","AWeek",sWebLanguage)%></option>
                </select>
            </td>
        </tr>
        <tr>
            <td class="admin"><%=getTran(request,"Web.Occup","medwan.healthrecord.anamnese.general.cofee-usage",sWebLanguage)%></td>
        ...
        <tr>
            <td class="admin"><%=getTran(request,"Web.Occup","medwan.healthrecord.anamnese.general.etat-familial-et-social",sWebLanguage)%></td>
        ...
        <tr>
            <td class="admin"><%=getTran(request,"Web.Occup","medwan.healthrecord.anamnese.general.sports",sWebLanguage)%></td>
            <td class="admin2">
                ...
                &nbsp;&nbsp;<%=getTran(request,"Web.Occup","hoursAWeek",sWebLanguage)%>
        ...
        <tr>
            <td class="admin"><%=getTran(request,"Web.Occup","medwan.healthrecord.anamnese.general.work-conditions",sWebLanguage)%></td>
            <td class="admin2">
        ...
        <tr>
            <td class="admin"><%=getTran(request,"Web.Occup","medwan.healthrecord.anamnese.general.complaints",sWebLanguage)%></td>
            <td class="admin2">
