...
<%=checkPermission("occup.ccbrt.vvf6monthsurvey","select",activeUser)%>
    ...
    <table class="list" width="100%" cellspacing="1">
        ...
        <%-- INTRO --%>
       	...
       	<tr id="questionB12">
            ...
            <td class="admin2">
                <textarea onKeyup="resizeTextarea(this,10);limitChars(this,512);" <%=setRightClick("ITEM_TYPE_CCBRT_VVF6MONTHSURVEY_QUESTIONB12")%> class="text" cols='80' rows='2' name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_CCBRT_VVF6MONTHSURVEY_QUESTIONB12" property="itemId"/>]>.value"><mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_CCBRT_VVF6MONTHSURVEY_QUESTIONB12" property="value"/></textarea>
            </td>
        </tr>
       	<tr id="questionB13">
            <td class="admin2">&nbsp;<%=getTran(request,"ccbrt.vvf","questionB13",sWebLanguage)%>&nbsp;</td>
            <td class="admin2">
                <textarea onKeyup="resizeTextarea(this,10);limitChars(this,512);" <%=setRightClick("ITEM_TYPE_CCBRT_VVF6MONTHSURVEY_QUESTIONB13")%> class="text" cols='80' rows='2' name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_CCBRT_VVF6MONTHSURVEY_QUESTIONB13" property="itemId"/>]>.value"><mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_CCBRT_VVF6MONTHSURVEY_QUESTIONB13" property="value"/></textarea>
            </td>
        </tr>
       	<tr id="questionB14">
       	...
       	<tr id="questionB15">
            ...
            <td class="admin2">
                <textarea onKeyup="resizeTextarea(this,10);limitChars(this,512);" <%=setRightClick("ITEM_TYPE_CCBRT_VVF6MONTHSURVEY_QUESTIONB15")%> class="text" cols='80' rows='2' name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_CCBRT_VVF6MONTHSURVEY_QUESTIONB15" property="itemId"/>]>.value"><mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_CCBRT_VVF6MONTHSURVEY_QUESTIONB15" property="value"/></textarea>
            </td>
        </tr>
       	<tr id="questionB16">
       	...
       	<tr id="questionB18">
            ...
            <td class="admin2">
                <textarea onKeyup="resizeTextarea(this,10);limitChars(this,512);" <%=setRightClick("ITEM_TYPE_CCBRT_VVF6MONTHSURVEY_QUESTIONB18")%> class="text" cols='80' rows='2' name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_CCBRT_VVF6MONTHSURVEY_QUESTIONB18" property="itemId"/>]>.value"><mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_CCBRT_VVF6MONTHSURVEY_QUESTIONB18" property="value"/></textarea>
            </td>
        </tr>
       	<tr id="questionB19">
       	...
       	<tr>
            ...
            <td class="admin2">
                <textarea onKeyup="resizeTextarea(this,10);limitChars(this,512);" <%=setRightClick("ITEM_TYPE_CCBRT_VVF6MONTHSURVEY_QUESTION22")%> class="text" cols='80' rows='2' name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_CCBRT_VVF6MONTHSURVEY_QUESTION22" property="itemId"/>]>.value"><mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_CCBRT_VVF6MONTHSURVEY_QUESTION22" property="value"/></textarea>
            </td>
        </tr>
    </table>
