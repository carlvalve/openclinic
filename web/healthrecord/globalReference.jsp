...
<form name="transactionForm" id="transactionForm" method="POST" action='<c:url value="/healthrecord/updateTransaction.do"/>?ts=<%=getTs()%>'>
    ...
    <table class="list" width="100%" cellspacing="1">
        ...
        <tr>
	        ...
	        <%-- Reference Centre --%>
	        <%
	            ItemVO item = ((TransactionVO)transaction).getItem(sPREFIX+"ITEM_TYPE_REFERENCE_REF_CENTR");
	            String sCentre = "";
            ...
            <td class="admin2">
                <select class="text" <%=setRightClick(session,"ITEM_TYPE_REFERENCE_REF_CENTR")%> name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_REFERENCE_REF_CENTR" property="itemId"/>]>.value">
