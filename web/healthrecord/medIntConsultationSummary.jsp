        ...
        <td width="50%" style="vertical-align:top;">
            <table class="list" width="100%" height="100%" cellspacing="1">
                ...
                <tr>
                    ...
                    <td class="admin2" colspan="3">
                        <select <%=setRightClick(session,"ITEM_TYPE_CE_ANAMNESE_SPORT")%> id="EditSports" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_CE_ANAMNESE_SPORT" property="itemId"/>]>.value" class="text">
                            <option/>
                            <option value="1">0</option>
