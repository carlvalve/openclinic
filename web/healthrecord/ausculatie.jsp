...
<form name="transactionForm" id="transactionForm" method="POST" action='<c:url value="/healthrecord/updateTransaction.do"/>?ts=<%=getTs()%>'>
    ...
    <%
        ...
        if (request.getParameter("message")!=null){
            out.print("<script>alert('"+getTran(request,"Web.Occup","medwan.common.do-not-use-back",sWebLanguage)+"');</script>");
        }
    %>
    <br>
    <%-- CARDIAL ---------------------------------------------------------------------------------%>
    <table border='0' width='100%' cellspacing="1" cellpadding="0" class="list">
        <tr class="admin">
            <td colspan="4"><%=getTran(request,"Web.Occup","medwan.healthrecord.cardial",sWebLanguage)%></td>
        </tr>
        <tr>
        ...
        <tr>
            <td class="clinical" colspan="4"><%=getTran(request,"Web.Occup","medwan.healthrecord.clinical-examination",sWebLanguage)%></td>
        </tr>
        <tr>
            <td class="admin" width=""><%=getTran(request,"Web.Occup","medwan.healthrecord.cardial.auscultation",sWebLanguage)%></td>
        ...
        <%-- DIAGNOSE --%>
        <tr>
            <td class="clinical" colspan="4"><%=getTran(request,"Web.Occup","medwan.healthrecord.diagnose",sWebLanguage)%></td>
        </tr>
        <tr>
    ...
    <table border='0' width='100%' cellspacing="1" cellpadding="0" class="list">
        <tr class="admin">
            <td colspan="4"><%=getTran(request,"Web.Occup","medwan.healthrecord.anamnese.respiratoire",sWebLanguage)%></td>
        </tr>
        <tr>
            <td class="admin" width="<%=sTDAdminWidth%>" rowspan="2"/>
        ...
        <tr>
            <td class="admin" rowspan="2"><%=getTran(request,"Web.Occup","medwan.healthrecord.respiratory.auscultation",sWebLanguage)%></td>
