...
<%=checkPermission("msas.registry.postnatal","select",activeUser)%>
	        	...
	        	<table width='100%'>
			        ...
			        <tr>
			            ...
			            <td class='admin2'>
	                        ...
	                        <script>writeMyDate("bcg", "<c:url value="/_img/icons/icon_agenda.gif"/>", "<%=getTran(null,"Web","PutToday",sWebLanguage)%>");</script>
			            </td>
			            ...
			            <td class='admin2'>
	                        ...
	                        <script>writeMyDate("polio", "<c:url value="/_img/icons/icon_agenda.gif"/>", "<%=getTran(null,"Web","PutToday",sWebLanguage)%>");</script>
			            </td>
			        </tr>
			        <tr>
