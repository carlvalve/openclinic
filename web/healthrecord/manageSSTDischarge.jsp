...
<%=checkPermission("occup.sstdischarge","select",activeUser)%>
        ...
        <tr>
            <td style="vertical-align:top;" width="50%">
                <table width="100%" cellpadding="1" cellspacing="1">
				    ...
				    <tr>
				        <td class='admin2'>
				            <%=getTran(request,"web","comment",sWebLanguage)%>: <textarea onKeyup="resizeTextarea(this,10);" <%=setRightClick("ITEM_TYPE_SST_TREATMENTRESULTCOMMENT")%> class="text" cols="60" rows="2" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_SST_TREATMENTRESULTCOMMENT" property="itemId"/>]>.value"><mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_SST_TREATMENTRESULTCOMMENT" property="value"/></textarea>
				        </td>
				    </tr>
	                <tr class="admin">
