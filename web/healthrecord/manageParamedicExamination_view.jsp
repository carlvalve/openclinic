...
<script>
  ...
  function calculateBMI(){
    ...
    <table class="list" width="100%" cellspacing="1">
        ...
        <%-- URINE ---------------------------------------------------------------------------------------------------%>
        <tr class="admin">
            <td colspan="7"><%=getTran(request,"Web.Occup","be.mxs.common.model.vo.healthrecord.IConstants.TRANSACTION_TYPE_URINE_EXAMINATION",sWebLanguage)%></td>
        </tr>
        <tr>
            <%-- ALBUMINE --%>
            <td class='admin'><%=getTran(request,"Web.Occup","medwan.healthrecord.urine-exam.albumine",sWebLanguage)%>&nbsp;</td>
            <td class='admin2' width="16%">
                <select <%=setRightClick(session,"ITEM_TYPE_URINE_ALBUMINE")%> class="text" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_URINE_ALBUMINE" property="itemId"/>]>.value" class="text">
            ...
            <%-- GLUCOSE --%>
            <td class='admin' width="16%"><%=getTran(request,"Web.Occup","medwan.healthrecord.urine-exam.glucose",sWebLanguage)%>&nbsp;</td>
            <td class='admin2' width="16%">
                <select <%=setRightClick(session,"ITEM_TYPE_URINE_GLUCOSE")%> class="text" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_URINE_GLUCOSE" property="itemId"/>]>.value" class="text">
            ...
            <%-- BLOOD --%>
            <td class='admin' width="16%"><%=getTran(request,"Web.Occup","medwan.healthrecord.urine-exam.blood",sWebLanguage)%>&nbsp;</td>
            <td class='admin2' width="*">
                <select <%=setRightClick(session,"ITEM_TYPE_URINE_BLOOD")%> class="text" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_URINE_BLOOD" property="itemId"/>]>.value" class="text">
        ...
        <%-- BIOMETRY -------------------------------------------------------------------------------------------------%>
        <tr class="admin">
            <td colspan="6"><%=getTran(request,"Web.Occup","be.mxs.common.model.vo.healthrecord.IConstants.TRANSACTION_TYPE_BIOMETRY",sWebLanguage)%></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <%-- right --%>
            <td class='admin2'><%=getTran(request,"Web.Occup","medwan.healthrecord.cardial.bras-droit",sWebLanguage)%></td>
            <td class="admin2">
            ...
            <%-- left --%>
            <td class='admin2'><%=getTran(request,"Web.Occup","medwan.healthrecord.cardial.bras-gauche",sWebLanguage)%></td>
            <td class="admin2" colspan="2">
