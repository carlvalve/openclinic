...
<%=checkPermission("occup.gitegaoutpatientfile","select",activeUser)%>
         		...
         		<table width="100%" cellpadding="1" cellspacing="1">
			        <tr>
         			...
         			<tr height="40">
         				...
         				<td>
         					<table width='100%'>
         						<tr onclick='selectKeywords("functional.signs.ids","functional.signs.text","ikirezi2.functional.signs","keywords")'>
			         				<td class='admin2'>
         			...
         			<tr height="40">
         				...
         				<td>
         					<table width='100%'>
         						<tr onclick='selectKeywords("inspection.ids","inspection.text","ikirezi2.inspection","keywords")'>
			         				<td class='admin2'>
         			...
         			<tr height="40">
         				...
         				<td>
         					<table width='100%'>
         						<tr onclick='selectKeywords("palpation.ids","palpation.text","ikirezi2.palpation","keywords")'>
			         				<td class='admin2'>
         			...
         			<tr height="40">
         				...
         				<td>
         					<table width='100%'>
         						<tr onclick='selectKeywords("auscultation.ids","auscultation.text","ikirezi2.auscultation","keywords")'>
			         				<td class='admin2'>
