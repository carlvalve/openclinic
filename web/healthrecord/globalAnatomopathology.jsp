...
<form name="transactionForm" id="transactionForm" method="POST" action='<c:url value="/healthrecord/updateTransaction.do"/>?ts=<%=getTs()%>'>
    ...
    <table class="list" cellspacing="1" cellpadding="0" width="100%">
        ...
        <tr>
            <td class='admin'><%=getTran(request,"openclinic.chuk","identificationumber",sWebLanguage)%></td>
            <td class='admin2'>
        ...
        <%-- internal number --%>
        <tr>
            <td class='admin'><%=getTran(request,"openclinic.chuk","internalNumber",sWebLanguage)%></td>
            <td class='admin2'>
		...
		<tr>
            <td class="admin" width="<%=sTDAdminWidth%>">
                <%=getTran(request,"Web.Occup","specimen.reception.date",sWebLanguage)%>
            </td>
            <td class="admin2">
            	<table width='100%'>
            		<tr>
			            ...
			            <td class="admin" width="<%=sTDAdminWidth%>">
			                <%=getTran(request,"Web.Occup","reported.date",sWebLanguage)%>
			            </td>
            			<td class='admin2'>
        ...
        <tr>
            <td class="admin"><%=getTran(request,"web","anatomical.location",sWebLanguage)%>&nbsp;</td>
            <td class="admin2">
            	<table width='100%'>
            		<tr>
            		    <td class="admin2" width='1%' nowrap><%=getTran(request,"web","anatomical.location.site",sWebLanguage)%>&nbsp;</td>
            		    <td>
			            	<select id='location.site' name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_ANATOMOPATHOLOGY_LOCATION_SITE" property="itemId"/>]>.value" class="text" onchange="fillDetail('location.organ',this.value,'<%=tran.getItemValue("be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_ANATOMOPATHOLOGY_LOCATION_ORGAN")%>');">
				                <option/>
				                <%=ScreenHelper.writeSelect(request,"location.site", tran.getItemValue("be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_ANATOMOPATHOLOGY_LOCATION_SITE"), sWebLanguage)%>
				            </select>
            		    </td>
            		</tr>
            		<tr>
            		    <td class="admin2" width='1%' nowrap><%=getTran(request,"web","anatomical.location.organ",sWebLanguage)%>&nbsp;</td>
            		    <td>
				            ...
				            <option/>
				                <%=ScreenHelper.writeSelect(request,"location.site."+tran.getItemValue("be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_ANATOMOPATHOLOGY_LOCATION_SITE"), tran.getItemValue("be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_ANATOMOPATHOLOGY_LOCATION_ORGAN"), sWebLanguage,false,false)%>
				            </select>
            		    </td>
            		</tr>
            		<tr>
            		    <td class="admin2" width='1%' nowrap><%=getTran(request,"web","anatomical.location.detail",sWebLanguage)%>&nbsp;</td>
            		    <td>
							<input type="text" class="text" size="80" <%=setRightClick(session,"ITEM_TYPE_ANATOMOPATHOLOGY_LOCATION_DETAIL")%> name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_ANATOMOPATHOLOGY_LOCATION_DETAIL" property="itemId"/>]>.value" value="<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_ANATOMOPATHOLOGY_LOCATION_DETAIL" property="value"/>">
            		    </td>
            		</tr>
        ...
        <%-- procedure --%>
        <tr>
            <td class="admin"><%=getTran(request,"openclinic.chuk","procedure_type",sWebLanguage)%>&nbsp;</td>
            <td class="admin2">
        ...
        <tr>
            ...
            <td class="admin2">
                <textarea onKeyup="resizeTextarea(this,10);limitChars(this,2999);" <%=setRightClick(session,"ITEM_TYPE_ANATOMOPATHOLOGY_RESULT")%> class="text" cols="100" rows="2" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_ANATOMOPATHOLOGY_RESULT" property="itemId"/>]>.value"><mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_ANATOMOPATHOLOGY_RESULT" property="value"/></textarea>
            </td>
        </tr>

        <%-- canreg --%>
        <tr>
            <td class="admin"><%=getTran(request,"openclinic.chuk","canreg",sWebLanguage)%>&nbsp;</td>
            <td class="admin2">
				<input type="text" class="text" size="20" <%=setRightClick(session,"ITEM_TYPE_ANATOMOPATHOLOGY_CANREG")%> name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_ANATOMOPATHOLOGY_CANREG" property="itemId"/>]>.value" value="<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_ANATOMOPATHOLOGY_CANREG" property="value"/>">
            </td>
        </tr>
        ...
        <tr>
            ...
            <td class="admin2">
                <textarea onKeyup="resizeTextarea(this,10);limitChars(this,2999);" <%=setRightClick(session,"ITEM_TYPE_ANATOMOPATHOLOGY_DECLARED_VALID")%> class="text" cols="100" rows="2" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_ANATOMOPATHOLOGY_DECLARED_VALID" property="itemId"/>]>.value"><mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_ANATOMOPATHOLOGY_DECLARED_VALID" property="value"/></textarea>
            </td>
        </tr>
    </table>
