...
<form name="transactionForm" id="transactionForm" method="POST" action="<c:url value="/healthrecord/updateTransaction.do"/>?ts=<%=getTs()%>">
    ...
    <table width="100%" cellspacing="1" class="list">
        ...
        <%-- YEUX -------------------------------------------------------------------------------%>
        <tr class="gray">
            <td class="admin" style="vertical-align:top;padding-top:3px;"><%=getTran(request,"leprosy","yeux",sWebLanguage)%></td>
            <td>
                <table width="100%" cellspacing="1" class="list">
                    <%-- header --%>
                    <tr>
        ...
        <tr class="gray">
            <td class="admin" style="vertical-align:top;padding-top:3px;"><%=getTran(request,"leprosy","cotationdesinfirmites",sWebLanguage)%></td>
            <td>
                <table width="100%" cellspacing="1" class="list">
                    <%-- header --%>
                    <tr>
