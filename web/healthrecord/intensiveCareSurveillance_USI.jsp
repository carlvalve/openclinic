        ...
        if(usi_data_holders.size() > 0){
            ...
            out.print("<tr>" +
                       "<td width='200px' align='center' valign='middle'>" + getTran(request,"openclinic.chuk","usi_add_surveillance",sWebLanguage) +
                        " &nbsp;<img src='" + sCONTEXTPATH + "/_img/icons/icon_new.png' alt='" + getTranNoLink("web","new",sWebLanguage) + "' style='vertical-align:-3px;' onmouseout='this.style.cursor = \"default\";' onmouseover='this.style.cursor = \"pointer\";' onclick='addSurveillance();'>" +
                       "</td>"
                      );
            while(iterA.hasNext()){
                           ...
                           "<table cellpadding='0' cellspacing='0' style='border: 1px solid black;' width='100%' height='50'>" +
                            "<tr>" +
                             "<td align='center'>&nbsp;" + usiData.getDate() + "&nbsp;" + usiData.getTime()+"&nbsp;&nbsp;"+
                              "<img src='" + sCONTEXTPATH + "/_img/icons/icon_edit.png' style='vertical-align:-3px;' alt='" + getTranNoLink("web","edit",sWebLanguage) + "' onmouseout='this.style.cursor = \"default\";' onmouseover='this.style.cursor = \"pointer\";' onclick='editSurveillance(" + usiData.getDataSetNr() + ");'>&nbsp;&nbsp;"+
                              "<img src='" + sCONTEXTPATH + "/_img/icons/icon_delete.png' style='vertical-align:-3px;' alt='" + getTranNoLink("web","delete",sWebLanguage) + "' onmouseout='this.style.cursor = \"default\";' onmouseover='this.style.cursor = \"pointer\";' onclick='deleteSurveillance(" + usiData.getDataSetNr() + ");'>"+
                             "</td>" +
                            "</tr>" +
                            "<tr>" +
