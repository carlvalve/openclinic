			...
			<td style="vertical-align:top;padding:0;" class="admin2">    
			    <table class="list" width="100%" cellspacing="1">
			        ...
			        <tr>
			            ...
			            %>
			            <td class="admin"><%=getTran(request,"web.occup","socialAssistant",sWebLanguage)%>&nbsp;</td>
			            <td class="admin2">
			                ...
			                <img src="<c:url value="/_img/icons/icon_search.png"/>" class="link" alt="<%=getTranNoLink("Web","select",sWebLanguage)%>" onclick="searchManager('SocialAssistantId','currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_SOCIALASSISTANT_NAME" property="itemId"/>]>.value');">
