...
<%=checkPermission("cnrkr.consultation","select",activeUser)%>
        ...
        <tr>
            <td style="vertical-align:top" width="50%">                
                <table class="list" cellspacing="1" cellpadding="0" width="100%">
			        ...
			        <tr>
			            <td class="admin"><%=getTran(request,"web","newevents",sWebLanguage)%></td>
			            <td class="admin2">
			                <textarea onKeyup="resizeTextarea(this,10);limitChars(this,5000);" <%=setRightClick("ITEM_TYPE_CNRKR_NEWEVENTS")%> class="text" cols="80" rows="2" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_CNRKR_NEWEVENTS" property="itemId"/>]>.value"><mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_CNRKR_NEWEVENTS" property="value"/></textarea>
			            </td>
			        </tr>
			        <tr class="admin" style="padding:0px;">
			            <td colspan="2"><%=getTran(request,"cnrkr","technicalexaminations",sWebLanguage)%></td>
			        </tr>
			        <tr>
			            <td class="admin"><%=getTran(request,"cnrkr","technicalexaminations",sWebLanguage)%></td>
			            <td class="admin2">
			                <textarea onKeyup="resizeTextarea(this,10);limitChars(this,5000);" <%=setRightClick("ITEM_TYPE_CNRKR_EXAMS")%> class="text" cols="80" rows="2" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_CNRKR_EXAMS" property="itemId"/>]>.value"><mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_CNRKR_EXAMS" property="value"/></textarea>
			            </td>
			        </tr>
			        <tr class="admin" style="padding:0px;">
			            <td colspan="2"><%=getTran(request,"cnrkr","treatmentresult",sWebLanguage)%></td>
			        </tr>
			        <tr>
			            <td class="admin"><%=getTran(request,"cnrkr","treatmentresult",sWebLanguage)%></td>
			            <td class="admin2">
			                <textarea onKeyup="resizeTextarea(this,10);limitChars(this,5000);" <%=setRightClick("ITEM_TYPE_CNRKR_TREATMENTRESULT")%> class="text" cols="80" rows="2" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_CNRKR_TREATMENTRESULT" property="itemId"/>]>.value"><mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_CNRKR_TREATMENTRESULT" property="value"/></textarea>
			            </td>
			        </tr>
			        <tr class="admin" style="padding:0px;">
			            <td colspan="2"><%=getTran(request,"web","clinicalexamination",sWebLanguage)%></td>
			        </tr>
			        <tr>
			            <td class="admin"><%=getTran(request,"web","clinicalexamination",sWebLanguage)%></td>
			            <td class="admin2">
			                <textarea onKeyup="resizeTextarea(this,10);limitChars(this,5000);" <%=setRightClick("ITEM_TYPE_CNRKR_CLINICALEXAM")%> class="text" cols="80" rows="2" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_CNRKR_CLINICALEXAM" property="itemId"/>]>.value"><mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_CNRKR_CLINICALEXAM" property="value"/></textarea>
			            </td>
			        </tr>
			        <tr class="admin" style="padding:0px;">
			            <td colspan="2"><%=getTran(request,"web","therapy",sWebLanguage)%></td>
			        </tr>
			        <tr>
			            <td class="admin"><%=getTran(request,"web","therapy",sWebLanguage)%></td>
			            <td class="admin2">
			                <textarea onKeyup="resizeTextarea(this,10);limitChars(this,5000);" <%=setRightClick("ITEM_TYPE_CNRKR_THERAPY")%> class="text" cols="80" rows="2" name="currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_CNRKR_THERAPY" property="itemId"/>]>.value"><mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_CNRKR_THERAPY" property="value"/></textarea>
			            </td>
			        </tr>
    			</table>
    		</td>
