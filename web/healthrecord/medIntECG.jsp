                ...
                <table width="100%" border="0" cellspacing="1" cellpadding="0" id="ecg-details">
                    ...
                    <tr>
                        ...
                        <td class='admin2' colspan="4">
                            ...
                            ><%=getLabel("Web.Occup","medwan.common.normal",sWebLanguage,"r1")%>
