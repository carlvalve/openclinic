...
<%=checkPermission("msas.registry.abortion","select",activeUser)%>
	        	...
	        	<table width='100%'>
		        	...
		        	<tr>
			            ...
			            <td class='admin2'>
	                        ...
	                        <script>writeMyDate("departuredate", "<c:url value="/_img/icons/icon_agenda.gif"/>", "<%=getTran(null,"Web","PutToday",sWebLanguage)%>");</script>
