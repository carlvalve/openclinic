...
<%
    ...
    if(activeUser.getAccessRight("labos.openpatientlaboresults.select"))out.print(writeTblChild("main.do?Page=labos/manageLaboResultsEdit.jsp&type=patient&open=true&Action=find",getTran(request,"web","fastresultsedit",sWebLanguage)));
    out.print("<tr><td colspan='2'></td></tr>");
