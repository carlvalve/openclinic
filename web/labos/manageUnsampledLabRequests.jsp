    ...
    <table width="100%" cellspacing="1" cellpadding="1" class="menu">
        ...
        <tr>
            ...
            <td class="admin2">
                ...
                <input class="button" type="submit" name="findSamples" value="<%=getTranNoLink("web","find",sWebLanguage)%>"/>
            </td>
        </tr>
    </table>
...
%>
    ...
    <%
        ...
        for(int n=0; n<unsampledRequests.size(); n++){
            ...
            if(labRequest.getPersonid() > 0){
                out.print("<tr>");
                 out.print("<td>"+(labRequest.getRequestdate()!=null?ScreenHelper.formatDate(labRequest.getRequestdate(),ScreenHelper.fullDateFormat):"")+"<BR/><a href='javascript:showRequest("+labRequest.getServerid()+","+labRequest.getTransactionid()+")'><b>"+labRequest.getTransactionid()+"</b></a></td>");
                ...
                while(enumeration.hasMoreElements()){
                    ...
                    out.print("<tr>"+
                               "<td class='admin2' width='20%'><input type='checkbox' name='execute."+labRequest.getServerid()+"."+labRequest.getTransactionid()+"."+labSample.type+"'>"+MedwanQuery.getInstance().getLabel("labanalysis.monster",labSample.type,sWebLanguage)+"</td>"+
                               "<td class='admin2'>");
    ...
    <%
        if(labRequest!=null){
            %>
            <input class="button" type="submit" name="execute" value="<%=getTranNoLink("web","save",sWebLanguage)%>"/>
