...
//            sBeginDate+= "&nbsp;<input type='button' name='buttonNewAPC' class='button' onclick='newAPC()' value='"+getTran(request,"Web","new",sWebLanguage)+"'>";
        ...
        out.print(sBeginDate
              ...
              +inputRow(request,"Web","region","PSanitaryDistrict","AdminPrivate",apc.sanitarydistrict,"T",true,false,sWebLanguage)
              +inputRow(request,"Web","province","PProvince","AdminPrivate",apc.province,"T",true,false,sWebLanguage)
              +inputRow(request,"Web","district","PDistrict","AdminPrivate",apc.district,"T",true,false,sWebLanguage)
              +inputRow(request,"Web","community","PSector","AdminPrivate",apc.sector,"T",true,false,sWebLanguage)
              +inputRow(request,"Web","sector","PQuarter","AdminPrivate",apc.quarter,"T",true,false,sWebLanguage)
