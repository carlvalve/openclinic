...
function changeQuarter(){
    ...
    <%
        ...
        sBeginDate+=(" size='12' onblur='checkBegin(this,"+sStartDate.trim()+")'>&nbsp;"
            +"<img class='link' name='popcal' onclick='gfPop1.fPopCalendar(document.getElementsByName(\"PBegin\")[0]);return false;' src='"+sCONTEXTPATH+"/_img/icons/icon_agenda.gif' ALT='"+getTran(request,"Web","Select",sWebLanguage)+"'>"
            +"&nbsp;<img class='link' src='"+sCONTEXTPATH+"/_img/icons/icon_compose.gif' ALT='"+getTran(request,"Web","PutToday",sWebLanguage)+"' onclick='getToday(PBegin);'>");

        if (!bNew){
            sBeginDate+= " <img src='"+sCONTEXTPATH+"/_img/icons/icon_new.gif' id='buttonNewAPC' class='link' alt='"+getTran(request,"Web","new",sWebLanguage)+"' onclick='newAPC()'>";
//            sBeginDate+= "&nbsp;<input type='button' name='buttonNewAPC' class='button' onclick='newAPC()' value='"+getTran(request,"Web","new",sWebLanguage)+"'>";
        ...
        out.print(sBeginDate
              ...
              +inputRow("Web","region","PSanitaryDistrict","AdminPrivate",apc.sanitarydistrict,"T",true,false,sWebLanguage)
              ...
              +inputRow("Web","community","PSector","AdminPrivate",apc.sector,"T",true,false,sWebLanguage)
              +inputRow("Web","sector","PQuarter","AdminPrivate",apc.quarter,"T",true,false,sWebLanguage)
