...
//            sBeginDate+= "&nbsp;<input type='button' name='buttonNewAPC' class='button' onclick='newAPC()' value='"+getTran(request,"Web","new",sWebLanguage)+"'>";
        ...
        out.print(sBeginDate
              ...
              +"<tr><td class='admin'>"+getTran(request,"web","arrondissement",sWebLanguage)+"</td><td class='admin2'>"+sCities+"</td></tr>"
              +inputRow("Web","postcode","PZipcode","AdminPrivate",apc.zipcode,"T",false,false,sWebLanguage)
