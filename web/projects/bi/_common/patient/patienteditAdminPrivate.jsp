...
<script>
    ...
    <%
        ...
        sBeginDate+=(" size='12' onblur='checkBegin(this,"+sStartDate.trim()+")'>&nbsp;"
            +"<img class='link' name='popcal' onclick='gfPop1.fPopCalendar(document.all[\"PBegin\"]);return false;' src='"+sCONTEXTPATH+"/_img/icons/icon_agenda.gif' ALT='"+getTran(request,"Web","Select",sWebLanguage)+"'>"
