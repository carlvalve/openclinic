    ...
    <table class='list' border='0' width='100%' cellspacing='1'>
       ...
       <tr id="Service">
           ...
           <td class='admin2'>
               ...
               <img src="<c:url value="/_img/icon_search.gif"/>" class="link" alt="<%=getTran(null,"Web","select",sWebLanguage)%>" onclick="searchService('EditEncounterService','EditEncounterServiceName');">
               <img src="<c:url value="/_img/icon_delete.gif"/>" class="link" alt="<%=getTran(null,"Web","clear",sWebLanguage)%>" onclick="EditEncounterForm.EditEncounterService.value='';EditEncounterForm.EditEncounterServiceName.value='';">
           </td>
       </tr>
