            ...
            <table width="100%" class='list' cellspacing="0" border="0">
                <tr class="admin">
                    <td width="300">
                        ...
                        <a href="javascript:newEncounter();"><img src="<c:url value='/_img/icons/icon_new.gif'/>" class="link" alt="<%=getTran(null,"web","newencounter",sWebLanguage)%>" style="vertical-align:-4px;"></a>
        ...
        <td>
            <table width='100%' cellspacing='0' cellpadding="0" class='list'>
                ...
                <tr class='list' onmouseover="this.style.cursor='hand';"
                    ...
                    <td>
                        <img src="<c:url value='/_img/icon_edit.gif'/>" class="link" alt="<%=getTran(null,"web","edit",sWebLanguage)%>" onclick="goEdit('<%=activeEncounter.getUid()%>');">
