...
<script>
  ...
  function updateCategory(){
    if(isAtLeastOneCategoryFieldFilled()){
      ...
      row.cells[0].innerHTML = "<a href='#' onclick='deleteCategory("+editCategoryRowid.id+")'><img src='<%=sCONTEXTPATH%>/_img/icon_delete.gif' alt='<%=getTran(null,"web","delete",sWebLanguage)%>' border='0'></a> "+
                               "<a href='#' onclick='editCategory("+editCategoryRowid.id+")'><img src='<%=sCONTEXTPATH%>/_img/icon_edit.gif' alt='<%=getTran(null,"web","edit",sWebLanguage)%>' border='0'></a>";
