...
<%!
    private StringBuffer addCategory(int iTotal,String sCategoryName,String sPrice,String sWebLanguage){
        ...
        sTmp.append("<tr id='rowCategory"+iTotal+"'>")
             ...
             .append("<a href='javascript:deleteCategory(rowCategory"+iTotal+")'><img src='" + sCONTEXTPATH + "/_img/icon_delete.png' alt='" + getTran(null,"Web.Occup","medwan.common.delete",sWebLanguage) + "' border='0'></a> ")
             .append("</td>")
                ...
                <table width="100%" cellspacing="1" cellpadding="0" class="list">
		            ...
		            <tr>
		                ...
		                <td class="admin2">
		                    ...
		                    <img src="<c:url value="/_img/icon_search.png"/>" class="link" alt="<%=getTran(null,"Web","select",sWebLanguage)%>" onclick="searchCoveragePlan();">
		                    <img src="<c:url value="/_img/icon_delete.png"/>" class="link" alt="<%=getTran(null,"Web","clear",sWebLanguage)%>" onclick="EditInsuranceForm.EditCoveragePlanName.value='';EditInsuranceForm.EditCoveragePlan.value='';EditInsuranceForm.EditCoveragePlanCategoryLetter.value='';">
		                </td>
		            </tr>
		            <tr>
		                <td class="admin">
...
<script>
  ...
  function addCategory(){
    if(isAtLeastOneCategoryFieldFilled()){
      ...
      td.innerHTML = "<a href='javascript:deleteCategory(rowCategory"+iCategoryIndex+")'><img src='<%=sCONTEXTPATH%>/_img/icon_delete.png' alt='<%=getTran(null,"Web.Occup","medwan.common.delete",sWebLanguage)%>' border='0'></a>";
      tr.appendChild(td);
