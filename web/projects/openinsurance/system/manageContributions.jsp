            ...
            if (checkString(prestation.getCategories()).length()>0){
                ...
                for (int i=0;i<aCategories.length;i++){
                    ...
                    if (aCategory.length==2){
                        sCategoryHtml += addCategory(iCategoryTotal,getTran("insurance.types",aCategory[0],sWebLanguage),aCategory[1],sWebLanguage);
                        iCategoryTotal++;
                    }
                }
            }
            if(prestation.getCoveragePlan()!=null && prestation.getCoveragePlan().length()>0){
            	...
            	if(coveragePlan!=null){
            		...
            		if(sEditCoveragePlanType!=null && sEditCoveragePlanType.length()>0){
            			sEditCoveragePlanTypeName = getTran("insurance.types",sEditCoveragePlanType,sWebLanguage);
            		}
            ...
            %>
               <br>
                ...
                <table width="100%" cellspacing="1" cellpadding="0" class="list">
		            ...
		            <tr>
		                <td class="admin">
		                    <%=getTran("web","coverageplan",sWebLanguage)%>
		                </td>
		                <td class="admin2">
		                    ...
		                    <img src="<c:url value="/_img/icon_search.gif"/>" class="link" alt="<%=getTran("Web","select",sWebLanguage)%>" onclick="searchCoveragePlan();">
		                    <img src="<c:url value="/_img/icon_delete.gif"/>" class="link" alt="<%=getTran("Web","clear",sWebLanguage)%>" onclick="EditInsuranceForm.EditCoveragePlanName.value='';EditInsuranceForm.EditCoveragePlan.value='';EditInsuranceForm.EditCoveragePlanCategoryLetter.value='';">
		                </td>
		            </tr>
		            <tr>
		                <td class="admin">
			        ...
			        <tr>
			            ...
			            <td class="admin2">
			                ...
			                <input class="readonly" type="text" readonly name="EditCoveragePlanTypeName" value="<%=sEditCoveragePlanType!=null && sEditCoveragePlanType.length()>0?getTran("insurance.types",sEditCoveragePlanType,sWebLanguage):""%>" size="<%=sTextWidth%>" readonly/>
			            </td>
			        </tr>
                    ...
                    <tr>
                        <td class="admin"><%=getTran("web","companycriteria",sWebLanguage)%></td>
                        <td class="admin2">
                            <%=getTran("web","numberofworkersfrom",sWebLanguage)%>
                            ...
                            &nbsp;
                            <%=getTran("web","maxrisklevel",sWebLanguage)%>
                    ...
                    <tr>
                        <td class="admin"><%=getTran("system.manage","tariffcategories",sWebLanguage)%></td>
                        <td class="admin2">
                            <%
                            ...
                            <table id="tblCategories" width="100%" cellspacing="1" cellpadding="0" class="list">
                                ...
                                <tr class="admin">
                                    <td width="40"/>
                                    <td><%=getTran("system.manage","tariffcategories",sWebLanguage)%></td>
                                    <td><%=getTran("web","price",sWebLanguage)%></td>
                                    <td/>
                                </tr>
                                <tr>
