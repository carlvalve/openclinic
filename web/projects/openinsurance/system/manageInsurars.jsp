                    ...
                    <tr>
                        ...
                        <td class="admin2">
                            ...
                            <select class="text" name="EditInsurarLanguage">
                                <option><%=getTran(request,"web","choose",sWebLanguage)%></option>
                                <%
                                    String tmpLang;
                    ...
                    <tr>
                        ...
                        <td class="admin2">
                            <select class="text" name="EditInsurarType">
                                ...
                                <%=ScreenHelper.writeSelectExclude("insurance.types",checkString(insurar.getType()),sWebLanguage,false,true,"plan.openinsurance")%>
                            </select>
                        </td>
                    </tr>
