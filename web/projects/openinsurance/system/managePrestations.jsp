                ...
                <table width="100%" cellspacing="1" cellpadding="0" class="list">
                    ...
                    <tr>
                        ...
                        <td class="admin2">
                            ...
                            &nbsp;<%=getTran(request,"web","variable",sWebLanguage)%> <input type="checkbox" class="text" value="1" name="EditPrestationVariablePrice" id="EditPrestationVariablePrice" <%=prestation!=null && prestation.getVariablePrice()==1?"checked":"" %>/>
                        </td>
                    </tr>
                    <%
                    ...
                    %>
                    <tr>
                        <td class="admin"><%=getTran(request,"web","reimbursementpercentage",sWebLanguage)%></td>
                        <td class="admin2">
