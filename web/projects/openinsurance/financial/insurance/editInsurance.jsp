    ...
    <table class='list' border='0' width='100%' cellspacing='1'>
        <%-- company --%>
            <tr>
                ...
                <td class="admin2">
                    ...
                    <img src="<c:url value="/_img/icon_search.png"/>" class="link" alt="<%=getTran(null,"Web","select",sWebLanguage)%>" onclick="searchInsuranceCategory();">
                    <img src="<c:url value="/_img/icon_delete.png"/>" class="link" alt="<%=getTran(null,"Web","clear",sWebLanguage)%>" onclick="EditInsuranceForm.EditInsuranceInsurarName.value='';EditInsuranceForm.EditInsuranceCategory.value='';EditInsuranceForm.EditInsuranceCategoryLetter.value='';">
                </td>
            </tr>
            <tr>
                <td class="admin">
        ...
        <tr>
            ...
            <td class="admin2">
                ...
                <img id="img1" src="<c:url value="/_img/icon_search.png"/>" class="link" alt="<%=getTran(null,"Web","select",sWebLanguage)%>" onclick="searchAffiliate();">
                <img id="img2" src="<c:url value="/_img/icon_delete.png"/>" class="link" alt="<%=getTran(null,"Web","clear",sWebLanguage)%>" onclick="EditInsuranceForm.EditInsuranceMemberName.value='';EditInsuranceForm.EditInsuranceMember.value='';EditInsuranceForm.EditInsuranceMemberEmployer.value='';EditInsuranceForm.EditInsuranceMemberImmat.value='';">
            </td>
        </tr>
        <tr>
            <td class="admin" width="<%=sTDAdminWidth%>">
