    ...
    <table class="menu" width="100%">
        <tr>
            ...
            <td>
                ...
                <img src="<c:url value="/_img/icon_search.png"/>" class="link" alt="<%=getTran(null,"Web","select",sWebLanguage)%>" onclick="searchInsurarInvoice();">
                <img src="<c:url value="/_img/icon_delete.png"/>" class="link" alt="<%=getTran(null,"Web","clear",sWebLanguage)%>" onclick="doClearInsurarInvoice()">
...
<table class='list' border='0' width='100%' cellspacing='1'>
    <tr>
        ...
        <td class="admin2">
            ...
            %>
            <img src="<c:url value="/_img/icon_search.png"/>" class="link" alt="<%=getTran(null,"Web","select",sWebLanguage)%>" onclick="searchInsurar();">
            <img src="<c:url value="/_img/icon_delete.png"/>" class="link" alt="<%=getTran(null,"Web","clear",sWebLanguage)%>" onclick="doClearInsurar()">
            <%
                }
            %>
        </td>
