    ...
    <table class='list' border='0' width='100%' cellspacing='1'>
        ...
        <tr>
            ...
            <td class='admin2'>
                ...
                <img src="<c:url value="/_img/icon_search.png"/>" class="link" alt="<%=getTran(null,"Web","select",sWebLanguage)%>" onclick="searchPrestation();">
        ...
        <tr>
            ...
            <td class='admin2'>
                ...
                <img src="<c:url value="/_img/icon_search.png"/>" class="link" alt="<%=getTranNoLink("Web","select",sWebLanguage)%>" onclick="searchEncounter('EditEncounterUID','EditEncounterName');">
                <img src="<c:url value="/_img/icon_delete.png"/>" class="link" alt="<%=getTranNoLink("Web","clear",sWebLanguage)%>" onclick="EditForm.EditEncounterUID.value='';EditForm.EditEncounterName.value='';">
            </td>
        </tr>
        <tr>
            ...
            <td class='admin2'>
                ...
                <img src="<c:url value="/_img/icon_search.png"/>" class="link" alt="<%=getTran(null,"Web","select",sWebLanguage)%>" onclick="searchSupplier('EditSupplierUID','EditSupplierName');">
                <img src="<c:url value="/_img/icon_delete.png"/>" class="link" alt="<%=getTran(null,"Web","clear",sWebLanguage)%>" onclick="EditForm.EditSupplierUID.value='';EditForm.EditSupplierName.value='';">
            </td>
        </tr>
        <tr>
...
<script>
  ...
  function doSave(){
      if((EditForm.EditDate.value.length>0)
          ...
          &&(EditForm.EditPrestationUID.value.length>0 || EditForm.EditPrestationGroup.value.length>0 || document.getElementById('prestationcontent').innerHTML.trim().length>0)
