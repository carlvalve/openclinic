...
//              +inputRow("Web","district","PDistrict","AdminPrivate",apc.district,"T",true,false,sWebLanguage)
              +"<tr><td class='admin'>"+getTran(request,"web","state",sWebLanguage)+"</td><td class='admin2'>"+sDistricts+"</td></tr>"
//              +inputRow("Web","city","PCity","AdminPrivate",apc.city,"T",true, true,sWebLanguage)
              +"<tr><td class='admin'>"+getTran(request,"web","microregion",sWebLanguage)+"</td><td class='admin2'>"+sCities+"</td></tr>"
