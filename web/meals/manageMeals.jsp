...
<table class="list" width="100%" cellspacing="1" onKeyDown="if(enterEvent(event,13)){searchMeals();return false;}">
    ...
    <tr>
        ...
        <td class="admin2" style="padding-left:5px;">
            ...
            <img src="<%=sCONTEXTPATH%>/_img/icons/icon_delete.png" class="link" title="<%=HTMLEntities.htmlentities(getTranNoLink("web","clear",sWebLanguage))%>" onclick="FindMealName.value='';FindMealName.focus();">&nbsp;&nbsp;
