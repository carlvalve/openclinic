    ...
    <form name="manageMealsItemsTable" id="manageMealsItemsTable" method="post">
        ...
        <tr>
            ...
            <td class="admin2" style="padding-left:5px;">
                ...
                <img src="<%=sCONTEXTPATH%>/_img/icons/icon_delete.png" class="link" title="<%=HTMLEntities.htmlentities(getTranNoLink("web","clear",sWebLanguage))%>" onclick="clearSearchFields();">&nbsp;&nbsp;
