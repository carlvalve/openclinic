...
<%=checkPermission("gmao.synchronisation","select",activeUser)%>
<table width='100%'>
	<tr class='admin'>
	...
	<tr>
        ...
        <td class="admin2">
            ...
            <img src="<c:url value="/_img/icons/icon_delete.gif"/>" class="link" alt="<%=getTran(null,"Web","delete",sWebLanguage)%>" onclick="document.getElementById('serviceuid').value='';document.getElementById('servicename').value='';">
