		        ...
		        <tr>     
		            <td class="admin"><%=getTran(request,"web","service",sWebLanguage)%>&nbsp;</td>
		           	<td class="admin2">
		                ...
		                <img src="<c:url value="/_img/icons/icon_delete.gif"/>" class="link" alt="<%=getTranNoLink("Web","clear",sWebLanguage)%>" onclick="SearchForm.serviceuid.value='';SearchForm.servicename.value='';">
					</td>
		            <td class="admin"/>
		            <td class="admin2">
		    ...
		    <table class="list" border="0" width="100%" cellspacing="1">
		        ...
		        <tr>
		            ...
		            <td class="admin2" colspan="3">
		                ...
		                <%-- buttons --%>
		                <img src="<c:url value="/_img/icons/icon_search.gif"/>" class="link" alt="<%=getTranNoLink("web","select",sWebLanguage)%>" onclick="selectSupplier('comment4','searchSupplierName');">
		                <img src="<c:url value="/_img/icons/icon_delete.gif"/>" class="link" alt="<%=getTranNoLink("web","clear",sWebLanguage)%>" onclick="EditForm.comment4.value='';EditForm.searchSupplierName.value='';">
	                 -->
		            </td>
		        </tr>  
