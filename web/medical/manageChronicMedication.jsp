    ...
    private StringBuffer objectsToHtml(Vector objects, String sWebLanguage){
        ...
        for(int i=0; i<objects.size(); i++){
            ...
            html.append("<tr class='list"+sClass+"' onmouseover=\"this.style.cursor='hand';\" onmouseout=\"this.style.cursor='default';\" title='"+detailsTran+"'>")
                 .append("<td align='center'><img src='"+sCONTEXTPATH+"/_img/icons/icon_delete.png' class='link' alt='"+deleteTran+"' onclick=\"doDelete('"+sMedicationUid+"');\">")
    ...
    if(sAction.equals("save") && sEditMedicationUid.length()>0){
        ...
        if(sEditMedicationUid.equals("-1")){
            ...
            //***** reject new addition *****
                ...
                msg = "<font color='red'>"+getTran(request,"web.manage","chronicmedicationexists",sWebLanguage)+"</font>";
            }
        }
        else{
            ...
            if(medication!=null){
                ...
                if(product!=null){
                    ...
                    if(sSelectedProductName.length()==0){
                        sSelectedProductName = getTran(request,"web","nonexistingproduct",sWebLanguage);
                    }
                }
            }
        }
                ...
                <table class="list" width="100%" cellspacing="1">
                    ...
                    <tr>
                        ...
                        <td class="admin2">
                            ...
                            <img name="popcal" class="link" src="<%=sCONTEXTPATH%>/_img/icons/icon_agenda.png" alt="<%=getTranNoLink("Web","Select",sWebLanguage)%>" onclick="gfPop1.fPopCalendar(document.transactionForm.all['EditDateBegin']);return false;">
                            <img class="link" src="<%=sCONTEXTPATH%>/_img/icons/icon_compose.png" alt="<%=getTranNoLink("Web","PutToday",sWebLanguage)%>" onclick="getToday(document.transactionForm.all['EditDateBegin']);">
                        </td>
                    </tr>
                    <%-- prescriber --%>
                    <tr>
                        <td class="admin" nowrap><%=getTran(request,"Web","prescriber",sWebLanguage)%></td>
                        <td class="admin2">
                    ...
                    <%-- comment --%>
                    <tr>
                        <td class="admin" nowrap><%=getTran(request,"Web","comment",sWebLanguage)%></td>
                        <td class="admin2">
                ...
                %>
                    <table width="100%" cellspacing="0" cellpadding="0" class="sortable" id="searchresults">
                        ...
                        <tr>
                            ...
                            <td class="admin" width="25%"><%=getTran(request,"Web","prescriber",sWebLanguage)%></td>
                            <td class="admin" width="20%"><%=getTran(request,"Web","productName",sWebLanguage)%></td>
                            <td class="admin" width="10%"><%=getTran(request,"Web","begindate",sWebLanguage)%></td>
                            <td class="admin" width="45%"><%=getTran(request,"Web","prescriptionrule",sWebLanguage)%></td>
                        </tr>
                    ...
                    <span style="width:49%;text-align:left;">
                        <%=foundMedicationCount%> <%=getTran(request,"web","recordsfound",sWebLanguage)%>
                    </span>
