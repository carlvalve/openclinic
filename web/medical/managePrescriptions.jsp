        ...
        for(int i=0; i<objects.size(); i++){
            ...
            */
            ...
            html.append("<tr class='list"+sClass+"' title='"+detailsTran+"'>")
                 .append("<td>"+(((prescr==null || (prescr!=null && prescr.getDeliveredQuantity()==0)) ||(activeUser.getAccessRight("sa"))) && (activeUser.getAccessRight("prescriptions.drugs.delete"))?"<img src='"+sCONTEXTPATH+"/_img/icons/icon_delete.png' border='0' title='"+deleteTran+"' onclick=\"doDelete('"+prescr.getUid()+"');\">":"")+"</td>")
    ...
    private StringBuffer activePrescriptionsToHtml(Vector objects, String sWebLanguage,User activeUser){
        ...
        for(int i = 0; i < objects.size(); i++){
            ...
            html.append("<tr class='list"+sClass+"' onmouseover=\"this.style.cursor='pointer';\" onmouseout=\"this.style.cursor='default';\" title='"+detailsTran+"'>")
                 .append("<td align='center'>"+((prescr==null || (prescr!=null && prescr.getDeliveredQuantity()==0)) && (activeUser.getAccessRight("prescriptions.drugs.delete"))?"<img src='"+sCONTEXTPATH+"/_img/icons/icon_delete.png' border='0' title='"+deleteTran+"' onclick=\"doDelete('"+prescr.getUid()+"');\">":"")+"</td>")
                    ...
                    <table width="100%" class="list" cellspacing="1" onClick="transactionForm.onkeydown='if(enterEvent(event,13)){doSearch();}';" onKeyDown="if(enterEvent(event,13)){doSearch();}">
                        ...
                        <tr>
                            ...
                            <td class="admin2">
                                ...
                                <img src="<c:url value='/_img/icons/icon_search.png'/>" class="link" alt="<%=getTranNoLink("Web","select",sWebLanguage)%>" onclick="searchPrescriber('FindPrescriberUid','FindPrescriberFullName');">
                                <img src="<c:url value='/_img/icons/icon_delete.png'/>" class="link" alt="<%=getTranNoLink("Web","clear",sWebLanguage)%>" onclick="transactionForm.FindPrescriberUid.value='';transactionForm.FindPrescriberFullName.value='';">
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="admin2">
                                ...
                                <img src="<c:url value='/_img/icons/icon_search.png'/>" class="link" alt="<%=getTranNoLink("Web","select",sWebLanguage)%>" onclick="searchSupplyingService('FindSupplyingServiceUid','FindSupplyingServiceName');">
                                <img src="<c:url value='/_img/icons/icon_delete.png'/>" class="link" alt="<%=getTranNoLink("Web","clear",sWebLanguage)%>" onclick="transactionForm.FindSupplyingServiceUid.value='';transactionForm.FindSupplyingServiceName.value='';">
                            </td>
                        </tr>
                    ...
                    <table class="list" width="100%" cellspacing="1">
                        ...
                        <tr>
                            ...
                            <td class="admin2">
                                ...
                                <img src="<c:url value="/_img/icons/icon_search.png"/>" class="link" alt="<%=getTranNoLink("Web","select",sWebLanguage)%>" <%=onClick%>>
                        ...
                        <tr>
                            ...
                            <td class="admin2">
                                ...
                                <img class="link" name="popcal" src="<%=sCONTEXTPATH%>/_img/icons/icon_agenda.png" alt="<%=getTranNoLink("Web","Select",sWebLanguage)%>" onclick="gfPop1.fPopCalendar(document.transactionForm.all['EditDateBegin']);return false;">
                                <img class="link" src="<%=sCONTEXTPATH%>/_img/icons/icon_compose.png" alt="<%=getTranNoLink("Web","PutToday",sWebLanguage)%>" onclick="getToday(document.transactionForm.all['EditDateBegin']);calculatePackagesNeeded(false);">
                            </td>
                        </tr>
                        <%-- date end --%>
                        <tr>
                            ...
                            <td class="admin2">
                                ...
                                <img class="link" name="popcal" src="<%=sCONTEXTPATH%>/_img/icons/icon_agenda.png" alt="<%=getTranNoLink("Web","Select",sWebLanguage)%>" onclick="gfPop1.fPopCalendar(document.transactionForm.all['EditDateEnd']);return false;">
                                <img class="link" src="<%=sCONTEXTPATH%>/_img/icons/icon_compose.png" alt="<%=getTranNoLink("Web","PutToday",sWebLanguage)%>" onclick="getToday(document.transactionForm.all['EditDateEnd']);calculatePackagesNeeded(false);">
                            </td>
                        </tr>
                            ...
                            <td class="admin2">
                                <table>
                                    <tr>
                                        ...
                                        <td><a href="javascript:loadSchema();"><img class="link" src="<c:url value="/_img/icons/icon_search.png"/>" alt="Search schema"/></a></td>
                                    </tr>
                                    <tr>
