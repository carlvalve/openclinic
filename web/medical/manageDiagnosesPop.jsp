    ...
    <table class="list" width="100%" cellspacing="1">
        ...
        <tr>
            ...
            <td class="admin2">
                ...
                <img src="<c:url value="/_img/icons/icon_search.png"/>" class="link" alt="<%=getTranNoLink("Web","select",sWebLanguage)%>" onclick="searchICPC('EditDiagnosisForm.EditDiagnosisCode','EditDiagnosisForm.EditDiagnosisCodeLabel','EditDiagnosisForm.EditDiagnosisCodeType');">
