            ...
            <table class="list" width="100%" cellspacing="1">
                ...
                <tr>
                    ...
                    <td class="admin2">
                        ...
                        <img src="<c:url value="/_img/icons/icon_delete.png"/>" class="link" alt="<%=getTranNoLink("Web","clear",sWebLanguage)%>" onclick="clearDescriptionRule();">
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="admin2">
                        ...
                        <img class="link" src="<%=sCONTEXTPATH%>/_img/icons/icon_compose.png" alt="<%=getTranNoLink("Web","PutToday",sWebLanguage)%>" onclick="getToday(document.getElementById('EditDateBegin'));">
                ...
                <tr>
                    ...
                    <td class="admin2">
                        ...
                        <img class="link" src="<%=sCONTEXTPATH%>/_img/icons/icon_compose.png" alt="<%=getTranNoLink("Web","PutToday",sWebLanguage)%>" onclick="getToday(document.getElementById('EditDateEnd'));">
