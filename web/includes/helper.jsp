...
<%!
    ...
    public String checkString(String sString, String defaultValue){
    ...
    //-- SET RIGHTCLICK ---------------------------------------------------------------------------
    public String setRightClick(HttpSession session,String itemType){
        return ScreenHelper.setRightClick(session,itemType);
    }
    ...
    //--- SET RIGHTCLICK MINI ---------------------------------------------------------------------
    public String setRightClickMini(HttpSession session,String itemType){
        return ScreenHelper.setRightClickMini(session,itemType);
    }
    ...
    public String setRow(HttpServletRequest request,String sType, String sID, String sValue, String sLanguage){
        return ScreenHelper.setRow(request,sType,sID,sValue,sLanguage);
    }
...
<%
    ...
    if(sUserTheme.length()==0) sUserTheme = "default";
