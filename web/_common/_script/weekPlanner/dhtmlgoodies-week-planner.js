...
function updateAppointmentProperties(id)
{
    ...
    if(dateFormat=="dd/MM/yyyy"){
      // EU
      saveString+= '&appointmentDateDay='+dateStart.getDate()+"/"+(Number(dateStart.getMonth()+1))+"/"+dateStart.getFullYear()
      ...
      // US
      saveString+= '&appointmentDateDay='+(Number(dateStart.getMonth()+1))+"/"+dateStart.getDate()+"/"+dateStart.getFullYear()
        +'&appointmentDateHour='+dateStart.getHours()
        +'&appointmentDateMinutes='+dateStart.getMinutes()
        +'&appointmentDateEndDay='+(Number(dateEnd.getMonth()+1))+"/"+dateEnd.getDate()+"/"+dateEnd.getFullYear()
        +'&appointmentDateEndHour='+dateEnd.getHours()
        +'&appointmentDateEndMinutes='+dateEnd.getMinutes();
    }
...
function displayPreviousWeek(){
    ...
    if(dateFormat=="dd/MM/yyyy"){
      ...
      return (dateStartOfWeek.getMonth()+1)+"/"+dateStartOfWeek.getDate()+"/"+y2k(dateStartOfWeek.getFullYear());
    }
}
