				...
				<div class="topicones">
				    <%
		                ...
		                if(sTmpPersonid.length() > 0){
		                    ...
		                    if(!bFingerPrint){
		                        %> <a class="imglink" href="javascript:enrollFingerPrint();"><img border='0' height='22px' src="<c:url value='/_img/icons/mobile/fingerprint.png'/>" alt="<%=getTranNoLink("web","enrollFingerPrint",sWebLanguage)%>"/></a><%
		                    }
		                    if(!bBarcode){
		                        %> <a class="imglink" href="javascript:printPatientCard();"><img border='0' height='22px' src="<c:url value='/_img/icons/mobile/badge.png'/>" alt="<%=getTranNoLink("web","printPatientCard",sWebLanguage)%>"/></a><%
		                    }
		                    if(!bPicture){
		                        %> <a class="imglink" href="javascript:storePicture();"><img border='0' height='22px' src="<c:url value='/_img/icons/mobile/camera.png'/>" alt="<%=getTranNoLink("web","loadPicture",sWebLanguage)%>"/></a><%
		                    }
		                }
		            %>
				</div>
