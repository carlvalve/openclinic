...
<%
    String sReturnField           = checkString(request.getParameter("returnField")),
	       sShowPatientEncounters = checkString(request.getParameter("showpatientencounters"));
	...
	String sCode  = checkString(request.getParameter("Code")),
           ...
           flags  = Diagnosis.getFlags(sType,sCode,"");
    ...
    /// DEBUG /////////////////////////////////////////////////////////////////////////////////////
    if(Debug.enabled){
    	Debug.println("\n***************** _common/search/diagnosisInfoDSM4.jsp ****************");
    	Debug.println("sReturnField : "+sReturnField);
    	Debug.println("sShowPatientEncounters : "+sShowPatientEncounters);
    	Debug.println("sCode  : "+sCode);
    	Debug.println("sValue : "+sValue);
        ...
        <tr>
            ...
            <td class="admin2">
            	<table width="100%">
            		<tr>
		            	<%
		            		String checked = "checked", altInfo = "<table></table>";
		            	%>
