...
<%
	...
	if(fingerprintimage.length()>0){
		System.out.println("fingerprintimage = "+fingerprintimage.length());
		System.out.println("fingerprintjpg = "+fingerprintjpg.getData().getDataBuffer().getSize());
		...
		conn.close();
		nSuccess=1;
		javax.imageio.ImageIO.write( fingerprintjpg, "jpg", new java.io.File("c:/temp/nfp.jpg") );
	}
%>
{
	"success":"<%=nSuccess%>",
