...
<%
    ...
    if (activePatient != null && request.getParameter("SavePatientEditForm") != null) {
        ...
        String sName = checkString(request.getParameter("Lastname")),
		       ...
		       sBiologicGender=checkString(request.getParameter("biologicgender"));
       ...
       if(reasons!=null){
        ...
        if (bReturn) {
            ...
            if (sBiologicGender.trim().length() > 0) {
                activePatient.adminextends.put("biologicgender", sBiologicGender);
            }
