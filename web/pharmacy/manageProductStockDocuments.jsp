				...
				<table width="100%" class="list" cellpadding="1" cellspacing="1">
					...
					<tr>
						...
						<td class="admin2">
			                ...
			                <img src='/openclinic/_img/icons/icon_search.png' id='buttonUnit' class='link' alt='Choisir' onclick='findsearchsource("finddocumentsource","finddocumentsourcetext");'>&nbsp;<img src='/openclinic/_img/icons/icon_delete.png' class='link' alt='Vider' onclick="document.getElementsByName('finddocumentsource')[0].value='';document.getElementsByName('finddocumentsourcetext')[0].value='';">
        ...
        <table class="list" width="100%" cellpadding="0" cellspacing="1">
			<%
				...
				for(int n=0; n<operations.size(); n++){
					...
					out.print("<tr>"+
					           "<td><img src='"+sCONTEXTPATH+"/_img/icons/icon_delete.png' class='link' onclick='javascript:deleteOperation(\""+operation.getUid()+"\");' title='"+getTranNoLink("web","delete",sWebLanguage)+"'>"+operation.getUid()+"</td>"+
