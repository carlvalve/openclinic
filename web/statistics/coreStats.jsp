...
<%
	...
	//>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
	out.println("<tr class='admin'><td colspan='2'>"+getTran("web","encounters",sWebLanguage)+"</td></tr>");
	...
	//>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
	out.println("<tr class='admin'><td colspan='2'>"+getTran("web","informationsharing",sWebLanguage)+"</td></tr>");
	...
	rs = ps.executeQuery();
	if(rs.next()){
		out.println("<tr><td class='admin'>"+getTran("web","userdensity",sWebLanguage)+ " - "+getTran("web","visits",sWebLanguage)+"</td><td class='admin2'>"+new DecimalFormat("#.00").format(rs.getDouble("total"))+"</td></tr>");
	}
	rs.close();
	ps.close();
	...
	rs = ps.executeQuery();
	if(rs.next()){
		out.println("<tr><td class='admin'>"+getTran("web","userdensity",sWebLanguage)+ " - "+getTran("web","admissions",sWebLanguage)+"</td><td class='admin2'>"+new DecimalFormat("#.00").format(rs.getDouble("total"))+"</td></tr>");
	}
	rs.close();
	ps.close();
	...
	if(rs.next()){
		...
		out.println("<tr><td class='admin'>"+getTran("web","paidpatients",sWebLanguage)+ " - "+getTran("web","visits",sWebLanguage)+"</td><td class='admin2'>"+new DecimalFormat("###,##0.00").format(paidvisits)+" "+MedwanQuery.getInstance().getConfigString("currency")+"</td></tr>");
	}
	rs.close();
	ps.close();
	...
	if(rs.next()){
		...
		out.println("<tr><td class='admin'>"+getTran("web","paidpatients",sWebLanguage)+ " - "+getTran("web","admissions",sWebLanguage)+"</td><td class='admin2'>"+new DecimalFormat("###,##0.00").format(paidadmissions)+" "+MedwanQuery.getInstance().getConfigString("currency")+"</td></tr>");
	}
	rs.close();
	ps.close();
	...
	rs = ps.executeQuery();
	if(rs.next()){
		out.println("<tr><td class='admin'>"+getTran("web","transactiondensity",sWebLanguage)+ " - "+getTran("web","visits",sWebLanguage)+"</td><td class='admin2'>"+new DecimalFormat("#0.00").format(rs.getDouble("total")/totalvisits)+"</td></tr>");
	}
	rs.close();
	ps.close();
	...
	rs = ps.executeQuery();
	if(rs.next()){
		out.println("<tr><td class='admin'>"+getTran("web","transactiondensity",sWebLanguage)+ " - "+getTran("web","admissions",sWebLanguage)+"</td><td class='admin2'>"+new DecimalFormat("#0.00").format(rs.getDouble("total")/totaladmissions)+"</td></tr>");
	}
	rs.close();
	ps.close();
	...
	rs = ps.executeQuery();
	if(rs.next()){
		out.println("<tr><td class='admin'>"+getTran("web","itemdensity",sWebLanguage)+ " - "+getTran("web","visits",sWebLanguage)+"</td><td class='admin2'>"+new DecimalFormat("#0.00").format(rs.getDouble("total")/totalvisits)+"</td></tr>");
	}
	rs.close();
	ps.close();
	...
	rs = ps.executeQuery();
	if(rs.next()){
		out.println("<tr><td class='admin'>"+getTran("web","itemdensity",sWebLanguage)+ " - "+getTran("web","admissions",sWebLanguage)+"</td><td class='admin2'>"+new DecimalFormat("#0.00").format(rs.getDouble("total")/totaladmissions)+"</td></tr>");
	}
	rs.close();
	ps.close();
	...
	rs = ps.executeQuery();
	if(rs.next()){
		out.println("<tr><td class='admin'>"+getTran("web","rfedensity",sWebLanguage)+ " - "+getTran("web","visits",sWebLanguage)+"</td><td class='admin2'>"+new DecimalFormat("#0.00").format(rs.getDouble("total")/totalvisits)+"</td></tr>");
	}
	rs.close();
	ps.close();
	...
	rs = ps.executeQuery();
	if(rs.next()){
		out.println("<tr><td class='admin'>"+getTran("web","rfedensity",sWebLanguage)+ " - "+getTran("web","admissions",sWebLanguage)+"</td><td class='admin2'>"+new DecimalFormat("#0.00").format(rs.getDouble("total")/totaladmissions)+"</td></tr>");
	}
	rs.close();
	ps.close();
	...
	rs = ps.executeQuery();
	if(rs.next()){
		out.println("<tr><td class='admin'>"+getTran("web","diagnosisdensity",sWebLanguage)+ " - "+getTran("web","visits",sWebLanguage)+"</td><td class='admin2'>"+new DecimalFormat("#0.00").format(rs.getDouble("total")/totalvisits)+"</td></tr>");
	}
	rs.close();
	ps.close();
	...
	rs = ps.executeQuery();
	if(rs.next()){
		out.println("<tr><td class='admin'>"+getTran("web","diagnosisdensity",sWebLanguage)+ " - "+getTran("web","admissions",sWebLanguage)+"</td><td class='admin2'>"+new DecimalFormat("#0.00").format(rs.getDouble("total")/totaladmissions)+"</td></tr>");
	}
	rs.close();
	ps.close();
	...
	rs = ps.executeQuery();
	if(rs.next()){
		out.println("<tr><td class='admin'>"+getTran("web","laborderdensity",sWebLanguage)+ " - "+getTran("web","visits",sWebLanguage)+"</td><td class='admin2'>"+new DecimalFormat("###,##0.00").format(rs.getDouble("total")/totalvisits)+"</td></tr>");
	}
	rs.close();
	ps.close();
	...
	rs = ps.executeQuery();
	if(rs.next()){
		out.println("<tr><td class='admin'>"+getTran("web","laborderdensity",sWebLanguage)+ " - "+getTran("web","admissions",sWebLanguage)+"</td><td class='admin2'>"+new DecimalFormat("#0.00").format(rs.getDouble("total")/totaladmissions)+"</td></tr>");
	}
	rs.close();
	ps.close();
	...
	rs = ps.executeQuery();
	if(rs.next()){
		out.println("<tr><td class='admin'>"+getTran("web","analysesperlaborder",sWebLanguage)+"</td><td class='admin2'>"+new DecimalFormat("#0.00").format(rs.getDouble("total"))+"</td></tr>");
	}
	rs.close();
	ps.close();
