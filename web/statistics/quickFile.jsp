...
<table width="100%" class="list" border="0" cellpadding="0" cellspacing="1">
    ...
    <tr id="Service">
        ...
        <td class='admin2'>
            ...
            <img src="<c:url value="/_img/icons/icon_delete.gif"/>" class="link" alt="<%=getTranNoLink("Web","clear",sWebLanguage)%>" onclick="EditPatientForm.EditEncounterService.value='';EditPatientForm.EditEncounterServiceName.value='';">
        </td>
    </tr>
