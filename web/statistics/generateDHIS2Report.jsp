...
<script>
	function showRecords(dataset,dataelement,option,attributeoption,datasettitle){
		var URL="/statistics/showDHIS2Records.jsp&datasettitle="+datasettitle+"&dataset="+dataset+"&dataelement="+dataelement+"&option="+option+"&attributeoption="+attributeoption+"&period=<%=request.getParameter("period")%>";
