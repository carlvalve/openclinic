...
%>
	<table width="100%">
		<tr class='admin'><td colspan='3'><%=getTran(request,"cnar","statistics.etiology.title1",sWebLanguage)%></td></tr>
		<tr class='admin'>
			<td rowspan='2'><%=getTran(request,"cnar","statistics.etiology.etiology",sWebLanguage)%></td>
...
%>
	<br/><hr/><br/>
	<table width="100%">
		<tr class='admin'><td colspan='6'><%=getTran(request,"cnar","statistics.etiology.title2",sWebLanguage)%></td></tr>
		<tr class='admin'>
			<td rowspan='2'><%=getTran(request,"cnar","statistics.etiology.etiology",sWebLanguage)%></td>
...
<%
	...
	<br/><hr/><br/>
	<table width="100%">
		<tr class='admin'><td colspan='8'><%=getTran(request,"cnar","statistics.etiology.title3",sWebLanguage)%></td></tr>
		<tr class='admin'>
			<td rowspan='2'><%=getTran(request,"cnar","statistics.etiology.etiology",sWebLanguage)%></td>
