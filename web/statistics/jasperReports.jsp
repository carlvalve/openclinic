					...
					while(iFields.hasNext()){
						...
						if(field.getName().equalsIgnoreCase("field")){
							...
							if(field.elementText("type").equalsIgnoreCase("text")){
			                    ...
			                    out.println("<img src='"+sCONTEXTPATH+"/_img/icons/icon_search.gif' class='link' alt='"+getTranNoLink("Web","select",sWebLanguage)+"' onclick='searchService(\"fieldname_"+field.elementText("name")+"\",\"servicename_"+field.elementText("name")+"\");'>&nbsp;");
			                    out.println("<img src='"+sCONTEXTPATH+"/_img/icons/icon_delete.gif' class='link' alt='"+getTranNoLink("Web","clear",sWebLanguage)+"' onclick='fieldname_"+field.elementText("name")+".value=\"\";servicename_"+field.elementText("name")+".value=\"\";'></td>");
							}
			                    ...
			                    out.println("<img src='"+sCONTEXTPATH+"/_img/icons/icon_search.gif' class='link' alt='"+getTranNoLink("Web","select",sWebLanguage)+"' onclick='searchPatient(\"fieldname_"+field.elementText("name")+"\",\"patientname_"+field.elementText("name")+"\");'>&nbsp;");
			                    out.println("<img src='"+sCONTEXTPATH+"/_img/icons/icon_delete.gif' class='link' alt='"+getTranNoLink("Web","clear",sWebLanguage)+"' onclick='fieldname_"+field.elementText("name")+".value=\"\";patientname_"+field.elementText("name")+".value=\"\";'></td>");
							}
							out.println("</tr>");
						}
					}
...
<script>
	...
	function executeReport(){
		var parameters="reportuid="+document.getElementById("selectedreport").value+"&format="+reportForm.reportformat.value+"&language=<%=sWebLanguage%>";
