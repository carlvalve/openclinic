...
%>
	<table width="100%">
		<tr class='admin'><td colspan='2'><%=getTran(request,"cnar","statistics.case.management.title1",sWebLanguage)%></td></tr>
		<tr>
...
%>
	<br/><hr/><br/>
<table width="100%">
	<tr class='admin'><td colspan='3'><%=getTran(request,"cnar","statistics.case.management.title2",sWebLanguage)%></td></tr>
	<tr class='admin'>
		<td rowspan="2"><%=getTran(request,"cnar","statistics.service.treatment",sWebLanguage)%></td>
