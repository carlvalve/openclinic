...
%>
	<table width="800px">
		<tr class='admin'><td colspan='4'><%=getTran(request,"cnar","statistics.disease.title1",sWebLanguage)%> (Top <%=maxdiseases %>)</td></tr>
		<tr class='admin'>
			<td rowspan='2'><%=getTran(request,"cnar","statistics.disease.code",sWebLanguage)%></td>
			<td rowspan='2'><%=getTran(request,"cnar","statistics.disease.disease",sWebLanguage)%></td>
			<td colspan='2'><%= getTran(request,"web","total",sWebLanguage)%></td></tr>
		<tr class='admin'>
			...
			%>
		<tr class='admin'>
			<td colspan='2'><%=getTran(request,"web","totals",sWebLanguage)%></td>
...
%>
	<br/><hr/><br/>
	<table width="800px">
		<tr class='admin'><td colspan='7'><%=getTran(request,"cnar","statistics.disease.title2",sWebLanguage)%> (Top <%=maxdiseases %>)</td></tr>
		<tr class='admin'>
			<td rowspan='2'><%=getTran(request,"cnar","statistics.disease.code",sWebLanguage)%></td>
			<td rowspan='2'><%=getTran(request,"cnar","statistics.disease.disease",sWebLanguage)%></td>
...
%>
	<br/><hr/><br/>
	<table width="800px">
		<tr class='admin'><td colspan='9'><%=getTran(request,"cnar","statistics.disease.title3",sWebLanguage)%> (Top <%=maxdiseases %>)</td></tr>
		<tr class='admin'>
			<td rowspan='2'><%=getTran(request,"cnar","statistics.disease.code",sWebLanguage)%></td>
			<td rowspan='2'><%=getTran(request,"cnar","statistics.disease.disease",sWebLanguage)%></td>
...
%>
	...
	<table width="100%" class="table table-striped table-header-rotated">
		<tr class='admin'><th colspan='<%=(3+allProvinces.size())+""%>'><%=getTran(request,"cnar","statistics.disease.title4",sWebLanguage)%> (Top <%=maxdiseases %>)</th></tr>
		<tr>
			<td class="admin"><%=getTran(request,"cnar","statistics.disease.code",sWebLanguage)%></td>
			<td class='admin'><%=getTran(request,"cnar","statistics.disease.disease",sWebLanguage)%></td>
			<%
			...
			%>
			<th class='rotate-45'><div><span><%= getTran(request,"web","total",sWebLanguage)%></span></div></th></tr>
			<%
				...
				out.println("<td colspan='2'>"+getTran(request,"web","totals",sWebLanguage)+"</td>");
				i = allProvinces.iterator();
				while(i.hasNext()){
