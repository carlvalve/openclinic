            ...
            <table width='100%' class="menu" cellspacing="1" cellpadding="0">
                    ...
                    <td class="admin2">
                      <%
                          out.print("<select name='EditAutomaticOrganizationIdValidation' id='council' onchange='showRegistrationStatus();'>"+
                                    ...
                                    "</select>");
                          out.print(" &nbsp;<a href='javascript:councilLookup("+thisUser.userid+");'><img id='councillookup' src='"+sCONTEXTPATH+"/_img/icons/icon_search.png' title='"+getTranNoLink("web","verify",sWebLanguage)+"'/></a> &nbsp;&nbsp;&nbsp;<label id='registrationstatus'></label>");
                      %>
                    </td>
                </tr>
                <%
                ...
                <tr>
                    ...
                    <td class="admin2">
                        ...
                        <img src="<c:url value="/_img/icons/icon_delete.png"/>" class="link" alt="<%=getTranNoLink("Web","clear",sWebLanguage)%>" onclick="document.getElementById('EditInsuranceAgent').value='';document.getElementById('insuranceagenttext').value='';">
                    </td>
                </tr>
