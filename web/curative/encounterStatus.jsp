                ...
                <tr class="admin">
                    <td width="300">
						...
						<%if(MedwanQuery.getInstance().getConfigString("quickConsult1."+activeUser.userid,"").split(";").length>MedwanQuery.getInstance().getConfigInt("minimumQuickConsultFields",3)-1){ %>
	                        <a href="javascript:newFastEncounter('<%=MedwanQuery.getInstance().getConfigString("quickConsult1."+activeUser.userid)%>');"><img src="<c:url value='/_img/icons/icon_new1.gif'/>" class="link" title="<%=getTranNoLink("web",MedwanQuery.getInstance().getConfigString("quickConsult1."+activeUser.userid).split(";")[0],sWebLanguage)+" "+getTranNoLink("service",MedwanQuery.getInstance().getConfigString("quickConsult1."+activeUser.userid).split(";")[2],sWebLanguage)+" "+(MedwanQuery.getInstance().getConfigString("quickConsult1."+activeUser.userid,"").split(";").length<5?"":getTranNoLink("encounter.situation",MedwanQuery.getInstance().getConfigString("quickConsult1."+activeUser.userid).split(";")[4],sWebLanguage))%>" style="vertical-align:-4px;"></a>
	                    <%} %>
						<%if(MedwanQuery.getInstance().getConfigString("quickConsult2."+activeUser.userid,"").split(";").length>4){ %>
	                        <a href="javascript:newFastEncounter('<%=MedwanQuery.getInstance().getConfigString("quickConsult2."+activeUser.userid)%>');"><img src="<c:url value='/_img/icons/icon_new2.gif'/>" class="link" title="<%=getTranNoLink("web",MedwanQuery.getInstance().getConfigString("quickConsult2."+activeUser.userid).split(";")[0],sWebLanguage)+" "+getTranNoLink("service",MedwanQuery.getInstance().getConfigString("quickConsult2."+activeUser.userid).split(";")[2],sWebLanguage)+" "+(MedwanQuery.getInstance().getConfigString("quickConsult2."+activeUser.userid,"").split(";").length<5?"":getTranNoLink("encounter.situation",MedwanQuery.getInstance().getConfigString("quickConsult2."+activeUser.userid).split(";")[4],sWebLanguage))%>" style="vertical-align:-4px;"></a>
	                    <%} %>
						<%if(MedwanQuery.getInstance().getConfigString("quickConsult3."+activeUser.userid,"").split(";").length>4){ %>
	                        <a href="javascript:newFastEncounter('<%=MedwanQuery.getInstance().getConfigString("quickConsult3."+activeUser.userid)%>');"><img src="<c:url value='/_img/icons/icon_new3.gif'/>" class="link" title="<%=getTranNoLink("web",MedwanQuery.getInstance().getConfigString("quickConsult3."+activeUser.userid).split(";")[0],sWebLanguage)+" "+getTranNoLink("service",MedwanQuery.getInstance().getConfigString("quickConsult3."+activeUser.userid).split(";")[2],sWebLanguage)+" "+(MedwanQuery.getInstance().getConfigString("quickConsult3."+activeUser.userid,"").split(";").length<5?"":getTranNoLink("encounter.situation",MedwanQuery.getInstance().getConfigString("quickConsult3."+activeUser.userid).split(";")[4],sWebLanguage))%>" style="vertical-align:-4px;"></a>
	                    <%} %>
						<%if(MedwanQuery.getInstance().getConfigString("quickConsult4."+activeUser.userid,"").split(";").length>4){ %>
	                        <a href="javascript:newFastEncounter('<%=MedwanQuery.getInstance().getConfigString("quickConsult4."+activeUser.userid)%>');"><img src="<c:url value='/_img/icons/icon_new4.gif'/>" class="link" title="<%=getTranNoLink("web",MedwanQuery.getInstance().getConfigString("quickConsult4."+activeUser.userid).split(";")[0],sWebLanguage)+" "+getTranNoLink("service",MedwanQuery.getInstance().getConfigString("quickConsult4."+activeUser.userid).split(";")[2],sWebLanguage)+" "+(MedwanQuery.getInstance().getConfigString("quickConsult4."+activeUser.userid,"").split(";").length<5?"":getTranNoLink("encounter.situation",MedwanQuery.getInstance().getConfigString("quickConsult4."+activeUser.userid).split(";")[4],sWebLanguage))%>" style="vertical-align:-4px;"></a>
	                    <%} %>
						<%if(MedwanQuery.getInstance().getConfigString("quickConsult5."+activeUser.userid,"").split(";").length>4){ %>
	                        <a href="javascript:newFastEncounter('<%=MedwanQuery.getInstance().getConfigString("quickConsult5."+activeUser.userid)%>');"><img src="<c:url value='/_img/icons/icon_new5.gif'/>" class="link" title="<%=getTranNoLink("web",MedwanQuery.getInstance().getConfigString("quickConsult5."+activeUser.userid).split(";")[0],sWebLanguage)+" "+getTranNoLink("service",MedwanQuery.getInstance().getConfigString("quickConsult5."+activeUser.userid).split(";")[2],sWebLanguage)+" "+(MedwanQuery.getInstance().getConfigString("quickConsult5."+activeUser.userid,"").split(";").length<5?"":getTranNoLink("encounter.situation",MedwanQuery.getInstance().getConfigString("quickConsult5."+activeUser.userid).split(";")[4],sWebLanguage))%>" style="vertical-align:-4px;"></a>
	                    <%} %>
                    </td>
