			        ...
			        while(examIter.hasNext()){
			        	...
			        	while(examsIter.hasNext()){
			        		...
			        		out.print("<td class='admin'>"+
							           "<table width='100%'><tr valign='top'><td width='1px'><input type='checkbox' name='cb_"+sServiceId+"_"+sExamId+"' id='cb_"+sServiceId+"_"+sExamId+"' "+(hExaminations.get(((String)serviceExams.get(sExamId)).split(";")[0])!=null?"checked":"")+"/></td><td><label for='cb_"+sServiceId+"_"+sExamId+"'>"+sExamName+"</label></td></tr></table>"+
			        		          "</td>");
			        		examCounter++;
