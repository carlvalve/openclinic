	...
	<table width='100%'>
		...
		<tr>
            ...
            <td class="admin2" colspan='4'>
                ...
                <img src="<c:url value="/_img/icons/icon_search.gif"/>" class="link" alt="<%=getTranNoLink("Web","select",sWebLanguage)%>" onclick="searchInsurar('EditInsurarUID','EditInsurarName');">
                <img src="<c:url value="/_img/icons/icon_delete.gif"/>" class="link" alt="<%=getTranNoLink("Web","clear",sWebLanguage)%>" onclick="transactionForm.EditInsurarName.value='';transactionForm.EditInsurarUid.value='';">
            </td>
		</tr>
		<tr>
			<td colspan='5'>
