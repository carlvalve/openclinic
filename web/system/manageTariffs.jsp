...
<%
	...
	if(sPrice.length()>0 && Double.parseDouble(sPrice)<0){
		sPrice="";
		sPrestUid="";
		sFindButton="1";
	}
	...
	<table class='list' border='0' width='100%' cellspacing='1'>
	        <tr>
	            ...
	            <td class='admin2'>
                	...
                	<img src="<c:url value="/_img/icons/icon_delete.png"/>" class="link" alt="<%=getTranNoLink("Web","clear",sWebLanguage)%>" onclick="EditForm.EditPrestationName.selectedIndex=-1;EditForm.tmpPrestationUID.value='';">
	            </td>
	        </tr>
	        <tr>
	...
	if(sFindButton!=null){
		...
		while (rs.next()){
			...
			if(tariffVersion==prestationVersion){
				...
				%>
					<td><img src="<c:url value="/_img/icons/icon_delete.png"/>" class="link" alt="<%=getTranNoLink("Web","delete",sWebLanguage)%>" onclick='selectPrestation("<%=iud%>","<%=pud %>","<%=cat %>",-1);'></td>
				<%
