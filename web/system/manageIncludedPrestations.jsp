	...
	<table width='100%'>
		...
		<tr>
            ...
            <td class="admin2" colspan='4'>
                ...
                <img src="<c:url value="/_img/icons/icon_search.gif"/>" class="link" alt="<%=getTranNoLink("Web","select",sWebLanguage)%>" onclick="searchPrestation('EditForfaitUID','EditForfaitName');">
                <img src="<c:url value="/_img/icons/icon_delete.gif"/>" class="link" alt="<%=getTranNoLink("Web","clear",sWebLanguage)%>" onclick="transactionForm.EditForfaitName.value='';transactionForm.EditForfaitUid.value='';">
            </td>
		</tr>
		<tr>
			<td colspan='5'>
