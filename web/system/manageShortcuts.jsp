	...
	<table class="list" cellpadding="0" cellspacing="1">
		...
		<tr>
	        ...
	        <td class='admin2'>
	            ...
	            <img src="<c:url value="/_img/icons/icon_search.gif"/>" class="link" alt="<%=getTranNoLink("web","select",sWebLanguage)%>" onclick="searchService('FastEncounterService.1','FastEncounterServiceName.1');">
	            <img src="<c:url value="/_img/icons/icon_delete.gif"/>" class="link" alt="<%=getTranNoLink("web","clear",sWebLanguage)%>" onclick="document.getElementById('FastEncounterService.1').value='';document.getElementById('FastEncounterServiceName.1').value='';">
	        </td>
	        <td class="admin2">
		...
		<tr>
	        ...
	        <td class='admin2'>
	            ...
	            <img src="<c:url value="/_img/icons/icon_search.gif"/>" class="link" alt="<%=getTranNoLink("web","select",sWebLanguage)%>" onclick="searchService('FastEncounterService.2','FastEncounterServiceName.2');">
	            <img src="<c:url value="/_img/icons/icon_delete.gif"/>" class="link" alt="<%=getTranNoLink("web","clear",sWebLanguage)%>" onclick="document.getElementById('FastEncounterService.2').value='';document.getElementById('FastEncounterServiceName.2').value='';">
	        </td>
	        <td class="admin2">
		...
		<tr>
	        ...
	        <td class='admin2'>
	            ...
	            <img src="<c:url value="/_img/icons/icon_search.gif"/>" class="link" alt="<%=getTranNoLink("web","select",sWebLanguage)%>" onclick="searchService('FastEncounterService.3','FastEncounterServiceName.3');">
	            <img src="<c:url value="/_img/icons/icon_delete.gif"/>" class="link" alt="<%=getTranNoLink("web","clear",sWebLanguage)%>" onclick="document.getElementById('FastEncounterService.3').value='';document.getElementById('FastEncounterServiceName.3').value='';">
	        </td>
	        <td class="admin2">
		...
		<tr>
	        ...
	        <td class='admin2'>
	            ...
	            <img src="<c:url value="/_img/icons/icon_search.gif"/>" class="link" alt="<%=getTranNoLink("web","select",sWebLanguage)%>" onclick="searchService('FastEncounterService.4','FastEncounterServiceName.4');">
	            <img src="<c:url value="/_img/icons/icon_delete.gif"/>" class="link" alt="<%=getTranNoLink("web","clear",sWebLanguage)%>" onclick="document.getElementById('FastEncounterService.4').value='';document.getElementById('FastEncounterServiceName.4').value='';">
	        </td>
	        <td class="admin2">
		...
		<tr>
	        ...
	        <td class='admin2'>
	            ...
	            <img src="<c:url value="/_img/icons/icon_search.gif"/>" class="link" alt="<%=getTranNoLink("web","select",sWebLanguage)%>" onclick="searchService('FastEncounterService.5','FastEncounterServiceName.5');">
	            <img src="<c:url value="/_img/icons/icon_delete.gif"/>" class="link" alt="<%=getTranNoLink("web","clear",sWebLanguage)%>" onclick="document.getElementById('FastEncounterService.5').value='';document.getElementById('FastEncounterServiceName.5').value='';">
	        </td>
	        <td class="admin2">
