	...
	if(checkString(report.getInputxml()).length()>0){
		...
		while(iFields.hasNext()){
			...
			if(field.getName().equalsIgnoreCase("field")){
				sHtml+="<tr><td class='admin'></td><td class='admin2'><img src='"+sCONTEXTPATH+"/_img/icons/icon_delete.gif' onclick='deleteField(\\\""+field.elementText("name")+"\\\");'> "+field.elementText("name")+
