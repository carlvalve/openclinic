...
<form name="transactionForm" method="post">
    ...
    <table class="list" width="100%" cellspacing="1">
        ...
        <%=inputRow(request,"Web","address","EditEPSAddress","",sAddress,"T",true, false,sWebLanguage,"")%>
        <%=writeZipcode(sZipcode, "EditEPSZipcode","","EditEPSCity",true,"Zipcode",sWebLanguage,"")%>
        <%=inputRow(request,"Web","city","EditEPSCity","",sCity,"T",true, false,sWebLanguage,"")%>
        <%=inputRow(request,"Web","telephone","EditEPSPhone","",sPhone,"T",true,false,sWebLanguage,"")%>
        <%=inputRow(request,"Web","fax","EditEPSFax","",sFax,"T",true,false,sWebLanguage,"")%>
