                        ...
                        while(iter.hasNext()){
                            ...
                            %>
                                <tr class="list<%=sClass%>" title="<%=sClickTran%>" id="header_<%=iCounter%>">
                                    <td class="hand"><img src="<c:url value='/_img/icons/icon_delete.png'/>" border="0" alt="<%=getTranNoLink("Web","delete",sWebLanguage)%>" onclick="deleteError('<%=sErrorId%>');" onmouseover='this.style.cursor="hand"' onmouseout='this.style.cursor="default"'/></td>
