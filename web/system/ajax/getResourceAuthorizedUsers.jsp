...
<%
	...
	for(int n=0;n<users.length;n++){
		if(users[n].length()>0){
			stbl+="<tr><td class='admin2' width='1%'><img src='_img/icons/icon_delete.gif' onclick='deleteAuthorizedUser("+users[n]+")'/></td><td class='admin2'>"+User.getFullUserName(users[n])+"</td></tr>";
		}
	}
	if(stbl.length()>0){
