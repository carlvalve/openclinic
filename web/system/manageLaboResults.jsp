    ...
    private StringBuffer objectsToHtmlType1(Vector objects, String resultType, boolean showOnlyOpenResults, 
        ...
        for(int i=0; i<objects.size(); i++){
            ...
            html.append("<tr class='"+sClass+"' onmouseover=\"this.style.cursor='hand'\" onmouseout=\"this.style.cursor='default'\" title='"+detailsTran+"'>")
                 .append("<td>&nbsp;</td>")
                 .append("<td><img src='"+sCONTEXTPATH+"/_img/icons/icon_delete.png' class='link' title='"+deleteTran+"' onclick=\"doDelete('"+labResult.getServerId()+"','"+labResult.getTransactionId()+"','"+labResult.getAnalysisCode()+"');\">")
                 .append("<td><img src='"+sCONTEXTPATH+"/_img/icons/icon_view.png' class='link' title='"+labrequestTran+"' onclick=\"showLabRequest('"+labResult.getServerId()+"','"+labResult.getTransactionId()+"');\">")
