...
<%!
    ...
    private String addAuthorizedUser(int userIdx, String userName, String sWebLanguage){
        ...
        html.append("<tr id='rowAuthorizedUsers"+userIdx+"'>")
             .append("<td width='16'>")
              .append("<img src='"+sCONTEXTPATH+"/_img/icons/icon_delete.png' onclick='deleteAuthorizedUser(rowAuthorizedUsers"+userIdx+");' alt='"+getTranNoLink("Web","delete",sWebLanguage)+"' class='link'>")
             .append("</td>")
			    ...
			    <table class='list' border='0' width='100%' cellspacing='1'>
			        ...
			        <tr>
			            ...
			            <td class='admin2'>
			                ...
			                <img src="<c:url value="/_img/icons/icon_search.png"/>" class="link" alt="<%=getTranNoLink("Web","select",sWebLanguage)%>" onclick="searchService('FindWicketService','FindWicketServiceName');">
			                <img src="<c:url value="/_img/icons/icon_delete.png"/>" class="link" alt="<%=getTranNoLink("Web","clear",sWebLanguage)%>" onclick="FindWicketForm.FindWicketServiceName.value='';FindWicketForm.FindWicketService.value='';">
            ...
            sbResults.append("<tr class=\"list"+sClass+"\" onmouseover=\"this.style.cursor='hand';\" onmouseout=\"this.style.cursor='default';\">" +
		                      "<td width='25'>"+
            		           "<a href='javascript:deleteWicket(\""+wicket.getUid()+"\")'>" +
		                        "<img src='"+sCONTEXTPATH+"/_img/icons/icon_delete.png' alt='"+getTranNoLink("Web", "delete", sWebLanguage)+"' class='link'>" +
		                       "</a>" +
		                      "</td>" +
    ...
    <table class='list' border='0' width='100%' cellspacing='1'>
        ...
        <tr>
            ...
            <td class="admin2">
                ...
                <img src="<c:url value="/_img/icons/icon_delete.png"/>" class="link" alt="<%=getTranNoLink("Web","clear",sWebLanguage)%>" onclick="EditWicketForm.AuthorizedUserIdAdd.value='';EditWicketForm.AuthorizedUserNameAdd.value='';">
