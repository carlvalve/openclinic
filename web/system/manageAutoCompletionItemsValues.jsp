    ...
    <table class="list" width="100%" cellspacing="1">
        ...
        <tr>
            ...
            <td class="admin2">
                ...
                <img src="<c:url value="/_img/icons/icon_search.png"/>" class="link" alt="<%=getTranNoLink("Web","select",sWebLanguage)%>" onclick="searchUser('userName','userID');">
                <br/><br/>
            </td>
        </tr>
        ...
        <tr id="SELECTEDTYPEITEMS" style="visibility:hidden;">
            ...
            <td class="admin2">
                ...
                <a href='#' onclick="delValue(transactionForm.itemTypeSelect.value,'',transactionForm.userID.value);">
                    <img src='<%=sCONTEXTPATH%>/_img/icons/icon_delete.png' alt='<%=getTranNoLink("Web","delete",sWebLanguage)%>' class='link'><%=getTran(request,"Web.manage","deletethisTypeFromUser",sWebLanguage)%>
                </a>
                <br/>
            </td>
        </tr>
