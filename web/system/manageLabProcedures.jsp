    ...
    <table width="100%" cellspacing="1" cellpadding="0" class="list">
        ...
        <tr>
            ...
            <td class="admin2">
		        ...
		        <img src="<c:url value="/_img/icons/icon_search.png"/>" class="link" alt="<%=getTranNoLink("Web","select",sWebLanguage)%>" onclick="searchReagent('EditReagentUid','EditReagentName','EditReagentUnit');">
		        <img src="<c:url value="/_img/icons/icon_delete.png"/>" class="link" alt='Vider' onclick="document.getElementById('EditReagentUid').value='';document.getElementById('EditReagentName').value='';"> 
...
<%-- SEARCH PROCEDURE --%>
	...
	function fillReagentsTable(){
		if(document.getElementById("EditReagents").value.length>0){
			...
			var reagents=document.getElementById("EditReagents").value.split("$");
			for(var n=0;n<reagents.length;n++){
				html=html+"<tr><td width='10%'><img src='<c:url value="_img/icons/icon_delete.png"/>' onclick='removeReagent(\""+reagents[n].split("|")[0]+"\")'/>"+reagents[n].split("|")[0]+"</td><td width='60%'>"+reagents[n].split("|")[2]+"</td><td width='30%'>"+reagents[n].split("|")[1];
