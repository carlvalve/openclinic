...
<%!
    ...
    private String addSourceItem(int itemTypeIdx, String itemTypeId, String sWebLanguage){
        ...
        html.append("<tr class='list"+sClass+"' id='rowSourceItem"+itemTypeIdx+"'>")
            ...
            .append("<img src='"+sCONTEXTPATH+"/_img/icons/icon_delete.png' alt='"+getTranNoLink("Web","delete",sWebLanguage)+"' class='link'>")
            .append("</a>")
            .append("</td>")
  ...
  function addSourceItem(){
    ...
    if(transactionForm.EditDestinationItemType.value.length > 0 &&
      ...
      if(!allreadySelected(transactionForm.SourceItemTypeAdd.value)){
        ...
        td1.innerHTML = "<a href='javascript:deleteSourceItem(rowSourceItem"+iSourceItemIdx+")'><img src='<%=sCONTEXTPATH%>/_img/icons/icon_delete.png' alt='<%=getTranNoLink("Web","delete",sWebLanguage)%>' border='0'></a>";
