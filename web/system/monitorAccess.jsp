                        ...
                        while (iter.hasNext()) {
                            ...
                            %>
                                <tr class="list<%=sClass%>">
                                    <td class="hand"><img src="<c:url value='/_img/icons/icon_delete.png'/>" border="0" alt="<%=getTranNoLink("Web","delete",sWebLanguage)%>" onclick="deleteAccess('<%=objAL.getAccessid()%>');" onmouseover='this.style.cursor="hand"' onmouseout='this.style.cursor="default"'/></td>
                                    <td><%=sAccessTime%></td>
                                    <td><%=sName%></td>
                                    <td>&nbsp;</td>
                                </tr>
